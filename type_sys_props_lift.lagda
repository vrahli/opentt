...
LIFTneqNOWRITE : {a : Term} {c : Term} → ¬ (LIFT a) ≡ NOWRITE c
LIFTneqNOWRITE {a} {c} ()

LIFTneqNOREAD : {a : Term} {c : Term} → ¬ (LIFT a) ≡ NOREAD c
LIFTneqNOREAD {a} {c} ()
...
typeSysConds-LIFT-ttrans u w A B A1 B1 x x₁ eqta exta inda C (EQTNOWRITE A3 A4 y y₁ eqtA extA) = ⊥-elim (LIFTneqNOWRITE (⇛-val-det tt tt x₁ y))
typeSysConds-LIFT-ttrans u w A B A1 B1 x x₁ eqta exta inda C (EQTNOREAD A3 A4 y y₁ eqtA extA) = ⊥-elim (LIFTneqNOREAD (⇛-val-det tt tt x₁ y))
...
typeSysConds-LIFT-extl1 u w A B A1 B1 x x₁ eqta exta inda C (EQTNOWRITE A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (LIFTneqNOWRITE (⇛-val-det tt tt x y))
typeSysConds-LIFT-extl1 u w A B A1 B1 x x₁ eqta exta inda C (EQTNOREAD A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (LIFTneqNOREAD (⇛-val-det tt tt x y))
...
typeSysConds-LIFT-extl2 u w A B A1 B1 x x₁ eqta exta inda C (EQTNOWRITE A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (LIFTneqNOWRITE (⇛-val-det tt tt x y₁))
typeSysConds-LIFT-extl2 u w A B A1 B1 x x₁ eqta exta inda C (EQTNOREAD A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (LIFTneqNOREAD (⇛-val-det tt tt x y₁))
...
typeSysConds-LIFT-extr1 u w A B A1 B1 x x₁ eqta exta inda C (EQTNOWRITE A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (LIFTneqNOWRITE (⇛-val-det tt tt x₁ y₁))
typeSysConds-LIFT-extr1 u w A B A1 B1 x x₁ eqta exta inda C (EQTNOREAD A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (LIFTneqNOREAD (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-LIFT-extr2 u w A B A1 B1 x x₁ eqta exta inda C (EQTNOWRITE A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (LIFTneqNOWRITE (⇛-val-det tt tt x₁ y))
typeSysConds-LIFT-extr2 u w A B A1 B1 x x₁ eqta exta inda C (EQTNOREAD A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (LIFTneqNOREAD (⇛-val-det tt tt x₁ y))
...
typeSysConds-LIFT-extrevl1 u w A B A1 B1 x x₁ eqta exta inda C (EQTNOWRITE A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (LIFTneqNOWRITE (⇛-val-det tt tt x y))
typeSysConds-LIFT-extrevl1 u w A B A1 B1 x x₁ eqta exta inda C (EQTNOREAD A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (LIFTneqNOREAD (⇛-val-det tt tt x y))
...
typeSysConds-LIFT-extrevl2 u w A B A1 B1 x x₁ eqta exta inda C (EQTNOWRITE A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (LIFTneqNOWRITE (⇛-val-det tt tt x y₁))
typeSysConds-LIFT-extrevl2 u w A B A1 B1 x x₁ eqta exta inda C (EQTNOREAD A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (LIFTneqNOREAD (⇛-val-det tt tt x y₁))
...
typeSysConds-LIFT-extrevr1 u w A B A1 B1 x x₁ eqta exta inda C (EQTNOWRITE A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (LIFTneqNOWRITE (⇛-val-det tt tt x₁ y₁))
typeSysConds-LIFT-extrevr1 u w A B A1 B1 x x₁ eqta exta inda C (EQTNOREAD A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (LIFTneqNOREAD (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-LIFT-extrevr2 u w A B A1 B1 x x₁ eqta exta inda C (EQTNOWRITE A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (LIFTneqNOWRITE (⇛-val-det tt tt x₁ y))
typeSysConds-LIFT-extrevr2 u w A B A1 B1 x x₁ eqta exta inda C (EQTNOREAD A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (LIFTneqNOREAD (⇛-val-det tt tt x₁ y))
...
eqInType-⇛-LIFT u w A B A1 B1 a b eqta exta inda c₁ c₂ (EQTNOWRITE A3 A4 x x₁ eqta₁ exta₁) ei = ⊥-elim (LIFTneqNOWRITE (⇛-val-det tt tt c₁ x))
eqInType-⇛-LIFT u w A B A1 B1 a b eqta exta inda c₁ c₂ (EQTNOREAD A3 A4 x x₁ eqta₁ exta₁) ei = ⊥-elim (LIFTneqNOREAD (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-LIFT2 u w A B A1 B1 a b eqta exta c₁ c₂ (EQTNOWRITE A3 A4 x x₁ eqta₁ exta₁) ei ext = ⊥-elim (LIFTneqNOWRITE (⇛-val-det tt tt c₁ x))
eqInType-⇛-LIFT2 u w A B A1 B1 a b eqta exta c₁ c₂ (EQTNOREAD A3 A4 x x₁ eqta₁ exta₁) ei ext = ⊥-elim (LIFTneqNOREAD (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-LIFT-rev u w A B A1 B1 a b eqta exta inda c₁ c₂ (EQTNOWRITE A3 A4 x x₁ eqta₁ exta₁) ei = ⊥-elim (LIFTneqNOWRITE (⇛-val-det tt tt c₁ x))
eqInType-⇛-LIFT-rev u w A B A1 B1 a b eqta exta inda c₁ c₂ (EQTNOREAD A3 A4 x x₁ eqta₁ exta₁) ei = ⊥-elim (LIFTneqNOREAD (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-LIFT-rev2 u w A B A1 B1 a b eqta exta c₁ c₂ (EQTNOWRITE A3 A4 x x₁ eqta₁ exta₁) ext ei = ⊥-elim (LIFTneqNOWRITE (⇛-val-det tt tt c₁ x))
eqInType-⇛-LIFT-rev2 u w A B A1 B1 a b eqta exta c₁ c₂ (EQTNOREAD A3 A4 x x₁ eqta₁ exta₁) ext ei = ⊥-elim (LIFTneqNOREAD (⇛-val-det tt tt c₁ x))
