...
LIFTneqNN : {a : Term} {c : Term} → ¬ (LIFT a) ≡ NN c
LIFTneqNN {a} {c} ()
...
typeSysConds-LIFT-ttrans u w A B A1 B1 x x₁ eqta exta inda C (EQTNN t₁ y y₁) = ⊥-elim (LIFTneqNN (⇛-val-det tt tt x₁ y))
...
typeSysConds-LIFT-extl1 u w A B A1 B1 x x₁ eqta exta inda C (EQTNN t₁ y y₁) f g eqi = ⊥-elim (LIFTneqNN (⇛-val-det tt tt x y))
...
typeSysConds-LIFT-extl2 u w A B A1 B1 x x₁ eqta exta inda C (EQTNN t₁ y y₁) f g eqi = ⊥-elim (LIFTneqNN (⇛-val-det tt tt x y₁))
...
typeSysConds-LIFT-extr1 u w A B A1 B1 x x₁ eqta exta inda C (EQTNN t₁ y y₁) f g eqi = ⊥-elim (LIFTneqNN (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-LIFT-extr2 u w A B A1 B1 x x₁ eqta exta inda C (EQTNN t₁ y y₁) f g eqi = ⊥-elim (LIFTneqNN (⇛-val-det tt tt x₁ y))
...
typeSysConds-LIFT-extrevl1 u w A B A1 B1 x x₁ eqta exta inda C (EQTNN t₁ y y₁) f g eqi = ⊥-elim (LIFTneqNN (⇛-val-det tt tt x y))
...
typeSysConds-LIFT-extrevl2 u w A B A1 B1 x x₁ eqta exta inda C (EQTNN t₁ y y₁) f g eqi = ⊥-elim (LIFTneqNN (⇛-val-det tt tt x y₁))
...
typeSysConds-LIFT-extrevr1 u w A B A1 B1 x x₁ eqta exta inda C (EQTNN t₁ y y₁) f g eqi = ⊥-elim (LIFTneqNN (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-LIFT-extrevr2 u w A B A1 B1 x x₁ eqta exta inda C (EQTNN t₁ y y₁) f g eqi = ⊥-elim (LIFTneqNN (⇛-val-det tt tt x₁ y))
...
eqInType-⇛-LIFT u w A B A1 B1 a b eqta exta inda c₁ c₂ (EQTNN t₁ x x₁) ei = ⊥-elim (LIFTneqNN (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-LIFT2 u w A B A1 B1 a b eqta exta c₁ c₂ (EQTNN t₁ x x₁) ei ext = ⊥-elim (LIFTneqNN (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-LIFT-rev u w A B A1 B1 a b eqta exta inda c₁ c₂ (EQTNN t₁ x x₁) ei = ⊥-elim (LIFTneqNN (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-LIFT-rev2 u w A B A1 B1 a b eqta exta c₁ c₂ (EQTNN t₁ x x₁) ext ei = ⊥-elim (LIFTneqNN (⇛-val-det tt tt c₁ x))
