...
TSQUASHneqW : {a : Term} {c d e : Term} → ¬ (TSQUASH a) ≡ WT c d e
TSQUASHneqW {a} {c} {d} {e} ()

TSQUASHneqM : {a : Term} {c d e : Term} → ¬ (TSQUASH a) ≡ MT c d e
TSQUASHneqM {a} {c} {d} {e} ()
...
TSQUASHneqPARTIAL : {a : Term} {c : Term} → ¬ (TSQUASH a) ≡ PARTIAL c
TSQUASHneqPARTIAL {a} {c} ()
...
TSQUASHneqNOWRITE : {a : Term} → ¬ (TSQUASH a) ≡ NOWRITE
TSQUASHneqNOWRITE {a} ()

TSQUASHneqNOREAD : {a : Term} → ¬ (TSQUASH a) ≡ NOREAD
TSQUASHneqNOREAD {a} ()
...
TSQUASHneqNOENC : {a : Term} → ¬ (TSQUASH a) ≡ NOENC
TSQUASHneqNOENC {a} ()
...
--    ind {u} {w} {T1} {T2} (EQTTNAT y y₁) ind x x₁ eqta exta inda = ⊥-elim (TSQUASHneqTNAT (⇛-val-det tt tt x₁ y))
    ...
    ind {u} {w} {T1} {T2} (EQTW C1 D1 E1 C2 D2 E2 y y₁ eqta0 eqtb0 eqtc0 exta0 extb0 extc0) ind x x₁ eqta exta inda = ⊥-elim (TSQUASHneqW (⇛-val-det tt tt x₁ y))
    ind {u} {w} {T1} {T2} (EQTM C1 D1 E1 C2 D2 E2 y y₁ eqta0 eqtb0 eqtc0 exta0 extb0 extc0) ind x x₁ eqta exta inda = ⊥-elim (TSQUASHneqM (⇛-val-det tt tt x₁ y))
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A3 A4 y y₁ eqtA extA) ind x x₁ eqta exta inda = ⊥-elim (TSQUASHneqTTRUNC (⇛-val-det tt tt x₁ y))
    ...
    ind {u} {w} {T1} {T2} (EQTNOENC y y₁) ind x x₁ eqta exta inda = ⊥-elim (TSQUASHneqNOENC (⇛-val-det tt tt x₁ y))
    ind {u} {w} {T1} {T2} (EQTTERM z₁ z₂ y y₁ y₂) ind x x₁ eqta exta inda = ⊥-elim (TSQUASHneqTERM (⇛-val-det tt tt x₁ y))
    ind {u} {w} {T1} {T2} (EQTNOWRITE y y₁) ind x x₁ eqta exta inda = ⊥-elim (TSQUASHneqNOWRITE (⇛-val-det tt tt x₁ y))
    ind {u} {w} {T1} {T2} (EQTNOREAD y y₁) ind x x₁ eqta exta inda = ⊥-elim (TSQUASHneqNOREAD (⇛-val-det tt tt x₁ y))
--    ind {u} {w} {T1} {T2} (EQTPARTIAL A3 A4 y y₁ eqtA) = ⊥-elim (TSQUASHneqPARTIAL (⇛-val-det tt tt x₁ y))
...
--    ind {u} {w} {T1} {T2} (EQTTNAT y y₁) ind eqta exta inda x f g eqi = ⊥-elim (TSQUASHneqTNAT (⇛-val-det tt tt x y))
    ...
    ind {u} {w} {T1} {T2} (EQTW A3 B3 C3 A4 B4 C4 y y₁ eqta0 eqtb0 eqtc0 exta0 extb0 extc0) ind eqta exta inda x f g eqi = ⊥-elim (TSQUASHneqW (⇛-val-det tt tt x y))
    ind {u} {w} {T1} {T2} (EQTM A3 B3 C3 A4 B4 C4 y y₁ eqta0 eqtb0 eqtc0 exta0 extb0 extc0) ind eqta exta inda x f g eqi = ⊥-elim (TSQUASHneqM (⇛-val-det tt tt x y))
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A3 A4 y y₁ eqtA extA) ind eqta exta inda x f g eqi = ⊥-elim (TSQUASHneqTTRUNC (⇛-val-det tt tt x y))
    ...
    ind {u} {w} {T1} {T2} (EQTNOENC y y₁) ind eqta exta inda x f g eqi = ⊥-elim (TSQUASHneqNOENC (⇛-val-det tt tt x y))
    ind {u} {w} {T1} {T2} (EQTTERM z₁ z₂ y y₁ y₂) ind eqta exta inda x f g eqi = ⊥-elim (TSQUASHneqTERM (⇛-val-det tt tt x y))
    ind {u} {w} {T1} {T2} (EQTNOWRITE y y₁) ind eqta exta inda x f g eqi = ⊥-elim (TSQUASHneqNOWRITE (⇛-val-det tt tt x y))
    ind {u} {w} {T1} {T2} (EQTNOREAD y y₁) ind eqta exta inda x f g eqi = ⊥-elim (TSQUASHneqNOREAD (⇛-val-det tt tt x y))
...
--    ind {u} {w} {T1} {T2} (EQTTNAT y y₁) ind eqta exta inda x f g eqi = ⊥-elim (TSQUASHneqTNAT (⇛-val-det tt tt x y₁))
    ...
    ind {u} {w} {T1} {T2} (EQTW A3 B3 C3 A4 B4 C4 y y₁ eqta₁ eqtb₁ eqtc₁ exta₁ extb₁ extc₁) ind eqta exta inda x f g eqi = ⊥-elim (TSQUASHneqW (⇛-val-det tt tt x y₁))
    ind {u} {w} {T1} {T2} (EQTM A3 B3 C3 A4 B4 C4 y y₁ eqta₁ eqtb₁ eqtc₁ exta₁ extb₁ extc₁) ind eqta exta inda x f g eqi = ⊥-elim (TSQUASHneqM (⇛-val-det tt tt x y₁))
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A3 A4 y y₁ eqtA extA) ind eqta exta inda x f g eqi = ⊥-elim (TSQUASHneqTTRUNC (⇛-val-det tt tt x y₁))
    ...
    ind {u} {w} {T1} {T2} (EQTNOWRITE y y₁) ind eqta exta inda x f g eqi = ⊥-elim (TSQUASHneqNOWRITE (⇛-val-det tt tt x y₁))
    ind {u} {w} {T1} {T2} (EQTNOREAD y y₁) ind eqta exta inda x f g eqi = ⊥-elim (TSQUASHneqNOREAD (⇛-val-det tt tt x y₁))
--    ind {u} {w} {T1} {T2} (EQTPARTIAL A3 A4 y y₁ eqtA) ind eqta exta inda x f g eqi = ⊥-elim (TSQUASHneqPARTIAL (⇛-val-det tt tt x y₁))
    ind {u} {w} {T1} {T2} (EQFFDEFS A3 A4 x1 x2 y y₁ eqtA extA eqx) ind eqta exta inda x f g eqi = ⊥-elim (TSQUASHneqFFDEFS (⇛-val-det tt tt x y₁))
    ind {u} {w} {T1} {T2} (EQTUNIV i p c₁ c₂) ind eqta exta inda x f g eqi = ⊥-elim (TSQUASHneqUNIV (⇛-val-det tt tt x c₂))
    ind {u} {w} {T1} {T2} (EQTLIFT A3 A4 y y₁ eqtA extA) ind eqta exta inda x f g eqi = ⊥-elim (TSQUASHneqLIFT (⇛-val-det tt tt x y₁))
    ind {u} {w} {T1} {T2} (EQTBAR y) ind eqta exta inda x f g eqi =
...
--    ind {u} {w} {T1} {T2} (EQTTNAT x x₁) ind eqta exta inda c₁ c₂ a b ei = ⊥-elim (TSQUASHneqTNAT (⇛-val-det tt tt c₁ x))
    ...
    ind {u} {w} {T1} {T2} (EQTW A3 B3 C3 A4 B4 C4 x x₁ eqta₁ eqtb₁ eqtc₁ exta₁ extb₁ extc₁) ind eqta exta inda c₁ c₂ a b ei = ⊥-elim (TSQUASHneqW (⇛-val-det tt tt c₁ x))
    ind {u} {w} {T1} {T2} (EQTM A3 B3 C3 A4 B4 C4 x x₁ eqta₁ eqtb₁ eqtc₁ exta₁ extb₁ extc₁) ind eqta exta inda c₁ c₂ a b ei = ⊥-elim (TSQUASHneqM (⇛-val-det tt tt c₁ x))
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A3 A4 x x₁ eqta₁ exta₁) ind eqta exta inda c₁ c₂ a b ei = ⊥-elim (TSQUASHneqTTRUNC (⇛-val-det tt tt c₁ x))
    ...
    ind {u} {w} {T1} {T2} (EQTNOENC x x₁) ind eqta exta inda c₁ c₂ a b ei = ⊥-elim (TSQUASHneqNOENC (⇛-val-det tt tt c₁ x))
    ind {u} {w} {T1} {T2} (EQTTERM z₁ z₂ x x₁ x₂) ind eqta exta inda c₁ c₂ a b ei = ⊥-elim (TSQUASHneqTERM (⇛-val-det tt tt c₁ x))
    ind {u} {w} {T1} {T2} (EQTNOWRITE x x₁) ind eqta exta inda c₁ c₂ a b ei = ⊥-elim (TSQUASHneqNOWRITE (⇛-val-det tt tt c₁ x))
    ind {u} {w} {T1} {T2} (EQTNOREAD x x₁) ind eqta exta inda c₁ c₂ a b ei = ⊥-elim (TSQUASHneqNOREAD (⇛-val-det tt tt c₁ x))
...
--    ind {u} {w} {T1} {T2} (EQTTNAT x x₁) ind eqta exta c₁ c₂ a b ei ext = ⊥-elim (TSQUASHneqTNAT (⇛-val-det tt tt c₁ x))
    ...
    ind {u} {w} {T1} {T2} (EQTW A3 B3 C3 A4 B4 C4 x x₁ eqta₁ eqtb₁ eqtc₁ exta₁ extb₁ extc₁) ind eqta exta c₁ c₂ a b ei ext = ⊥-elim (TSQUASHneqW (⇛-val-det tt tt c₁ x))
    ind {u} {w} {T1} {T2} (EQTM A3 B3 C3 A4 B4 C4 x x₁ eqta₁ eqtb₁ eqtc₁ exta₁ extb₁ extc₁) ind eqta exta c₁ c₂ a b ei ext = ⊥-elim (TSQUASHneqM (⇛-val-det tt tt c₁ x))
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A3 A4 x x₁ eqta₁ exta₁) ind eqta exta c₁ c₂ a b ei ext = ⊥-elim (TSQUASHneqTTRUNC (⇛-val-det tt tt c₁ x))
    ...
    ind {u} {w} {T1} {T2} (EQTNOENC x x₁) ind eqta exta c₁ c₂ a b ei ext = ⊥-elim (TSQUASHneqNOENC (⇛-val-det tt tt c₁ x))
    ind {u} {w} {T1} {T2} (EQTTERM z₁ z₂ x x₁ x₂) ind eqta exta c₁ c₂ a b ei ext = ⊥-elim (TSQUASHneqTERM (⇛-val-det tt tt c₁ x))
    ind {u} {w} {T1} {T2} (EQTNOWRITE x x₁) ind eqta exta c₁ c₂ a b ei ext = ⊥-elim (TSQUASHneqNOWRITE (⇛-val-det tt tt c₁ x))
    ind {u} {w} {T1} {T2} (EQTNOREAD x x₁) ind eqta exta c₁ c₂ a b ei ext = ⊥-elim (TSQUASHneqNOREAD (⇛-val-det tt tt c₁ x))
-- ind {u} {w} {T1} {T2} (EQTPARTIAL A3 A4 x x₁ eqtA) ind eqta exta c₁ c₂ a b ei ext = ⊥-elim (TSQUASHneqPARTIAL (⇛-val-det tt tt c₁ x))
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A3 A4 x x₁ eqta₁ exta₁) ind eqta exta inda c₁ c₂ a b ei = ⊥-elim (TSQUASHneqTTRUNC (⇛-val-det tt tt c₁ x))
    ...
    ind {u} {w} {T1} {T2} (EQTNOWRITE x x₁) ind eqta exta inda c₁ c₂ a b ei = ⊥-elim (TSQUASHneqNOWRITE (⇛-val-det tt tt c₁ x))
    ind {u} {w} {T1} {T2} (EQTNOREAD x x₁) ind eqta exta inda c₁ c₂ a b ei = ⊥-elim (TSQUASHneqNOREAD (⇛-val-det tt tt c₁ x))
--    ind {u} {w} {T1} {T2} (EQTPARTIAL A3 A4 x x₁ eqtA) ind eqta exta inda c₁ c₂ a b ei = ⊥-elim (TSQUASHneqPARTIAL (⇛-val-det tt tt c₁ x))
    ind {u} {w} {T1} {T2} (EQFFDEFS A3 A4 x1 x2 x x₁ eqtA extA eqx) ind eqta exta inda c₁ c₂ a b ei = ⊥-elim (TSQUASHneqFFDEFS (⇛-val-det tt tt c₁ x))
    ind {u} {w} {T1} {T2} (EQTUNIV i p d₁ d₂) ind eqta exta inda c₁ c₂ a b ei = ⊥-elim (TSQUASHneqUNIV (⇛-val-det tt tt c₁ d₁))
    ind {u} {w} {T1} {T2} (EQTLIFT A3 A4 x x₁ eqtA extA) ind eqta exta inda c₁ c₂ a b ei = ⊥-elim (TSQUASHneqLIFT (⇛-val-det tt tt c₁ x))
    ind {u} {w} {T1} {T2} (EQTBAR x) ind eqta exta inda c₁ c₂ a b ei =
...
--    ind {u} {w} {T1} {T2} (EQTTNAT x x₁) ind eqta exta c₁ c₂ a b ext ei = ⊥-elim (TSQUASHneqTNAT (⇛-val-det tt tt c₁ x))
    ...
    ind {u} {w} {T1} {T2} (EQTW A3 B3 C3 A4 B4 C4 x x₁ eqta₁ eqtb₁ eqtc₁ exta₁ extb₁ extc₁) ind eqta exta c₁ c₂ a b ext ei = ⊥-elim (TSQUASHneqW (⇛-val-det tt tt c₁ x))
    ind {u} {w} {T1} {T2} (EQTM A3 B3 C3 A4 B4 C4 x x₁ eqta₁ eqtb₁ eqtc₁ exta₁ extb₁ extc₁) ind eqta exta c₁ c₂ a b ext ei = ⊥-elim (TSQUASHneqM (⇛-val-det tt tt c₁ x))
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A3 A4 x x₁ eqta₁ exta₁) ind eqta exta c₁ c₂ a b ext ei = ⊥-elim (TSQUASHneqTTRUNC (⇛-val-det tt tt c₁ x))
    ...
    ind {u} {w} {T1} {T2} (EQTNOENC x x₁) ind eqta exta c₁ c₂ a b ext ei = ⊥-elim (TSQUASHneqNOENC (⇛-val-det tt tt c₁ x))
    ind {u} {w} {T1} {T2} (EQTTERM z₁ z₂ x x₁ x₂) ind eqta exta c₁ c₂ a b ext ei = ⊥-elim (TSQUASHneqTERM (⇛-val-det tt tt c₁ x))
    ind {u} {w} {T1} {T2} (EQTNOWRITE x x₁) ind eqta exta c₁ c₂ a b ext ei = ⊥-elim (TSQUASHneqNOWRITE (⇛-val-det tt tt c₁ x))
    ind {u} {w} {T1} {T2} (EQTNOREAD x x₁) ind eqta exta c₁ c₂ a b ext ei = ⊥-elim (TSQUASHneqNOREAD (⇛-val-det tt tt c₁ x))
--    ind {u} {w} {T1} {T2} (EQTPARTIAL A3 A4 x x₁ eqtA) ind eqta exta c₁ c₂ a b ext ei = ⊥-elim (TSQUASHneqPARTIAL (⇛-val-det tt tt c₁ x))
