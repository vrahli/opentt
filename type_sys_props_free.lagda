...
typeSysConds-FREE-ttrans u w A B x x₁ C (EQTTERM y y₁) = ⊥-elim (FREEneqTERM (⇛-val-det tt tt x₁ y))
...
typeSysConds-FREE-extl1 u w A B x x₁ C (EQTTERM y y₁) a b eqi = ⊥-elim (FREEneqTERM (⇛-val-det tt tt x y))
...
typeSysConds-FREE-extl2 u w A B x x₁ C (EQTTERM y y₁) a b eqi = ⊥-elim (FREEneqTERM (⇛-val-det tt tt x y₁))
...
typeSysConds-FREE-extr1 u w A B x x₁ C (EQTTERM y y₁) a b eqi = ⊥-elim (FREEneqTERM (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-FREE-extr2 u w A B x x₁ C (EQTTERM y y₁) a b eqi = ⊥-elim (FREEneqTERM (⇛-val-det tt tt x₁ y))
...
typeSysConds-FREE-extrevl1 u w A B x x₁ C (EQTTERM y y₁) a b eqi = ⊥-elim (FREEneqTERM (⇛-val-det tt tt x y))
...
typeSysConds-FREE-extrevl2 u w A B x x₁ C (EQTTERM y y₁) a b eqi = ⊥-elim (FREEneqTERM (⇛-val-det tt tt x y₁))
...
typeSysConds-FREE-extrevr1 u w A B x x₁ C (EQTTERM y y₁) a b eqi = ⊥-elim (FREEneqTERM (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-FREE-extrevr2 u w A B x x₁ C (EQTTERM y y₁) a b eqi = ⊥-elim (FREEneqTERM (⇛-val-det tt tt x₁ y))
...
eqInType-⇛-FREE u w A B a b c₁ c₂ (EQTTERM x x₁) ei = ⊥-elim (FREEneqTERM (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-FREE-rev u w A B a b c₁ c₂ (EQTTERM x x₁) ei = ⊥-elim (FREEneqTERM (⇛-val-det tt tt c₁ x))
