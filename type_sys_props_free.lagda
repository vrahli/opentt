...
FREEneqNOWRITE : {c : Term} → ¬ FREE ≡ NOWRITE c
FREEneqNOWRITE {c} ()

FREEneqNOREAD : {c : Term} → ¬ FREE ≡ NOREAD c
FREEneqNOREAD {c} ()
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A1 A2 y y₁ eqtA extA) ih c₁ c₂ = ⊥-elim (FREEneqTTRUNC (⇛-val-det tt tt c₂ y))
    ind {u} {w} {T1} {T2} (EQTNOWRITE A1 A2 y y₁ eqtA extA) ih c₁ c₂ = ⊥-elim (FREEneqNOWRITE (⇛-val-det tt tt c₂ y))
    ind {u} {w} {T1} {T2} (EQTNOREAD A1 A2 y y₁ eqtA extA) ih c₁ c₂ = ⊥-elim (FREEneqNOREAD (⇛-val-det tt tt c₂ y))
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A1 A2 y y₁ eqtA exta) ih comp a b eqi = ⊥-elim (FREEneqTTRUNC (⇛-val-det tt tt comp y))
    ind {u} {w} {T1} {T2} (EQTNOWRITE A1 A2 y y₁ eqtA exta) ih comp a b eqi = ⊥-elim (FREEneqNOWRITE (⇛-val-det tt tt comp y))
    ind {u} {w} {T1} {T2} (EQTNOREAD A1 A2 y y₁ eqtA exta) ih comp a b eqi = ⊥-elim (FREEneqNOREAD (⇛-val-det tt tt comp y))
