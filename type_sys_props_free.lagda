...
FREEneqPARTIAL : {c : Term} → ¬ FREE ≡ PARTIAL c
FREEneqPARTIAL {c} ()
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A1 A2 y y₁ eqtA extA) ih c₁ c₂ = ⊥-elim (FREEneqTTRUNC (⇛-val-det tt tt c₂ y))
    ...
    ind {u} {w} {T1} {T2} (EQTPARTIAL A1 A2 y y₁ eqtA extA) ih c₁ c₂ = ⊥-elim (FREEneqPARTIAL (⇛-val-det tt tt c₂ y))
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A1 A2 y y₁ eqtA exta) ih comp a b eqi = ⊥-elim (FREEneqTTRUNC (⇛-val-det tt tt comp y))
    ...
    ind {u} {w} {T1} {T2} (EQTPARTIAL A1 A2 y y₁ eqtA extA) ih comp a b eqi = ⊥-elim (FREEneqPARTIAL (⇛-val-det tt tt comp y))
