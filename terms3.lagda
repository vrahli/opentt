...
--  differ-TNAT    : differ name1 name2 f TNAT TNAT
  ...
  differ-NATREC  : (a₁ a₂ b₁ b₂ c₁ c₂ : Term) → differ name1 name2 f a₁ a₂ → differ name1 name2 f b₁ b₂ → differ name1 name2 f c₁ c₂ → differ name1 name2 f (NATREC a₁ b₁ c₁) (NATREC a₂ b₂ c₂)
  ...
  differ-WT      : (a₁ a₂ b₁ b₂ c₁ c₂ : Term) → differ name1 name2 f a₁ a₂ → differ name1 name2 f b₁ b₂ → differ name1 name2 f c₁ c₂ → differ name1 name2 f (WT a₁ b₁ c₁) (WT a₂ b₂ c₂)
...
--  differ-DSUP    : (a₁ a₂ b₁ b₂ : Term) → differ name1 name2 f a₁ a₂ → differ name1 name2 f b₁ b₂ → differ name1 name2 f (DSUP a₁ b₁) (DSUP a₂ b₂)
  ...
  differ-MT      : (a₁ a₂ b₁ b₂ c₁ c₂ : Term) → differ name1 name2 f a₁ a₂ → differ name1 name2 f b₁ b₂ → differ name1 name2 f c₁ c₂ → differ name1 name2 f (MT a₁ b₁ c₁) (MT a₂ b₂ c₂)
...
--  differ-TTRUNC  : (a b : Term) → differ name1 name2 f a b → differ name1 name2 f (TTRUNC a) (TTRUNC b)
  ...
  differ-NOENC   : differ name1 name2 f NOENC NOENC
  ...
  differ-PARTIAL : (a b : Term) → differ name1 name2 f a b → differ name1 name2 f (PARTIAL a) (PARTIAL b)
...
--  →differ-shiftUp v {name1} {name2} {f} cf {.TNAT} {.TNAT} differ-TNAT = differ-TNAT
  ...
  →differ-shiftUp v {name1} {name2} {f} cf {.(NATREC a₁ b₁ c₁)} {.(NATREC a₂ b₂ c₂)} (differ-NATREC a₁ a₂ b₁ b₂ c₁ c₂ diff diff₁ diff₂) = differ-NATREC _ _ _ _ _ _ (→differ-shiftUp v cf diff) (→differ-shiftUp v cf diff₁) (→differ-shiftUp v cf diff₂)
  ...
  →differ-shiftUp v {name1} {name2} {f} cf {.(WT a₁ b₁ c₁)} {.(WT a₂ b₂ c₂)} (differ-WT a₁ a₂ b₁ b₂ c₁ c₂ diff diff₁ diff₂) = differ-WT _ _ _ _ _ _ (→differ-shiftUp v cf diff) (→differ-shiftUp (suc v) cf diff₁) (→differ-shiftUp v cf diff₂)
  ...
  →differ-shiftUp v {name1} {name2} {f} cf {.(MT a₁ b₁ c₁)} {.(MT a₂ b₂ c₂)} (differ-MT a₁ a₂ b₁ b₂ c₁ c₂ diff diff₁ diff₂) = differ-MT _ _ _ _ _ _ (→differ-shiftUp v cf diff) (→differ-shiftUp (suc v) cf diff₁) (→differ-shiftUp v cf diff₂)
...
--  →differ-shiftUp v {name1} {name2} {f} cf {.(TTRUNC a)} {.(TTRUNC b)} (differ-TTRUNC a b diff) = differ-TTRUNC _ _ (→differ-shiftUp v cf diff)
  ...
  →differ-shiftUp v {name1} {name2} {f} cf {.(NOENC)} {.(NOENC)} (differ-NOENC) = differ-NOENC
  ...
  →differ-shiftUp v {name1} {name2} {f} cf {.(PARTIAL a)} {.(PARTIAL b)} (differ-PARTIAL a b diff) = differ-PARTIAL _ _ (→differ-shiftUp v cf diff)
...
shiftNameUp-shiftNameUp {i} {j} {PARTIAL t} imp = ≡PARTIAL (shiftNameUp-shiftNameUp {i} {j} {t} imp)
...
--  shiftNameUp-shiftNameUp {i} {j} {TNAT} imp = refl
  ...
  shiftNameUp-shiftNameUp {i} {j} {SUC t} imp = ≡SUC (shiftNameUp-shiftNameUp {i} {j} {t} imp)
  shiftNameUp-shiftNameUp {i} {j} {NATREC t t₁ t₂} imp = ≡NATREC (shiftNameUp-shiftNameUp {i} {j} {t} imp) (shiftNameUp-shiftNameUp {i} {j} {t₁} imp) (shiftNameUp-shiftNameUp {i} {j} {t₂} imp)
  ...
  shiftNameUp-shiftNameUp {i} {j} {WT t t₁ t₂} imp = ≡WT (shiftNameUp-shiftNameUp {i} {j} {t} imp) (shiftNameUp-shiftNameUp {i} {j} {t₁} imp) (shiftNameUp-shiftNameUp {i} {j} {t₂} imp)
  ...
  shiftNameUp-shiftNameUp {i} {j} {MT t t₁ t₂} imp = ≡MT (shiftNameUp-shiftNameUp {i} {j} {t} imp) (shiftNameUp-shiftNameUp {i} {j} {t₁} imp) (shiftNameUp-shiftNameUp {i} {j} {t₂} imp)
...
--  shiftNameUp-shiftNameUp {i} {j} {TTRUNC t} imp = ≡TTRUNC (shiftNameUp-shiftNameUp {i} {j} {t} imp)
  ...
  shiftNameUp-shiftNameUp {i} {j} {NOENC} imp = refl
...
--  →differ-shiftNameUp v {name1} {name2} {f} cf {.TNAT} {.TNAT} differ-TNAT = differ-TNAT
  ...
  →differ-shiftNameUp v {name1} {name2} {f} cf {.(NATREC a₁ b₁ c₁)} {.(NATREC a₂ b₂ c₂)} (differ-NATREC a₁ a₂ b₁ b₂ c₁ c₂ diff diff₁ diff₂) = differ-NATREC _ _ _ _ _ _ (→differ-shiftNameUp v cf diff) (→differ-shiftNameUp v cf diff₁) (→differ-shiftNameUp v cf diff₂)
  ...
  →differ-shiftNameUp v {name1} {name2} {f} cf {.(WT a₁ b₁ c₁)} {.(WT a₂ b₂ c₂)} (differ-WT a₁ a₂ b₁ b₂ c₁ c₂ diff diff₁ diff₂) = differ-WT _ _ _ _ _ _ (→differ-shiftNameUp v cf diff) (→differ-shiftNameUp v cf diff₁) (→differ-shiftNameUp v cf diff₂)
  ...
  →differ-shiftNameUp v {name1} {name2} {f} cf {.(MT a₁ b₁ c₁)} {.(MT a₂ b₂ c₂)} (differ-MT a₁ a₂ b₁ b₂ c₁ c₂ diff diff₁ diff₂) = differ-MT _ _ _ _ _ _ (→differ-shiftNameUp v cf diff) (→differ-shiftNameUp v cf diff₁) (→differ-shiftNameUp v cf diff₂)
...
--  →differ-shiftNameUp v {name1} {name2} {f} cf {.(TTRUNC a)} {.(TTRUNC b)} (differ-TTRUNC a b diff) = differ-TTRUNC _ _ (→differ-shiftNameUp v cf diff)
  ...
  →differ-shiftNameUp v {name1} {name2} {f} cf {.(NOENC)} {.(NOENC)} (differ-NOENC) = differ-NOENC
  ...
  →differ-shiftNameUp v {name1} {name2} {f} cf {.(PARTIAL a)} {.(PARTIAL b)} (differ-PARTIAL a b diff) = differ-PARTIAL _ _ (→differ-shiftNameUp v cf diff)
...
--  differ-subv {name1} {name2} {f} cf v {.TNAT} {.TNAT} {b₁} {b₂} differ-TNAT d₂ = differ-TNAT
  ...
  differ-subv {name1} {name2} {f} cf v {.(NATREC a₁ b₃ c₁)} {.(NATREC a₂ b₄ c₂)} {b₁} {b₂} (differ-NATREC a₁ a₂ b₃ b₄ c₁ c₂ d₁ d₃ d₄) d₂ = differ-NATREC _ _ _ _ _ _ (differ-subv cf v d₁ d₂) (differ-subv cf v d₃ d₂) (differ-subv cf v d₄ d₂)
  ...
  differ-subv {name1} {name2} {f} cf v {.(WT a₁ b₃ c₁)} {.(WT a₂ b₄ c₂)} {b₁} {b₂} (differ-WT a₁ a₂ b₃ b₄ c₁ c₂ d₁ d₃ d₄) d₂ = differ-WT _ _ _ _ _ _ (differ-subv cf v d₁ d₂) (differ-subv cf (suc v) d₃ (→differ-shiftUp 0 cf d₂)) (differ-subv cf v d₄ d₂)
  ...
  differ-subv {name1} {name2} {f} cf v {.(MT a₁ b₃ c₁)} {.(MT a₂ b₄ c₂)} {b₁} {b₂} (differ-MT a₁ a₂ b₃ b₄ c₁ c₂ d₁ d₃ d₄) d₂ = differ-MT _ _ _ _ _ _ (differ-subv cf v d₁ d₂) (differ-subv cf (suc v) d₃ (→differ-shiftUp 0 cf d₂)) (differ-subv cf v d₄ d₂)
...
--  differ-subv {name1} {name2} {f} cf v {.(TTRUNC a)} {.(TTRUNC b)} {b₁} {b₂} (differ-TTRUNC a b d₁) d₂ = differ-TTRUNC _ _ (differ-subv cf v d₁ d₂)
  ...
  differ-subv {name1} {name2} {f} cf v {.(NOENC)} {.(NOENC)} {b₁} {b₂} (differ-NOENC) d₂ = differ-NOENC
  ...
  differ-subv {name1} {name2} {f} cf v {.(PARTIAL a)} {.(PARTIAL b)} {b₁} {b₂} (differ-PARTIAL a b d₁) d₂ = differ-PARTIAL _ _ (differ-subv cf v d₁ d₂)
...
--  →differ-shiftDown v {name1} {name2} {f} cf {.TNAT} {.TNAT} differ-TNAT = differ-TNAT
  ...
  →differ-shiftDown v {name1} {name2} {f} cf {.(NATREC a₁ b₁ c₁)} {.(NATREC a₂ b₂ c₂)} (differ-NATREC a₁ a₂ b₁ b₂ c₁ c₂ diff diff₁ diff₂) = differ-NATREC _ _ _ _ _ _ (→differ-shiftDown v cf diff) (→differ-shiftDown v cf diff₁) (→differ-shiftDown v cf diff₂)
  ...
  →differ-shiftDown v {name1} {name2} {f} cf {.(WT a₁ b₁ c₁)} {.(WT a₂ b₂ c₂)} (differ-WT a₁ a₂ b₁ b₂ c₁ c₂ diff diff₁ diff₂) = differ-WT _ _ _ _ _ _ (→differ-shiftDown v cf diff) (→differ-shiftDown (suc v) cf diff₁) (→differ-shiftDown v cf diff₂)
  ...
  →differ-shiftDown v {name1} {name2} {f} cf {.(MT a₁ b₁ c₁)} {.(MT a₂ b₂ c₂)} (differ-MT a₁ a₂ b₁ b₂ c₁ c₂ diff diff₁ diff₂) = differ-MT _ _ _ _ _ _ (→differ-shiftDown v cf diff) (→differ-shiftDown (suc v) cf diff₁) (→differ-shiftDown v cf diff₂)
...
--  →differ-shiftDown v {name1} {name2} {f} cf {.(TTRUNC a)} {.(TTRUNC b)} (differ-TTRUNC a b diff) = differ-TTRUNC _ _ (→differ-shiftDown v cf diff)
  ...
  →differ-shiftDown v {name1} {name2} {f} cf {.(NOENC)} {.(NOENC)} (differ-NOENC) = differ-NOENC
  ...
  →differ-shiftDown v {name1} {name2} {f} cf {.(PARTIAL a)} {.(PARTIAL b)} (differ-PARTIAL a b diff) = differ-PARTIAL _ _ (→differ-shiftDown v cf diff)
...
--  differ-isValue→ {name1} {name2} {f} {.TNAT} {.TNAT} differ-TNAT isv = tt
  ...
  differ-isValue→ {name1} {name2} {f} {.(WT a₁ b₁ c₁)} {.(WT a₂ b₂ c₂)} (differ-WT a₁ a₂ b₁ b₂ c₁ c₂ diff diff₁ diff₂) isv = tt
  differ-isValue→ {name1} {name2} {f} {.(SUP a₁ b₁)} {.(SUP a₂ b₂)} (differ-SUP a₁ a₂ b₁ b₂ diff diff₁) isv = tt
  differ-isValue→ {name1} {name2} {f} {.(MT a₁ b₁ c₁)} {.(MT a₂ b₂ c₂)} (differ-MT a₁ a₂ b₁ b₂ c₁ c₂ diff diff₁ diff₂) isv = tt
...
--  differ-isValue→ {name1} {name2} {f} {.(TTRUNC a)} {.(TTRUNC b)} (differ-TTRUNC a b diff) isv = tt
  ...
  differ-isValue→ {name1} {name2} {f} {.(NOENC)} {.(NOENC)} (differ-NOENC) isv = tt
  differ-isValue→ {name1} {name2} {f} {.(TERM a)} {.(TERM b)} (differ-TERM a b diff) isv = tt
  differ-isValue→ {name1} {name2} {f} {.(PARTIAL a)} {.(PARTIAL b)} (differ-PARTIAL a b diff) isv = tt
