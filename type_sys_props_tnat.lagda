...
TNATneqNOWRITE : {c : Term} → ¬ TNAT ≡ NOWRITE c
TNATneqNOWRITE {c} ()

TNATneqNOREAD : {c : Term} → ¬ TNAT ≡ NOREAD c
TNATneqNOREAD {c} ()
...
TNATneqPARTIAL : {c : Term} → ¬ TNAT ≡ PARTIAL c
TNATneqPARTIAL {c} ()
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A1 A2 y y₁ eqtA extA) ih c₁ c₂ = ⊥-elim (TNATneqTTRUNC (⇛-val-det tt tt c₂ y))
    ind {u} {w} {T1} {T2} (EQTNOWRITE A1 A2 y y₁ eqtA extA) ih c₁ c₂ = ⊥-elim (TNATneqNOWRITE (⇛-val-det tt tt c₂ y))
    ind {u} {w} {T1} {T2} (EQTNOREAD A1 A2 y y₁ eqtA extA) ih c₁ c₂ = ⊥-elim (TNATneqNOREAD (⇛-val-det tt tt c₂ y))
    ...
    ind {u} {w} {T1} {T2} (EQTPARTIAL A1 A2 y y₁ eqtA) ih c₁ c₂ = ⊥-elim (TNATneqPARTIAL (⇛-val-det tt tt c₂ y))
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A1 A2 y y₁ eqtA exta) ih comp a b eqi = ⊥-elim (TNATneqTTRUNC (⇛-val-det tt tt comp y))
    ind {u} {w} {T1} {T2} (EQTNOWRITE A1 A2 y y₁ eqtA exta) ih comp a b eqi = ⊥-elim (TNATneqNOWRITE (⇛-val-det tt tt comp y))
    ind {u} {w} {T1} {T2} (EQTNOREAD A1 A2 y y₁ eqtA exta) ih comp a b eqi = ⊥-elim (TNATneqNOREAD (⇛-val-det tt tt comp y))
    ind {u} {w} {T1} {T2} (EQTSUBSING A1 A2 y y₁ eqtA exta) ih comp a b eqi = ⊥-elim (TNATneqSUBSING (⇛-val-det tt tt comp y))
    ind {u} {w} {T1} {T2} (EQTPARTIAL A1 A2 y y₁ eqtA) ih comp a b eqi = ⊥-elim (TNATneqPARTIAL (⇛-val-det tt tt comp y))
