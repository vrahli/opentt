...
QNATneqW : {c : Term} {d : Term} → ¬ QNAT ≡ WT c d
QNATneqW {c} {d} ()

QNATneqM : {c : Term} {d : Term} → ¬ QNAT ≡ MT c d
QNATneqM {c} {d} ()
...
typeSysConds-QNAT-ttrans u w A B x x₁ C (EQTTNAT y y₁) = ⊥-elim (QNATneqTNAT (⇛-val-det tt tt x₁ y))
...
typeSysConds-QNAT-ttrans u w A B x x₁ C (EQTW A1 B1 A2 B2 y y₁ eqta eqtb exta extb) = ⊥-elim (QNATneqW (⇛-val-det tt tt x₁ y))
typeSysConds-QNAT-ttrans u w A B x x₁ C (EQTM A1 B1 A2 B2 y y₁ eqta eqtb exta extb) = ⊥-elim (QNATneqM (⇛-val-det tt tt x₁ y))
...
typeSysConds-QNAT-ttrans u w A B x x₁ C (EQTISECT A1 B1 A2 B2 y y₁ eqtA eqtB extA extB) = ⊥-elim (QNATneqISECT (⇛-val-det tt tt x₁ y))
...
typeSysConds-QNAT-ttrans u w A B x x₁ C (EQTSUBSING A1 A2 y y₁ eqtA extA) = ⊥-elim (QNATneqSUBSING (⇛-val-det tt tt x₁ y))
typeSysConds-QNAT-ttrans u w A B x x₁ C (EQTPURE y y₁) = ⊥-elim (QNATneqPURE (⇛-val-det tt tt x₁ y))
typeSysConds-QNAT-ttrans u w A B x x₁ C (EQTNOSEQ y y₁) = ⊥-elim (QNATneqNOSEQ (⇛-val-det tt tt x₁ y))
typeSysConds-QNAT-ttrans u w A B x x₁ C (EQTTERM z₁ z₂ y y₁ y₂) = ⊥-elim (QNATneqTERM (⇛-val-det tt tt x₁ y))
...
typeSysConds-QNAT-extl1 u w A B x x₁ C (EQTTNAT y y₁) a b eqi = ⊥-elim (QNATneqTNAT (⇛-val-det tt tt x y))
...
typeSysConds-QNAT-extl1 u w A B x x₁ C (EQTW A1 B1 A2 B2 y y₁ eqta eqtb exta extb) a b eqi = ⊥-elim (QNATneqW (⇛-val-det tt tt x y))
typeSysConds-QNAT-extl1 u w A B x x₁ C (EQTM A1 B1 A2 B2 y y₁ eqta eqtb exta extb) a b eqi = ⊥-elim (QNATneqM (⇛-val-det tt tt x y))
...
typeSysConds-QNAT-extl1 u w A B x x₁ C (EQTISECT A1 B1 A2 B2 y y₁ eqtA eqtB extA extB) a b eqi = ⊥-elim (QNATneqISECT (⇛-val-det tt tt x y))
...
typeSysConds-QNAT-extl1 u w A B x x₁ C (EQTSUBSING A1 A2 y y₁ eqtA extA) a b eqi = ⊥-elim (QNATneqSUBSING (⇛-val-det tt tt x y))
typeSysConds-QNAT-extl1 u w A B x x₁ C (EQTPURE y y₁) a b eqi = ⊥-elim (QNATneqPURE (⇛-val-det tt tt x y))
typeSysConds-QNAT-extl1 u w A B x x₁ C (EQTNOSEQ y y₁) a b eqi = ⊥-elim (QNATneqNOSEQ (⇛-val-det tt tt x y))
typeSysConds-QNAT-extl1 u w A B x x₁ C (EQTTERM z₁ z₂ y y₁ y₂) a b eqi = ⊥-elim (QNATneqTERM (⇛-val-det tt tt x y))
...
typeSysConds-QNAT-extl2 u w A B x x₁ C (EQTTNAT y y₁) a b eqi = ⊥-elim (QNATneqTNAT (⇛-val-det tt tt x y₁))
...
typeSysConds-QNAT-extl2 u w A B x x₁ C (EQTW A1 B1 A2 B2 y y₁ eqta eqtb exta extb) a b eqi = ⊥-elim (QNATneqW (⇛-val-det tt tt x y₁))
typeSysConds-QNAT-extl2 u w A B x x₁ C (EQTM A1 B1 A2 B2 y y₁ eqta eqtb exta extb) a b eqi = ⊥-elim (QNATneqM (⇛-val-det tt tt x y₁))
...
typeSysConds-QNAT-extl2 u w A B x x₁ C (EQTISECT A1 B1 A2 B2 y y₁ eqtA eqtB extA extB) a b eqi = ⊥-elim (QNATneqISECT (⇛-val-det tt tt x y₁))
...
typeSysConds-QNAT-extl2 u w A B x x₁ C (EQTSUBSING A1 A2 y y₁ eqtA extA) a b eqi = ⊥-elim (QNATneqSUBSING (⇛-val-det tt tt x y₁))
typeSysConds-QNAT-extl2 u w A B x x₁ C (EQTPURE y y₁) a b eqi = ⊥-elim (QNATneqPURE (⇛-val-det tt tt x y₁))
typeSysConds-QNAT-extl2 u w A B x x₁ C (EQTNOSEQ y y₁) a b eqi = ⊥-elim (QNATneqNOSEQ (⇛-val-det tt tt x y₁))
typeSysConds-QNAT-extl2 u w A B x x₁ C (EQTTERM z₁ z₂ y y₁ y₂) a b eqi = ⊥-elim (QNATneqTERM (⇛-val-det tt tt x y₁))
...
typeSysConds-QNAT-extr1 u w A B x x₁ C (EQTTNAT y y₁) a b eqi = ⊥-elim (QNATneqTNAT (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-QNAT-extr1 u w A B x x₁ C (EQTW A1 B1 A2 B2 y y₁ eqta eqtb exta extb) a b eqi = ⊥-elim (QNATneqW (⇛-val-det tt tt x₁ y₁))
typeSysConds-QNAT-extr1 u w A B x x₁ C (EQTM A1 B1 A2 B2 y y₁ eqta eqtb exta extb) a b eqi = ⊥-elim (QNATneqM (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-QNAT-extr1 u w A B x x₁ C (EQTISECT A1 B1 A2 B2 y y₁ eqtA eqtB extA extB) a b eqi = ⊥-elim (QNATneqISECT (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-QNAT-extr1 u w A B x x₁ C (EQTSUBSING A1 A2 y y₁ eqtA extA) a b eqi = ⊥-elim (QNATneqSUBSING (⇛-val-det tt tt x₁ y₁))
typeSysConds-QNAT-extr1 u w A B x x₁ C (EQTPURE y y₁) a b eqi = ⊥-elim (QNATneqPURE (⇛-val-det tt tt x₁ y₁))
typeSysConds-QNAT-extr1 u w A B x x₁ C (EQTNOSEQ y y₁) a b eqi = ⊥-elim (QNATneqNOSEQ (⇛-val-det tt tt x₁ y₁))
typeSysConds-QNAT-extr1 u w A B x x₁ C (EQTTERM z₁ z₂ y y₁ y₂) a b eqi = ⊥-elim (QNATneqTERM (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-QNAT-extr2 u w A B x x₁ C (EQTTNAT y y₁) a b eqi = ⊥-elim (QNATneqTNAT (⇛-val-det tt tt x₁ y))
...
typeSysConds-QNAT-extr2 u w A B x x₁ C (EQTW A1 B1 A2 B2 y y₁ eqta eqtb exta extb) a b eqi = ⊥-elim (QNATneqW (⇛-val-det tt tt x₁ y))
typeSysConds-QNAT-extr2 u w A B x x₁ C (EQTM A1 B1 A2 B2 y y₁ eqta eqtb exta extb) a b eqi = ⊥-elim (QNATneqM (⇛-val-det tt tt x₁ y))
...
typeSysConds-QNAT-extr2 u w A B x x₁ C (EQTISECT A1 B1 A2 B2 y y₁ eqtA eqtB extA extB) a b eqi = ⊥-elim (QNATneqISECT (⇛-val-det tt tt x₁ y))
...
typeSysConds-QNAT-extr2 u w A B x x₁ C (EQTSUBSING A1 A2 y y₁ eqtA extA) a b eqi = ⊥-elim (QNATneqSUBSING (⇛-val-det tt tt x₁ y))
typeSysConds-QNAT-extr2 u w A B x x₁ C (EQTPURE y y₁) a b eqi = ⊥-elim (QNATneqPURE (⇛-val-det tt tt x₁ y))
typeSysConds-QNAT-extr2 u w A B x x₁ C (EQTNOSEQ y y₁) a b eqi = ⊥-elim (QNATneqNOSEQ (⇛-val-det tt tt x₁ y))
typeSysConds-QNAT-extr2 u w A B x x₁ C (EQTTERM z₁ z₂ y y₁ y₂) a b eqi = ⊥-elim (QNATneqTERM (⇛-val-det tt tt x₁ y))
...
typeSysConds-QNAT-extrevl1 u w A B x x₁ C (EQTTNAT y y₁) a b eqi = ⊥-elim (QNATneqTNAT (⇛-val-det tt tt x y))
...
typeSysConds-QNAT-extrevl1 u w A B x x₁ C (EQTW A1 B1 A2 B2 y y₁ eqta eqtb exta extb) a b eqi = ⊥-elim (QNATneqW (⇛-val-det tt tt x y))
typeSysConds-QNAT-extrevl1 u w A B x x₁ C (EQTM A1 B1 A2 B2 y y₁ eqta eqtb exta extb) a b eqi = ⊥-elim (QNATneqM (⇛-val-det tt tt x y))
...
typeSysConds-QNAT-extrevl1 u w A B x x₁ C (EQTISECT A1 B1 A2 B2 y y₁ eqtA eqtB extA extB) a b eqi = ⊥-elim (QNATneqISECT (⇛-val-det tt tt x y))
...
typeSysConds-QNAT-extrevl1 u w A B x x₁ C (EQTSUBSING A1 A2 y y₁ eqtA extA) a b eqi = ⊥-elim (QNATneqSUBSING (⇛-val-det tt tt x y))
typeSysConds-QNAT-extrevl1 u w A B x x₁ C (EQTPURE y y₁) a b eqi = ⊥-elim (QNATneqPURE (⇛-val-det tt tt x y))
typeSysConds-QNAT-extrevl1 u w A B x x₁ C (EQTNOSEQ y y₁) a b eqi = ⊥-elim (QNATneqNOSEQ (⇛-val-det tt tt x y))
typeSysConds-QNAT-extrevl1 u w A B x x₁ C (EQTTERM z₁ z₂ y y₁ y₂) a b eqi = ⊥-elim (QNATneqTERM (⇛-val-det tt tt x y))
...
typeSysConds-QNAT-extrevl2 u w A B x x₁ C (EQTTNAT y y₁) a b eqi = ⊥-elim (QNATneqTNAT (⇛-val-det tt tt x y₁))
...
typeSysConds-QNAT-extrevl2 u w A B x x₁ C (EQTW A1 B1 A2 B2 y y₁ eqta eqtb exta extb) a b eqi = ⊥-elim (QNATneqW (⇛-val-det tt tt x y₁))
typeSysConds-QNAT-extrevl2 u w A B x x₁ C (EQTM A1 B1 A2 B2 y y₁ eqta eqtb exta extb) a b eqi = ⊥-elim (QNATneqM (⇛-val-det tt tt x y₁))
...
typeSysConds-QNAT-extrevl2 u w A B x x₁ C (EQTISECT A1 B1 A2 B2 y y₁ eqtA eqtB extA extB) a b eqi = ⊥-elim (QNATneqISECT (⇛-val-det tt tt x y₁))
...
typeSysConds-QNAT-extrevl2 u w A B x x₁ C (EQTSUBSING A1 A2 y y₁ eqtA extA) a b eqi = ⊥-elim (QNATneqSUBSING (⇛-val-det tt tt x y₁))
typeSysConds-QNAT-extrevl2 u w A B x x₁ C (EQTPURE y y₁) a b eqi = ⊥-elim (QNATneqPURE (⇛-val-det tt tt x y₁))
typeSysConds-QNAT-extrevl2 u w A B x x₁ C (EQTNOSEQ y y₁) a b eqi = ⊥-elim (QNATneqNOSEQ (⇛-val-det tt tt x y₁))
typeSysConds-QNAT-extrevl2 u w A B x x₁ C (EQTTERM z₁ z₂ y y₁ y₂) a b eqi = ⊥-elim (QNATneqTERM (⇛-val-det tt tt x y₁))
...
typeSysConds-QNAT-extrevr1 u w A B x x₁ C (EQTTNAT y y₁) a b eqi = ⊥-elim (QNATneqTNAT (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-QNAT-extrevr1 u w A B x x₁ C (EQTW A1 B1 A2 B2 y y₁ eqta eqtb exta extb) a b eqi = ⊥-elim (QNATneqW (⇛-val-det tt tt x₁ y₁))
typeSysConds-QNAT-extrevr1 u w A B x x₁ C (EQTM A1 B1 A2 B2 y y₁ eqta eqtb exta extb) a b eqi = ⊥-elim (QNATneqM (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-QNAT-extrevr1 u w A B x x₁ C (EQTISECT A1 B1 A2 B2 y y₁ eqtA eqtB extA extB) a b eqi = ⊥-elim (QNATneqISECT (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-QNAT-extrevr1 u w A B x x₁ C (EQTSUBSING A1 A2 y y₁ eqtA extA) a b eqi = ⊥-elim (QNATneqSUBSING (⇛-val-det tt tt x₁ y₁))
typeSysConds-QNAT-extrevr1 u w A B x x₁ C (EQTPURE y y₁) a b eqi = ⊥-elim (QNATneqPURE (⇛-val-det tt tt x₁ y₁))
typeSysConds-QNAT-extrevr1 u w A B x x₁ C (EQTNOSEQ y y₁) a b eqi = ⊥-elim (QNATneqNOSEQ (⇛-val-det tt tt x₁ y₁))
typeSysConds-QNAT-extrevr1 u w A B x x₁ C (EQTTERM z₁ z₂ y y₁ y₂) a b eqi = ⊥-elim (QNATneqTERM (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-QNAT-extrevr2 u w A B x x₁ C (EQTTNAT y y₁) a b eqi = ⊥-elim (QNATneqTNAT (⇛-val-det tt tt x₁ y))
...
typeSysConds-QNAT-extrevr2 u w A B x x₁ C (EQTW A1 B1 A2 B2 y y₁ eqta eqtb exta extb) a b eqi = ⊥-elim (QNATneqW (⇛-val-det tt tt x₁ y))
typeSysConds-QNAT-extrevr2 u w A B x x₁ C (EQTM A1 B1 A2 B2 y y₁ eqta eqtb exta extb) a b eqi = ⊥-elim (QNATneqM (⇛-val-det tt tt x₁ y))
...
typeSysConds-QNAT-extrevr2 u w A B x x₁ C (EQTISECT A1 B1 A2 B2 y y₁ eqtA eqtB extA extB) a b eqi = ⊥-elim (QNATneqISECT (⇛-val-det tt tt x₁ y))
...
typeSysConds-QNAT-extrevr2 u w A B x x₁ C (EQTSUBSING A1 A2 y y₁ eqtA extA) a b eqi = ⊥-elim (QNATneqSUBSING (⇛-val-det tt tt x₁ y))
typeSysConds-QNAT-extrevr2 u w A B x x₁ C (EQTPURE y y₁) a b eqi = ⊥-elim (QNATneqPURE (⇛-val-det tt tt x₁ y))
typeSysConds-QNAT-extrevr2 u w A B x x₁ C (EQTNOSEQ y y₁) a b eqi = ⊥-elim (QNATneqNOSEQ (⇛-val-det tt tt x₁ y))
typeSysConds-QNAT-extrevr2 u w A B x x₁ C (EQTTERM z₁ z₂ y y₁ y₂) a b eqi = ⊥-elim (QNATneqTERM (⇛-val-det tt tt x₁ y))
...
eqInType-⇛-QNAT u w A B a b c₁ c₂ (EQTTNAT x x₁) ei = ⊥-elim (QNATneqTNAT (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-QNAT u w A B a b c₁ c₂ (EQTW A1 B1 A2 B2 x x₁ eqta eqtb exta extb) ei = ⊥-elim (QNATneqW (⇛-val-det tt tt c₁ x))
eqInType-⇛-QNAT u w A B a b c₁ c₂ (EQTM A1 B1 A2 B2 x x₁ eqta eqtb exta extb) ei = ⊥-elim (QNATneqM (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-QNAT u w A B a b c₁ c₂ (EQTISECT A1 B1 A2 B2 x x₁ eqtA eqtB extA extB) ei = ⊥-elim (QNATneqISECT (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-QNAT u w A B a b c₁ c₂ (EQTSUBSING A1 A2 x x₁ eqtA extA) ei = ⊥-elim (QNATneqSUBSING (⇛-val-det tt tt c₁ x))
eqInType-⇛-QNAT u w A B a b c₁ c₂ (EQTPURE x x₁) ei = ⊥-elim (QNATneqPURE (⇛-val-det tt tt c₁ x))
eqInType-⇛-QNAT u w A B a b c₁ c₂ (EQTNOSEQ x x₁) ei = ⊥-elim (QNATneqNOSEQ (⇛-val-det tt tt c₁ x))
eqInType-⇛-QNAT u w A B a b c₁ c₂ (EQTTERM z₁ z₂ y y₁ y₂) ei = ⊥-elim (QNATneqTERM (⇛-val-det tt tt c₁ y))
...
eqInType-⇛-QNAT-rev u w A B a b c₁ c₂ (EQTTNAT x x₁) ei = ⊥-elim (QNATneqTNAT (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-QNAT-rev u w A B a b c₁ c₂ (EQTW A1 B1 A2 B2 x x₁ eqta eqtb exta extb) ei = ⊥-elim (QNATneqW (⇛-val-det tt tt c₁ x))
eqInType-⇛-QNAT-rev u w A B a b c₁ c₂ (EQTM A1 B1 A2 B2 x x₁ eqta eqtb exta extb) ei = ⊥-elim (QNATneqM (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-QNAT-rev u w A B a b c₁ c₂ (EQTISECT A1 B1 A2 B2 x x₁ eqtA eqtB extA extB) ei = ⊥-elim (QNATneqISECT (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-QNAT-rev u w A B a b c₁ c₂ (EQTSUBSING A1 A2 x x₁ eqtA extA) ei = ⊥-elim (QNATneqSUBSING (⇛-val-det tt tt c₁ x))
eqInType-⇛-QNAT-rev u w A B a b c₁ c₂ (EQTPURE x x₁) ei = ⊥-elim (QNATneqPURE (⇛-val-det tt tt c₁ x))
eqInType-⇛-QNAT-rev u w A B a b c₁ c₂ (EQTNOSEQ x x₁) ei = ⊥-elim (QNATneqNOSEQ (⇛-val-det tt tt c₁ x))
eqInType-⇛-QNAT-rev u w A B a b c₁ c₂ (EQTTERM z₁ z₂ y y₁ y₂) ei = ⊥-elim (QNATneqTERM (⇛-val-det tt tt c₁ y))
