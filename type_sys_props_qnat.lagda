...
QNATneqNOWRITE : {c : Term} → ¬ QNAT ≡ NOWRITE c
QNATneqNOWRITE {c} ()

QNATneqNOREAD : {c : Term} → ¬ QNAT ≡ NOREAD c
QNATneqNOREAD {c} ()
...
typeSysConds-QNAT-ttrans u w A B x x₁ C eqt = concl x x₁
  where
    ...
    ind {u} {w} {T1} {T2} (EQTW A1 B1 A2 B2 y y₁ eqta eqtb exta extb) ih c₁ c₂ = ⊥-elim (QNATneqW (⇛-val-det tt tt c₂ y))
    ind {u} {w} {T1} {T2} (EQTM A1 B1 A2 B2 y y₁ eqta eqtb exta extb) ih c₁ c₂ = ⊥-elim (QNATneqM (⇛-val-det tt tt c₂ y))
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A1 A2 y y₁ eqtA extA) ih c₁ c₂ = ⊥-elim (QNATneqTTRUNC (⇛-val-det tt tt c₂ y))
    ind {u} {w} {T1} {T2} (EQTNOWRITE A1 A2 y y₁ eqtA extA) ih c₁ c₂ = ⊥-elim (QNATneqNOWRITE (⇛-val-det tt tt c₂ y))
    ind {u} {w} {T1} {T2} (EQTNOREAD A1 A2 y y₁ eqtA extA) ih c₁ c₂ = ⊥-elim (QNATneqNOREAD (⇛-val-det tt tt c₂ y))
...
typeSysConds-QNAT-extl1 u w A B x x₁ C eqt' =
  ...
  where
    ...
    ind {u} {w} {T1} {T2} (EQTW A1 B1 A2 B2 y y₁ eqta eqtb exta extb) ih comp a b eqi = ⊥-elim (QNATneqW (⇛-val-det tt tt comp y))
    ind {u} {w} {T1} {T2} (EQTM A1 B1 A2 B2 y y₁ eqta eqtb exta extb) ih comp a b eqi = ⊥-elim (QNATneqM (⇛-val-det tt tt comp y))
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A1 A2 y y₁ eqtA exta) ih comp a b eqi = ⊥-elim (QNATneqTTRUNC (⇛-val-det tt tt comp y))
    ind {u} {w} {T1} {T2} (EQTNOWRITE A1 A2 y y₁ eqtA exta) ih comp a b eqi = ⊥-elim (QNATneqNOWRITE (⇛-val-det tt tt comp y))
    ind {u} {w} {T1} {T2} (EQTNOREAD A1 A2 y y₁ eqtA exta) ih comp a b eqi = ⊥-elim (QNATneqNOREAD (⇛-val-det tt tt comp y))
