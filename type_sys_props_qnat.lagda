...
QNATneqPARTIAL : {c : Term} → ¬ QNAT ≡ PARTIAL c
QNATneqPARTIAL {c} ()
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A1 A2 y y₁ eqtA extA) ih c₁ c₂ = ⊥-elim (QNATneqTTRUNC (⇛-val-det tt tt c₂ y))
    ...
    ind {u} {w} {T1} {T2} (EQTPARTIAL A1 A2 y y₁ eqtA extA) ih c₁ c₂ = ⊥-elim (QNATneqPARTIAL (⇛-val-det tt tt c₂ y))
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A1 A2 y y₁ eqtA exta) ih comp a b eqi = ⊥-elim (QNATneqTTRUNC (⇛-val-det tt tt comp y))
    ...
    ind {u} {w} {T1} {T2} (EQTPARTIAL A1 A2 y y₁ eqtA extA) ih comp a b eqi = ⊥-elim (QNATneqPARTIAL (⇛-val-det tt tt comp y))
