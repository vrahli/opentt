...
--    ind {u} {w} {T1} {T2} (EQTPARTIAL A1 A2 y y₁ eqtA) ih c₁ c₂ = ⊥-elim (QNATneqPARTIAL (⇛-val-det tt tt c₂ y))
...
--    ind {u} {w} {T1} {T2} (EQTPARTIAL A1 A2 y y₁ eqtA) ih comp a b eqi = ⊥-elim (QNATneqPARTIAL (⇛-val-det tt tt comp y))
