...
typeSysConds-QNAT-ttrans u w A B x x₁ C (EQTNN t₁ y y₁) = ⊥-elim (QNATneqNN (⇛-val-det tt tt x₁ y))
...
typeSysConds-QNAT-extl1 u w A B x x₁ C (EQTNN t₁ y y₁) a b eqi = ⊥-elim (QNATneqNN (⇛-val-det tt tt x y))
...
typeSysConds-QNAT-extl2 u w A B x x₁ C (EQTNN t₁ y y₁) a b eqi = ⊥-elim (QNATneqNN (⇛-val-det tt tt x y₁))
...
typeSysConds-QNAT-extr1 u w A B x x₁ C (EQTNN t₁ y y₁) a b eqi = ⊥-elim (QNATneqNN (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-QNAT-extr2 u w A B x x₁ C (EQTNN t₁ y y₁) a b eqi = ⊥-elim (QNATneqNN (⇛-val-det tt tt x₁ y))
...
typeSysConds-QNAT-extrevl1 u w A B x x₁ C (EQTNN t₁ y y₁) a b eqi = ⊥-elim (QNATneqNN (⇛-val-det tt tt x y))
...
typeSysConds-QNAT-extrevl2 u w A B x x₁ C (EQTNN t₁ y y₁) a b eqi = ⊥-elim (QNATneqNN (⇛-val-det tt tt x y₁))
...
typeSysConds-QNAT-extrevr1 u w A B x x₁ C (EQTNN t₁ y y₁) a b eqi = ⊥-elim (QNATneqNN (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-QNAT-extrevr2 u w A B x x₁ C (EQTNN t₁ y y₁) a b eqi = ⊥-elim (QNATneqNN (⇛-val-det tt tt x₁ y))
...
eqInType-⇛-QNAT u w A B a b c₁ c₂ (EQTNN t₁ x x₁) ei = ⊥-elim (QNATneqNN (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-QNAT-rev u w A B a b c₁ c₂ (EQTNN t₁ x x₁) ei = ⊥-elim (QNATneqNN (⇛-val-det tt tt c₁ x))
