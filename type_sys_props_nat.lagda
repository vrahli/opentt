...
typeSysConds-NAT-extl1 u w A B x x₁ C (EQTLIFT A1 A2 y y₁ eqtA) a b eqi = ⊥-elim (NATneqLIFT (⇛-val-det tt tt x y))
typeSysConds-NAT-extl1 u w A B x x₁ C (EQTBAR y) a b eqi =
  ...
  where
    ...
    aw w1 e1 z at = typeSysConds-NAT-extl1 u w1 A B (⇛-mon e1 x) (⇛-mon e1 x₁) C z a b (Bar.↑inBar inOpenBar-Bar eqi e1)
...
typeSysConds-NAT-extl2 u w A B x x₁ C (EQTLIFT A1 A2 y y₁ eqtA) a b eqi = ⊥-elim (NATneqLIFT (⇛-val-det tt tt x y₁))
typeSysConds-NAT-extl2 u w A B x x₁ C (EQTBAR y) a b eqi =
  Bar.∀𝕎-inBar-inBar' inOpenBar-Bar y aw
  where
    aw : ∀𝕎 w (λ w' e' → (x : eqTypes u w' C A) (at : atbar y w' e' x) → eqInType u w' x a b)
    aw w1 e1 z at = typeSysConds-NAT-extl2 u w1 A B (⇛-mon e1 x) (⇛-mon e1 x₁) C z a b (Bar.↑inBar inOpenBar-Bar eqi e1)
...
typeSysConds-NAT-extr1 u w A B x x₁ C (EQTLIFT A1 A2 y y₁ eqtA) a b eqi = ⊥-elim (NATneqLIFT (⇛-val-det tt tt x₁ y₁))
typeSysConds-NAT-extr1 u w A B x x₁ C (EQTBAR y) a b eqi =
  Bar.∀𝕎-inBar-inBar' inOpenBar-Bar y aw
  where
    aw : ∀𝕎 w (λ w' e' → (x : eqTypes u w' C B) (at : atbar y w' e' x) → eqInType u w' x a b)
    aw w1 e1 z at = typeSysConds-NAT-extr1 u w1 A B (⇛-mon e1 x) (⇛-mon e1 x₁) C z a b (Bar.↑inBar inOpenBar-Bar eqi e1)
...
typeSysConds-NAT-extr2 u w A B x x₁ C (EQTLIFT A1 A2 y y₁ eqtA) a b eqi = ⊥-elim (NATneqLIFT (⇛-val-det tt tt x₁ y))
typeSysConds-NAT-extr2 u w A B x x₁ C (EQTBAR y) a b eqi =
  Bar.∀𝕎-inBar-inBar' inOpenBar-Bar y aw
  where
    aw : ∀𝕎 w (λ w' e' → (x : eqTypes u w' B C) (at : atbar y w' e' x) → eqInType u w' x a b)
    aw w1 e1 z at = typeSysConds-NAT-extr2 u w1 A B (⇛-mon e1 x) (⇛-mon e1 x₁) C z a b (Bar.↑inBar inOpenBar-Bar eqi e1)
...
typeSysConds-NAT-extrevl1 u w A B x x₁ C (EQTLIFT A1 A2 y y₁ eqtA) a b eqi = ⊥-elim (NATneqLIFT (⇛-val-det tt tt x y))
...
typeSysConds-NAT-extrevl2 u w A B x x₁ C (EQTLIFT A1 A2 y y₁ eqtA) a b eqi = ⊥-elim (NATneqLIFT (⇛-val-det tt tt x y₁))
...
typeSysConds-NAT-extrevr1 u w A B x x₁ C (EQTLIFT A1 A2 y y₁ eqtA) a b eqi = ⊥-elim (NATneqLIFT (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-NAT-extrevr2 u w A B x x₁ C (EQTLIFT A1 A2 y y₁ eqtA) a b eqi = ⊥-elim (NATneqLIFT (⇛-val-det tt tt x₁ y))
...
eqInType-⇛-NAT u w A B a b c₁ c₂ (EQTLIFT A1 A2 x x₁ eqtA) ei = ⊥-elim (NATneqLIFT (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-NAT-rev u w A B a b c₁ c₂ (EQTLIFT A1 A2 x x₁ eqtA) ei = ⊥-elim (NATneqLIFT (⇛-val-det tt tt c₁ x))
eqInType-⇛-NAT-rev u w A B a b c₁ c₂ (EQTBAR x) ei =
  ...
  where
    ...
    aw w1 e1 x₁ at = eqInType-⇛-NAT-rev u w1 A B a b (⇛-mon e1 c₁) (⇛-mon e1 c₂) x₁ (Bar.↑inBar inOpenBar-Bar ei e1)
...
typeSysConds-NAT u w A B x x₁ =
  ...
  where
    ...
    ttrans C eqt1 = EQTBAR (Bar.∀𝕎-inBarFunc inOpenBar-Bar d c)
      where
