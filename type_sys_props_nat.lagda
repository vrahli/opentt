...
typeSysConds-NAT-extl1 u w A B x x₁ C (EQTTERM y y₁) a b eqi = ⊥-elim (NATneqTERM (⇛-val-det tt tt x y))
...
typeSysConds-NAT-extl2 u w A B x x₁ C (EQTTERM y y₁) a b eqi = ⊥-elim (NATneqTERM (⇛-val-det tt tt x y₁))
...
typeSysConds-NAT-extr1 u w A B x x₁ C (EQTTERM y y₁) a b eqi = ⊥-elim (NATneqTERM (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-NAT-extr2 u w A B x x₁ C (EQTTERM y y₁) a b eqi = ⊥-elim (NATneqTERM (⇛-val-det tt tt x₁ y))
...
typeSysConds-NAT-extrevl1 u w A B x x₁ C (EQTTERM y y₁) a b eqi = ⊥-elim (NATneqTERM (⇛-val-det tt tt x y))
...
typeSysConds-NAT-extrevl2 u w A B x x₁ C (EQTTERM y y₁) a b eqi = ⊥-elim (NATneqTERM (⇛-val-det tt tt x y₁))
...
typeSysConds-NAT-extrevr1 u w A B x x₁ C (EQTTERM y y₁) a b eqi = ⊥-elim (NATneqTERM (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-NAT-extrevr2 u w A B x x₁ C (EQTTERM y y₁) a b eqi = ⊥-elim (NATneqTERM (⇛-val-det tt tt x₁ y))
...
eqInType-⇛-NAT u w A B a b c₁ c₂ (EQTTERM x x₁) ei = ⊥-elim (NATneqTERM (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-NAT-rev u w A B a b c₁ c₂ (EQTTERM x x₁) ei = ⊥-elim (NATneqTERM (⇛-val-det tt tt c₁ x))
...
typeSysConds-NAT-ttrans u w A B x x₁ C (EQTTERM y y₁) = ⊥-elim (NATneqTERM (⇛-val-det tt tt x₁ y))
