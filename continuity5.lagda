...
abstract
  ...
  step-updRel gc {n} {name} {f} {g} {.(TERM)} {.(TERM)} {x} {w1} {w2} {w} nnf nng cf cg comp ind (updRel-TERM) gtn compat wgt0 eqn rewrite pair-inj₁ (just-inj (sym comp)) | pair-inj₂ (just-inj (sym comp)) = 0 , 0 , TERM , TERM , w1 , refl , refl , updRel-TERM
...
abstract
  ...
  updRel-refl {name} {f} {g} {TERM} nn = updRel-TERM
