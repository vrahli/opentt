...
SUMneqW : {a b : Term} {c d e : Term} → ¬ (SUM a b) ≡ WT c d e
SUMneqW {a} {b} {c} {d} {e} ()

SUMneqM : {a b : Term} {c d e : Term} → ¬ (SUM a b) ≡ MT c d e
SUMneqM {a} {b} {c} {d} {e} ()
...
SUMneqNOWRITE : {a b : Term} → ¬ (SUM a b) ≡ NOWRITE
SUMneqNOWRITE {a} {b} ()

SUMneqNOREAD : {a b : Term} → ¬ (SUM a b) ≡ NOREAD
SUMneqNOREAD {a} {b} ()
...
SUMneqNOENC : {a b : Term} → ¬ (SUM a b) ≡ NOENC
SUMneqNOENC {a} {b} ()
...
SUMneqPARTIAL : {a b : Term} {c : Term} → ¬ (SUM a b) ≡ PARTIAL c
SUMneqPARTIAL {a} {b} {c} ()
...
--    ind {u} {w} {T1} {T2} (EQTTNAT y y₁) ind x x₁ eqta eqtb exta extb inda indb = ⊥-elim (SUMneqTNAT (⇛-val-det tt tt x₁ y))
    ...
    ind {u} {w} {T1} {T2} (EQTW C1 D1 E1 C2 D2 E2 y y₁ eqta0 eqtb0 eqtc0 exta0 extb0 extc0) ind x x₁ eqta eqtb exta extb inda indb = ⊥-elim (SUMneqW (⇛-val-det tt tt x₁ y))
    ind {u} {w} {T1} {T2} (EQTM C1 D1 E1 C2 D2 E2 y y₁ eqta0 eqtb0 eqtc0 exta0 extb0 extc0) ind x x₁ eqta eqtb exta extb inda indb = ⊥-elim (SUMneqM (⇛-val-det tt tt x₁ y))
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A3 A4 y y₁ eqtA extA) ind x x₁ eqta eqtb exta extb inda indb = ⊥-elim (SUMneqTTRUNC (⇛-val-det tt tt x₁ y))
    ...
    ind {u} {w} {T1} {T2} (EQTNOENC y y₁) ind x x₁ eqta eqtb exta extb inda indb = ⊥-elim (SUMneqNOENC (⇛-val-det tt tt x₁ y))
    ind {u} {w} {T1} {T2} (EQTTERM z₁ z₂ y y₁ y₂) ind x x₁ eqta eqtb exta extb inda indb = ⊥-elim (SUMneqTERM (⇛-val-det tt tt x₁ y))
    ind {u} {w} {T1} {T2} (EQTNOWRITE y y₁) ind x x₁ eqta eqtb exta extb inda indb = ⊥-elim (SUMneqNOWRITE (⇛-val-det tt tt x₁ y))
    ind {u} {w} {T1} {T2} (EQTNOREAD y y₁) ind x x₁ eqta eqtb exta extb inda indb = ⊥-elim (SUMneqNOREAD (⇛-val-det tt tt x₁ y))
    ind {u} {w} {T1} {T2} (EQTPARTIAL A3 A4 y y₁ eqtA extA) ind x x₁ eqta eqtb exta extb inda indb = ⊥-elim (SUMneqPARTIAL (⇛-val-det tt tt x₁ y))
...
--    ind {u} {w} {T1} {T2} (EQTTNAT y y₁) ind eqta eqtb exta extb inda indb x f g eqi = ⊥-elim (SUMneqTNAT (⇛-val-det tt tt x y))
    ...
    ind {u} {w} {T1} {T2} (EQTW A3 B3 C3 A4 B4 C4 y y₁ eqta0 eqtb0 eqtc0 exta0 extb0 extc0) ind eqta eqtb exta extb inda indb x f g eqi = ⊥-elim (SUMneqW (⇛-val-det tt tt x y))
    ind {u} {w} {T1} {T2} (EQTM A3 B3 C3 A4 B4 C4 y y₁ eqta0 eqtb0 eqtc0 exta0 extb0 extc0) ind eqta eqtb exta extb inda indb x f g eqi = ⊥-elim (SUMneqM (⇛-val-det tt tt x y))
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A3 A4 y y₁ eqtA extA) ind eqta eqtb exta extb inda indb x f g eqi = ⊥-elim (SUMneqTTRUNC (⇛-val-det tt tt x y))
    ...
    ind {u} {w} {T1} {T2} (EQTPARTIAL A3 A4 y y₁ eqtA extA) ind eqta eqtb exta extb inda indb x f g eqi = ⊥-elim (SUMneqPARTIAL (⇛-val-det tt tt x y))
    ...
    ind {u} {w} {T1} {T2} (EQTNOENC y y₁) ind eqta eqtb exta extb inda indb x f g eqi = ⊥-elim (SUMneqNOENC (⇛-val-det tt tt x y))
    ind {u} {w} {T1} {T2} (EQTTERM z₁ z₂ y y₁ y₂) ind eqta eqtb exta extb inda indb x f g eqi = ⊥-elim (SUMneqTERM (⇛-val-det tt tt x y))
    ind {u} {w} {T1} {T2} (EQTNOWRITE y y₁) ind eqta eqtb exta extb inda indb x f g eqi = ⊥-elim (SUMneqNOWRITE (⇛-val-det tt tt x y))
    ind {u} {w} {T1} {T2} (EQTNOREAD y y₁) ind eqta eqtb exta extb inda indb x f g eqi = ⊥-elim (SUMneqNOREAD (⇛-val-det tt tt x y))
...
--    ind {u} {w} {T1} {T2} (EQTTNAT y y₁) ind eqta eqtb exta extb inda indb x f g eqi = ⊥-elim (SUMneqTNAT (⇛-val-det tt tt x y₁))
    ...
    ind {u} {w} {T1} {T2} (EQTW A3 B3 C3 A4 B4 C4 y y₁ eqta₁ eqtb₁ eqtc₁ exta₁ extb₁ extc₁) ind eqta eqtb exta extb inda indb x f g eqi = ⊥-elim (SUMneqW (⇛-val-det tt tt x y₁))
    ind {u} {w} {T1} {T2} (EQTM A3 B3 C3 A4 B4 C4 y y₁ eqta₁ eqtb₁ eqtc₁ exta₁ extb₁ extc₁) ind eqta eqtb exta extb inda indb x f g eqi = ⊥-elim (SUMneqM (⇛-val-det tt tt x y₁))
...
--    ind {u} {w} {T1} {T2} (EQTTNAT x x₁) ind eqta eqtb exta extb inda indb c₁ c₂ a b ei = ⊥-elim (SUMneqTNAT (⇛-val-det tt tt c₁ x))
    ...
    ind {u} {w} {T1} {T2} (EQTW A3 B3 C3 A4 B4 C4 x x₁ eqta₁ eqtb₁ eqtc₁ exta₁ extb₁ extc₁) ind eqta eqtb exta extb inda indb c₁ c₂ a b ei = ⊥-elim (SUMneqW (⇛-val-det tt tt c₁ x))
    ind {u} {w} {T1} {T2} (EQTM A3 B3 C3 A4 B4 C4 x x₁ eqta₁ eqtb₁ eqtc₁ exta₁ extb₁ extc₁) ind eqta eqtb exta extb inda indb c₁ c₂ a b ei = ⊥-elim (SUMneqM (⇛-val-det tt tt c₁ x))
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A3 A4 x x₁ eqta₁ exta₁) ind eqta eqtb exta extb inda indb c₁ c₂ a b ei = ⊥-elim (SUMneqTTRUNC (⇛-val-det tt tt c₁ x))
    ...
    ind {u} {w} {T1} {T2} (EQTPARTIAL A3 A4 x x₁ eqta₁ exta₁) ind eqta eqtb exta extb inda indb c₁ c₂ a b ei = ⊥-elim (SUMneqPARTIAL (⇛-val-det tt tt c₁ x))
    ...
    ind {u} {w} {T1} {T2} (EQTNOENC x x₁) ind eqta eqtb exta extb inda indb c₁ c₂ a b ei = ⊥-elim (SUMneqNOENC (⇛-val-det tt tt c₁ x))
    ind {u} {w} {T1} {T2} (EQTTERM z₁ z₂ x x₁ x₂) ind eqta eqtb exta extb inda indb c₁ c₂ a b ei = ⊥-elim (SUMneqTERM (⇛-val-det tt tt c₁ x))
    ind {u} {w} {T1} {T2} (EQTNOWRITE x x₁) ind eqta eqtb exta extb inda indb c₁ c₂ a b ei = ⊥-elim (SUMneqNOWRITE (⇛-val-det tt tt c₁ x))
    ind {u} {w} {T1} {T2} (EQTNOREAD x x₁) ind eqta eqtb exta extb inda indb c₁ c₂ a b ei = ⊥-elim (SUMneqNOREAD (⇛-val-det tt tt c₁ x))
...
--    ind {u} {w} {T1} {T2} (EQTTNAT x x₁) ind eqta eqtb exta extb c₁ c₂ a b ei ext = ⊥-elim (SUMneqTNAT (⇛-val-det tt tt c₁ x))
    ...
    ind {u} {w} {T1} {T2} (EQTW A3 B3 C3 A4 B4 C4 x x₁ eqta₁ eqtb₁ eqtc₁ exta₁ extb₁ extc₁) ind eqta eqtb exta extb c₁ c₂ a b ei ext = ⊥-elim (SUMneqW (⇛-val-det tt tt c₁ x))
    ind {u} {w} {T1} {T2} (EQTM A3 B3 C3 A4 B4 C4 x x₁ eqta₁ eqtb₁ eqtc₁ exta₁ extb₁ extc₁) ind eqta eqtb exta extb c₁ c₂ a b ei ext = ⊥-elim (SUMneqM (⇛-val-det tt tt c₁ x))
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A3 A4 x x₁ eqta₁ exta₁) ind eqta eqtb exta extb c₁ c₂ a b ei ext = ⊥-elim (SUMneqTTRUNC (⇛-val-det tt tt c₁ x))
    ...
    ind {u} {w} {T1} {T2} (EQTNOENC x x₁) ind eqta eqtb exta extb c₁ c₂ a b ei ext = ⊥-elim (SUMneqNOENC (⇛-val-det tt tt c₁ x))
    ind {u} {w} {T1} {T2} (EQTTERM z₁ z₂ x x₁ x₂) ind eqta eqtb exta extb c₁ c₂ a b ei ext = ⊥-elim (SUMneqTERM (⇛-val-det tt tt c₁ x))
    ind {u} {w} {T1} {T2} (EQTNOWRITE x x₁) ind eqta eqtb exta extb c₁ c₂ a b ei ext = ⊥-elim (SUMneqNOWRITE (⇛-val-det tt tt c₁ x))
    ind {u} {w} {T1} {T2} (EQTNOREAD x x₁) ind eqta eqtb exta extb c₁ c₂ a b ei ext = ⊥-elim (SUMneqNOREAD (⇛-val-det tt tt c₁ x))
    ind {u} {w} {T1} {T2} (EQTPARTIAL A3 A4 x x₁ eqtA extA) ind eqta eqtb exta extb c₁ c₂ a b ei ext = ⊥-elim (SUMneqPARTIAL (⇛-val-det tt tt c₁ x))
...
--    ind {u} {w} {T1} {T2} (EQTTNAT x x₁) ind eqta eqtb exta extb c₁ c₂ a b ext ei = ⊥-elim (SUMneqTNAT (⇛-val-det tt tt c₁ x))
    ...
    ind {u} {w} {T1} {T2} (EQTW A3 B3 C3 A4 B4 C4 x x₁ eqta₁ eqtb₁ eqtc₁ exta₁ extb₁ extc₁) ind eqta eqtb exta extb c₁ c₂ a b ext ei = ⊥-elim (SUMneqW (⇛-val-det tt tt c₁ x))
    ind {u} {w} {T1} {T2} (EQTM A3 B3 C3 A4 B4 C4 x x₁ eqta₁ eqtb₁ eqtc₁ exta₁ extb₁ extc₁) ind eqta eqtb exta extb c₁ c₂ a b ext ei = ⊥-elim (SUMneqM (⇛-val-det tt tt c₁ x))
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A3 A4 x x₁ eqta₁ exta₁) ind eqta eqtb exta extb c₁ c₂ a b ext ei = ⊥-elim (SUMneqTTRUNC (⇛-val-det tt tt c₁ x))
    ...
    ind {u} {w} {T1} {T2} (EQTNOENC x x₁) ind eqta eqtb exta extb c₁ c₂ a b ext ei = ⊥-elim (SUMneqNOENC (⇛-val-det tt tt c₁ x))
    ind {u} {w} {T1} {T2} (EQTTERM z₁ z₂ x x₁ x₂) ind eqta eqtb exta extb c₁ c₂ a b ext ei = ⊥-elim (SUMneqTERM (⇛-val-det tt tt c₁ x))
    ind {u} {w} {T1} {T2} (EQTNOWRITE x x₁) ind eqta eqtb exta extb c₁ c₂ a b ext ei = ⊥-elim (SUMneqNOWRITE (⇛-val-det tt tt c₁ x))
    ind {u} {w} {T1} {T2} (EQTNOREAD x x₁) ind eqta eqtb exta extb c₁ c₂ a b ext ei = ⊥-elim (SUMneqNOREAD (⇛-val-det tt tt c₁ x))
    ind {u} {w} {T1} {T2} (EQTPARTIAL A3 A4 x x₁ eqtA extA) ind eqta eqtb exta extb c₁ c₂ a b ext ei = ⊥-elim (SUMneqPARTIAL (⇛-val-det tt tt c₁ x))
