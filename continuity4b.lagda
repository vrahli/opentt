...
--  updRel2-TNAT    : updRel2 name f g r TNAT TNAT
  ...
  updRel2-NATREC  : (a₁ a₂ b₁ b₂ c₁ c₂ : Term) → updRel2 name f g r a₁ a₂ → updRel2 name f g r b₁ b₂ → updRel2 name f g r c₁ c₂ → updRel2 name f g r (NATREC a₁ b₁ c₁) (NATREC a₂ b₂ c₂)
  ...
  updRel2-WT      : (a₁ a₂ b₁ b₂ c₁ c₂ : Term) → updRel2 name f g r a₁ a₂ → updRel2 name f g r b₁ b₂ → updRel2 name f g r c₁ c₂ → updRel2 name f g r (WT a₁ b₁ c₁) (WT a₂ b₂ c₂)
  ...
  updRel2-MT      : (a₁ a₂ b₁ b₂ c₁ c₂ : Term) → updRel2 name f g r a₁ a₂ → updRel2 name f g r b₁ b₂ → updRel2 name f g r c₁ c₂ → updRel2 name f g r (MT a₁ b₁ c₁) (MT a₂ b₂ c₂)
...
--  updRel2-refl {name} {f} {g} {r} {TNAT} nn = updRel2-TNAT
  ...
  updRel2-refl {name} {f} {g} {r} {NATREC a a₁ a₂} nn = updRel2-NATREC _ _ _ _ _ _ (updRel2-refl (∧≡true→1-3 {¬names a} {¬names a₁} {¬names a₂} nn)) (updRel2-refl (∧≡true→2-3 {¬names a} {¬names a₁} {¬names a₂} nn)) (updRel2-refl (∧≡true→3-3 {¬names a} {¬names a₁} {¬names a₂} nn))
  ...
  updRel2-refl {name} {f} {g} {r} {WT a a₁ a₂} nn = updRel2-WT _ _ _ _ _ _ (updRel2-refl (∧≡true→1-3 {¬names a} {¬names a₁} {¬names a₂} nn)) (updRel2-refl (∧≡true→2-3 {¬names a} {¬names a₁} {¬names a₂} nn)) (updRel2-refl (∧≡true→3-3 {¬names a} {¬names a₁} {¬names a₂} nn))
  ...
  updRel2-refl {name} {f} {g} {r} {MT a a₁ a₂} nn = updRel2-MT _ _ _ _ _ _ (updRel2-refl (∧≡true→1-3 {¬names a} {¬names a₁} {¬names a₂} nn)) (updRel2-refl (∧≡true→2-3 {¬names a} {¬names a₁} {¬names a₂} nn)) (updRel2-refl (∧≡true→3-3 {¬names a} {¬names a₁} {¬names a₂} nn))
...
--  updRel2-shiftUp n {name} {f} {g} {r} cf cg {.TNAT} {.TNAT} updRel2-TNAT = updRel2-TNAT
  ...
  updRel2-shiftUp n {name} {f} {g} {r} cf cg {.(NATREC a₁ b₁ c₁)} {.(NATREC a₂ b₂ c₂)} (updRel2-NATREC a₁ a₂ b₁ b₂ c₁ c₂ u u₁ u₂) = updRel2-NATREC _ _ _ _ _ _ (updRel2-shiftUp n cf cg u) (updRel2-shiftUp n cf cg u₁) (updRel2-shiftUp n cf cg u₂)
  ...
  updRel2-shiftUp n {name} {f} {g} {r} cf cg {.(WT a₁ b₁ c₁)} {.(WT a₂ b₂ c₂)} (updRel2-WT a₁ a₂ b₁ b₂ c₁ c₂ u u₁ u₂) = updRel2-WT _ _ _ _ _ _ (updRel2-shiftUp n cf cg u) (updRel2-shiftUp (suc n) cf cg u₁) (updRel2-shiftUp n cf cg u₂)
  ...
  updRel2-shiftUp n {name} {f} {g} {r} cf cg {.(MT a₁ b₁ c₁)} {.(MT a₂ b₂ c₂)} (updRel2-MT a₁ a₂ b₁ b₂ c₁ c₂ u u₁ u₂) = updRel2-MT _ _ _ _ _ _ (updRel2-shiftUp n cf cg u) (updRel2-shiftUp (suc n) cf cg u₁) (updRel2-shiftUp n cf cg u₂)
...
--  updRel2-shiftDown n {name} {f} {g} {r} cf cg {.TNAT} {.TNAT} updRel2-TNAT = updRel2-TNAT
  ...
  updRel2-shiftDown n {name} {f} {g} {r} cf cg {.(NATREC a₁ b₁ c₁)} {.(NATREC a₂ b₂ c₂)} (updRel2-NATREC a₁ a₂ b₁ b₂ c₁ c₂ u u₁ u₂) = updRel2-NATREC _ _ _ _ _ _ (updRel2-shiftDown n cf cg u) (updRel2-shiftDown n cf cg u₁) (updRel2-shiftDown n cf cg u₂)
  ...
  updRel2-shiftDown n {name} {f} {g} {r} cf cg {.(WT a₁ b₁ c₁)} {.(WT a₂ b₂ c₂)} (updRel2-WT a₁ a₂ b₁ b₂ c₁ c₂ u u₁ u₂) = updRel2-WT _ _ _ _ _ _ (updRel2-shiftDown n cf cg u) (updRel2-shiftDown (suc n) cf cg u₁) (updRel2-shiftDown n cf cg u₂)
  ...
  updRel2-shiftDown n {name} {f} {g} {r} cf cg {.(MT a₁ b₁ c₁)} {.(MT a₂ b₂ c₂)} (updRel2-MT a₁ a₂ b₁ b₂ c₁ c₂ u u₁ u₂) = updRel2-MT _ _ _ _ _ _ (updRel2-shiftDown n cf cg u) (updRel2-shiftDown (suc n) cf cg u₁) (updRel2-shiftDown n cf cg u₂)
...
--  updRel2-shiftNameUp n {name} {f} {g} {r} cf cg {.TNAT} {.TNAT} updRel2-TNAT = updRel2-TNAT
  ...
  updRel2-shiftNameUp n {name} {f} {g} {r} cf cg {.(NATREC a₁ b₁ c₁)} {.(NATREC a₂ b₂ c₂)} (updRel2-NATREC a₁ a₂ b₁ b₂ c₁ c₂ u u₁ u₂) = updRel2-NATREC _ _ _ _ _ _ (updRel2-shiftNameUp n cf cg u) (updRel2-shiftNameUp n cf cg u₁) (updRel2-shiftNameUp n cf cg u₂)
  ...
  updRel2-shiftNameUp n {name} {f} {g} {r} cf cg {.(WT a₁ b₁ c₁)} {.(WT a₂ b₂ c₂)} (updRel2-WT a₁ a₂ b₁ b₂ c₁ c₂ u u₁ u₂) = updRel2-WT _ _ _ _ _ _ (updRel2-shiftNameUp n cf cg u) (updRel2-shiftNameUp n cf cg u₁) (updRel2-shiftNameUp n cf cg u₂)
  ...
  updRel2-shiftNameUp n {name} {f} {g} {r} cf cg {.(MT a₁ b₁ c₁)} {.(MT a₂ b₂ c₂)} (updRel2-MT a₁ a₂ b₁ b₂ c₁ c₂ u u₁ u₂) = updRel2-MT _ _ _ _ _ _ (updRel2-shiftNameUp n cf cg u) (updRel2-shiftNameUp n cf cg u₁) (updRel2-shiftNameUp n cf cg u₂)
...
--  updRel2-subv v {name} {f} {g} {r} cf cg {.TNAT} {.TNAT} {b₁} {b₂} updRel2-TNAT ub = updRel2-TNAT
  ...
  updRel2-subv v {name} {f} {g} {r} cf cg {.(NATREC a₁ b₃ c₁)} {.(NATREC a₂ b₄ c₂)} {b₁} {b₂} (updRel2-NATREC a₁ a₂ b₃ b₄ c₁ c₂ ua ua₁ ua₂) ub = updRel2-NATREC _ _ _ _ _ _ (updRel2-subv v cf cg ua ub) (updRel2-subv v cf cg ua₁ ub) (updRel2-subv v cf cg ua₂ ub)
  ...
  updRel2-subv v {name} {f} {g} {r} cf cg {.(WT a₁ b₃ c₁)} {.(WT a₂ b₄ c₂)} {b₁} {b₂} (updRel2-WT a₁ a₂ b₃ b₄ c₁ c₂ ua ua₁ ua₂) ub = updRel2-WT _ _ _ _ _ _ (updRel2-subv v cf cg ua ub) (updRel2-subv (suc v) cf cg ua₁ (updRel2-shiftUp 0 cf cg ub)) (updRel2-subv v cf cg ua₂ ub)
  ...
  updRel2-subv v {name} {f} {g} {r} cf cg {.(MT a₁ b₃ c₁)} {.(MT a₂ b₄ c₂)} {b₁} {b₂} (updRel2-MT a₁ a₂ b₃ b₄ c₁ c₂ ua ua₁ ua₂) ub = updRel2-MT _ _ _ _ _ _ (updRel2-subv v cf cg ua ub) (updRel2-subv (suc v) cf cg ua₁ (updRel2-shiftUp 0 cf cg ub)) (updRel2-subv v cf cg ua₂ ub)
