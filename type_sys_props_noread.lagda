...
NOREADneqW : {c : Term} {d : Term} → ¬ NOREAD ≡ WT c d
NOREADneqW {c} {d} ()

NOREADneqM : {c : Term} {d : Term} → ¬ NOREAD ≡ MT c d
NOREADneqM {c} {d} ()
...
--    ind {u} {w} {T1} {T2} (EQTTNAT y y₁) ind x x₁ = ⊥-elim (NOREADneqTNAT (⇛-val-det tt tt x₁ y))
    ...
    ind {u} {w} {T1} {T2} (EQTW C1 D1 C2 D2 y y₁ eqta0 eqtb0 exta0 extb0) ind x x₁ = ⊥-elim (NOREADneqW (⇛-val-det tt tt x₁ y))
    ind {u} {w} {T1} {T2} (EQTM C1 D1 C2 D2 y y₁ eqta0 eqtb0 exta0 extb0) ind x x₁ = ⊥-elim (NOREADneqM (⇛-val-det tt tt x₁ y))
...
--    ind {u} {w} {T1} {T2} (EQTTNAT y y₁) ind x f g eqi = ⊥-elim (NOREADneqTNAT (⇛-val-det tt tt x y))
    ...
    ind {u} {w} {T1} {T2} (EQTW A3 B3 A4 B4 y y₁ eqta0 eqtb0 exta0 extb0) ind x f g eqi = ⊥-elim (NOREADneqW (⇛-val-det tt tt x y))
    ind {u} {w} {T1} {T2} (EQTM A3 B3 A4 B4 y y₁ eqta0 eqtb0 exta0 extb0) ind x f g eqi = ⊥-elim (NOREADneqM (⇛-val-det tt tt x y))
...
--    ind {u} {w} {T1} {T2} (EQTTNAT y y₁) ind x f g eqi = ⊥-elim (NOREADneqTNAT (⇛-val-det tt tt x y₁))
    ...
    ind {u} {w} {T1} {T2} (EQTW A3 B3 A4 B4 y y₁ eqta₁ eqtb₁ exta₁ extb₁) ind x f g eqi = ⊥-elim (NOREADneqW (⇛-val-det tt tt x y₁))
    ind {u} {w} {T1} {T2} (EQTM A3 B3 A4 B4 y y₁ eqta₁ eqtb₁ exta₁ extb₁) ind x f g eqi = ⊥-elim (NOREADneqM (⇛-val-det tt tt x y₁))
