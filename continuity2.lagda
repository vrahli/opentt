...
open import props0(W)(M)(C)(K)(P)(G)(X)(N)(E) using (⇓-from-to→≡𝕎 ; ⇓-from-to≡wᵣ ; ⇓-from-to≡wₗ)
...
--  updCtxt-DSUP    : (a b : Term) → updCtxt name f a → updCtxt name f b → updCtxt name f (DSUP a b)
  ...
  updCtxt-MT      : (a b : Term) → updCtxt name f a → updCtxt name f b → updCtxt name f (MT a b)
...
abstract
  ...
  updCtxt→differ {name} {f} {.(MT a b)} (updCtxt-MT a b u u₁) = differ-MT _ _ _ _ (updCtxt→differ u) (updCtxt→differ u₁)
...
abstract
  ...
  differ→updCtxt {name} {f} {.(MT a₁ b₁)} (differ-MT a₁ .a₁ b₁ .b₁ d d₁) = updCtxt-MT _ _ (differ→updCtxt d) (differ→updCtxt d₁)
