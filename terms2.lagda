...
--  shiftUp-shiftNameUp c d (TTRUNC t) rewrite shiftUp-shiftNameUp c d t = refl
  shiftUp-shiftNameUp c d (NOWRITE t) rewrite shiftUp-shiftNameUp c d t = refl
  shiftUp-shiftNameUp c d (NOREAD t) rewrite shiftUp-shiftNameUp c d t = refl
...
--  renn-shiftNameUp n1 n2 (TTRUNC t) rewrite renn-shiftNameUp n1 n2 t = refl
  renn-shiftNameUp n1 n2 (NOWRITE t) rewrite renn-shiftNameUp n1 n2 t = refl
  renn-shiftNameUp n1 n2 (NOREAD t) rewrite renn-shiftNameUp n1 n2 t = refl
...
--  shiftNameDownUp n (TTRUNC t) rewrite shiftNameDownUp n t = refl
  shiftNameDownUp n (NOWRITE t) rewrite shiftNameDownUp n t = refl
  shiftNameDownUp n (NOREAD t) rewrite shiftNameDownUp n t = refl
...
--  ¬names-shiftUp n (TTRUNC a) rewrite ¬names-shiftUp n a = refl
  ¬names-shiftUp n (NOWRITE a) rewrite ¬names-shiftUp n a = refl
  ¬names-shiftUp n (NOREAD a) rewrite ¬names-shiftUp n a = refl
...
--  ¬names-shiftDown n (TTRUNC a) rewrite ¬names-shiftDown n a = refl
  ¬names-shiftDown n (NOWRITE a) rewrite ¬names-shiftDown n a = refl
  ¬names-shiftDown n (NOREAD a) rewrite ¬names-shiftDown n a = refl
...
--  ¬Names-subv v {a} {TTRUNC b} na nb = ¬Names-subv v {a} {b} na nb
  ¬Names-subv v {a} {NOWRITE b} na nb = ¬Names-subv v {a} {b} na nb
  ¬Names-subv v {a} {NOREAD b} na nb = ¬Names-subv v {a} {b} na nb
...
--  noseq-shiftUp n (TTRUNC a) rewrite noseq-shiftUp n a = refl
  noseq-shiftUp n (NOWRITE a) rewrite noseq-shiftUp n a = refl
  noseq-shiftUp n (NOREAD a) rewrite noseq-shiftUp n a = refl
...
--  noseq-shiftDown n (TTRUNC a) rewrite noseq-shiftDown n a = refl
  noseq-shiftDown n (NOWRITE a) rewrite noseq-shiftDown n a = refl
  noseq-shiftDown n (NOREAD a) rewrite noseq-shiftDown n a = refl
...
--  noseq-shiftNameUp n (TTRUNC a) rewrite noseq-shiftNameUp n a = refl
  noseq-shiftNameUp n (NOWRITE a) rewrite noseq-shiftNameUp n a = refl
  noseq-shiftNameUp n (NOREAD a) rewrite noseq-shiftNameUp n a = refl
...
--  ¬Seq-subv v {a} {TTRUNC b} na nb = ¬Seq-subv v {a} {b} na nb
  ¬Seq-subv v {a} {NOWRITE b} na nb = ¬Seq-subv v {a} {b} na nb
  ¬Seq-subv v {a} {NOREAD b} na nb = ¬Seq-subv v {a} {b} na nb
