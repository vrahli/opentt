...
NOSEQneqW : {c d e : Term} → ¬ NOSEQ ≡ WT c d e
NOSEQneqW {c} {d} {e} ()

NOSEQneqM : {c d e : Term} → ¬ NOSEQ ≡ MT c d e
NOSEQneqM {c} {d} {e} ()
...
NOSEQneqPARTIAL : {c : Term} → ¬ NOSEQ ≡ PARTIAL c
NOSEQneqPARTIAL {c} ()
...
NOSEQneqNOWRITE : ¬ NOSEQ ≡ NOWRITE
NOSEQneqNOWRITE ()

NOSEQneqNOREAD : ¬ NOSEQ ≡ NOREAD
NOSEQneqNOREAD ()
...
--    ind {u} {w} {T1} {T2} (EQTTNAT y y₁) ih c₁ c₂ = ⊥-elim (NOSEQneqTNAT (⇛-val-det tt tt c₂ y))
    ...
    ind {u} {w} {T1} {T2} (EQTW A1 B1 C1 A2 B2 C2 y y₁ eqta eqtb eqtc exta extb extc) ih c₁ c₂ = ⊥-elim (NOSEQneqW (⇛-val-det tt tt c₂ y))
    ind {u} {w} {T1} {T2} (EQTM A1 B1 C1 A2 B2 C2 y y₁ eqta eqtb eqtc exta extb extc) ih c₁ c₂ = ⊥-elim (NOSEQneqM (⇛-val-det tt tt c₂ y))
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A1 A2 y y₁ eqtA extA) ih c₁ c₂ = ⊥-elim (NOSEQneqTTRUNC (⇛-val-det tt tt c₂ y))
    ind {u} {w} {T1} {T2} (EQTNOWRITE y y₁) ih c₁ c₂ = ⊥-elim (NOSEQneqNOWRITE (⇛-val-det tt tt c₂ y))
    ind {u} {w} {T1} {T2} (EQTNOREAD y y₁) ih c₁ c₂ = ⊥-elim (NOSEQneqNOREAD (⇛-val-det tt tt c₂ y))
    ind {u} {w} {T1} {T2} (EQTSUBSING A1 A2 y y₁ eqtA extA) ih c₁ c₂ = ⊥-elim (NOSEQneqSUBSING (⇛-val-det tt tt c₂ y))
    ind {u} {w} {T1} {T2} (EQTPARTIAL A1 A2 y y₁ eqtA extA) ih c₁ c₂ = ⊥-elim (NOSEQneqPARTIAL (⇛-val-det tt tt c₂ y))
    ind {u} {w} {T1} {T2} (EQTPURE y y₁) ih c₁ c₂ = ⊥-elim (NOSEQneqPURE (⇛-val-det tt tt c₂ y))
    ind {u} {w} {T1} {T2} (EQTNOENC y y₁) ih c₁ c₂ = ⊥-elim (NOSEQneqNOENC (⇛-val-det tt tt c₂ y))
...
--    ind {u} {w} {T1} {T2} (EQTTNAT y y₁) ih comp a b eqi = ⊥-elim (NOSEQneqTNAT (⇛-val-det tt tt comp y))
    ...
    ind {u} {w} {T1} {T2} (EQTW A1 B1 C1 A2 B2 C2 y y₁ eqta eqtb eqtc exta extb extc) ih comp a b eqi = ⊥-elim (NOSEQneqW (⇛-val-det tt tt comp y))
    ind {u} {w} {T1} {T2} (EQTM A1 B1 C1 A2 B2 C2 y y₁ eqta eqtb eqtc exta extb extc) ih comp a b eqi = ⊥-elim (NOSEQneqM (⇛-val-det tt tt comp y))
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A1 A2 y y₁ eqtA exta) ih comp a b eqi = ⊥-elim (NOSEQneqTTRUNC (⇛-val-det tt tt comp y))
    ind {u} {w} {T1} {T2} (EQTNOWRITE y y₁) ih comp a b eqi = ⊥-elim (NOSEQneqNOWRITE (⇛-val-det tt tt comp y))
    ind {u} {w} {T1} {T2} (EQTNOREAD y y₁) ih comp a b eqi = ⊥-elim (NOSEQneqNOREAD (⇛-val-det tt tt comp y))
    ind {u} {w} {T1} {T2} (EQTSUBSING A1 A2 y y₁ eqtA exta) ih comp a b eqi = ⊥-elim (NOSEQneqSUBSING (⇛-val-det tt tt comp y))
    ind {u} {w} {T1} {T2} (EQTPARTIAL A1 A2 y y₁ eqtA extA) ih comp a b eqi = ⊥-elim (NOSEQneqPARTIAL (⇛-val-det tt tt comp y))
    ...
    ind {u} {w} {T1} {T2} (EQTNOENC y y₁) ih comp a b eqi = ⊥-elim (NOSEQneqNOENC (⇛-val-det tt tt comp y))
