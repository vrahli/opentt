...
--    ind {u} {w} {T1} {T2} (EQTPARTIAL A1 A2 y y₁ eqtA) ih c₁ c₂ = ⊥-elim (NOSEQneqPARTIAL (⇛-val-det tt tt c₂ y))
...
--    ind {u} {w} {T1} {T2} (EQTPARTIAL A1 A2 y y₁ eqtA) ih comp a b eqi = ⊥-elim (NOSEQneqPARTIAL (⇛-val-det tt tt comp y))
