...
data <TypeStep (u : univs) : {w1 : world} {T1 U1 : CTerm} (eqt1 : eqTypes u w1 T1 U1)
                             {w2 : world} {T2 U2 : CTerm} (eqt2 : eqTypes u w2 T2 U2) → Set₁
data <TypeStep u where
  <TypePIa : (w : world) (T1 T2 : CTerm) (A1 : CTerm) (B1 : CTerm0) (A2 : CTerm) (B2 : CTerm0)
             (c₁ : T1 #⇛ (#PI A1 B1) at w)
             (c₂ : T2 #⇛ (#PI A2 B2) at w)
  ...
  <TypePIb : (w : world) (T1 T2 : CTerm) (A1 : CTerm) (B1 : CTerm0) (A2 : CTerm) (B2 : CTerm0)
             (c₁ : T1 #⇛ (#PI A1 B1) at w)
             (c₂ : T2 #⇛ (#PI A2 B2) at w)
             (eqta : allW w (λ w' _ → eqTypes u w' A1 A2))
             (eqtb : allW w (λ w' e → ∀ a1 a2 → eqInType u w' (eqta w' e) a1 a2
             ...
             (exta : (a b : CTerm) → wPredExtIrr (λ w e → eqInType u w (eqta w e) a b))
             (extb : (a b c d : CTerm) → wPredDepExtIrr (λ w e x → eqInType u w (eqtb w e a b x) c d))
             (w' : world) (e' : w' ≽ w) (a1 a2 : CTerm) (eqa : eqInType u w' (eqta w' e') a1 a2)
             → <TypeStep u {w'} {sub0 a1 B1} {sub0 a2 B2} (eqtb w' e' a1 a2 eqa) {w} {T1} {T2} (EQTPI A1 B1 A2 B2 c₁ c₂ eqta eqtb exta extb)
  <TypeSUMa : (w : world) (T1 T2 : CTerm) (A1 : CTerm) (B1 : CTerm0) (A2 : CTerm) (B2 : CTerm0)
              (c₁ : T1 #⇛ (#SUM A1 B1) at w)
              (c₂ : T2 #⇛ (#SUM A2 B2) at w)
              (eqta : allW w (λ w' _ → eqTypes u w' A1 A2))
              (eqtb : allW w (λ w' e → ∀ a1 a2 → eqInType u w' (eqta w' e) a1 a2
  ...
  <TypeSUMb : (w : world) (T1 T2 : CTerm) (A1 : CTerm) (B1 : CTerm0) (A2 : CTerm) (B2 : CTerm0)
              (c₁ : T1 #⇛ (#SUM A1 B1) at w)
              (c₂ : T2 #⇛ (#SUM A2 B2) at w)
              (eqta : allW w (λ w' _ → eqTypes u w' A1 A2))
              (eqtb : allW w (λ w' e → ∀ a1 a2 → eqInType u w' (eqta w' e) a1 a2
  ...
  <TypeSETa : (w : world) (T1 T2 : CTerm) (A1 : CTerm) (B1 : CTerm0) (A2 : CTerm) (B2 : CTerm0)
              (c₁ : T1 #⇛ (#SET A1 B1) at w)
              (c₂ : T2 #⇛ (#SET A2 B2) at w)
              (eqta : allW w (λ w' _ → eqTypes u w' A1 A2))
              (eqtb : allW w (λ w' e → ∀ a1 a2 → eqInType u w' (eqta w' e) a1 a2
  ...
  <TypeSETb : (w : world) (T1 T2 : CTerm) (A1 : CTerm) (B1 : CTerm0) (A2 : CTerm) (B2 : CTerm0)
              (c₁ : T1 #⇛ (#SET A1 B1) at w)
              (c₂ : T2 #⇛ (#SET A2 B2) at w)
              (eqta : allW w (λ w' _ → eqTypes u w' A1 A2))
              (eqtb : allW w (λ w' e → ∀ a1 a2 → eqInType u w' (eqta w' e) a1 a2
  ...
  <TypeEQ : (w : world) (T1 T2 : CTerm) (a1 b1 a2 b2 A B : CTerm)
  ...
  <TypeUNIONl : (w : world) (T1 T2 : CTerm) (A1 B1 A2 B2 : CTerm)
  ...
  <TypeUNIONr : (w : world) (T1 T2 : CTerm) (A1 B1 A2 B2 : CTerm)
                (c₁ : T1 #⇛ (#UNION A1 B1) at w)
                (c₂ : T2 #⇛ (#UNION A2 B2) at w)
                (eqtA : allW w (λ w' _ → eqTypes u w' A1 A2))
                (eqtB : allW w (λ w' _ → eqTypes u w' B1 B2))
  ...
  <TypeSQUASH : (w : world) (T1 T2 : CTerm) (A1 A2 : CTerm)
...
{--  <TypeDUM : (w : world) (T1 T2 : CTerm) (A1 A2 : CTerm)
             (c₁ : T1 ⇛ (DUM A1) at w)
             (c₂ : T2 ⇛ (DUM A2) at w)
             (eqtA : allW w (λ w' _ → eqTypes u w' A1 A2))
             (exta : (a b : CTerm) → wPredExtIrr (λ w e → eqInType u w (eqtA w e) a b))
  ...
  <TypeFFDEFS : (w : world) (T1 T2 : CTerm) (A1 A2 x1 x2 : CTerm)
  ...
  <TypeBAR : (w : world) (T1 T2 : CTerm) (i : inbar w (λ w' _ → eqTypes u w' T1 T2))
             (w' : world) (e' : w' ≽ w) (p : eqTypes u w' T1 T2) (a : Bar.atBar inOpenBar-Bar i w' e' p)
             → <TypeStep u p (EQTBAR i)



data <Type (u : univs) : {w1 : world} {T1 U1 : CTerm} (eqt1 : eqTypes u w1 T1 U1)
                         {w2 : world} {T2 U2 : CTerm} (eqt2 : eqTypes u w2 T2 U2) → Set₁
data <Type u where
  <Type1 : {w1 : world} {T1 U1 : CTerm} (eqt1 : eqTypes u w1 T1 U1)
           {w2 : world} {T2 U2 : CTerm} (eqt2 : eqTypes u w2 T2 U2)
           → <TypeStep u eqt1 eqt2 → <Type u eqt1 eqt2
  <TypeS : {w1 : world} {T1 U1 : CTerm} (eqt1 : eqTypes u w1 T1 U1)
           {w2 : world} {T2 U2 : CTerm} (eqt2 : eqTypes u w2 T2 U2)
           {w3 : world} {T3 U3 : CTerm} (eqt3 : eqTypes u w3 T3 U3)
...
data ≤Type (u : univs) : {w1 : world} {T1 U1 : CTerm} (eqt1 : eqTypes u w1 T1 U1)
                         {w2 : world} {T2 U2 : CTerm} (eqt2 : eqTypes u w2 T2 U2) → Set₁
data ≤Type u where
  ≤Type0 : {w : world} {T U : CTerm} (eqt : eqTypes u w T U) → ≤Type u eqt eqt
  ≤TypeS : {w1 : world} {T1 U1 : CTerm} (eqt1 : eqTypes u w1 T1 U1)
           {w2 : world} {T2 U2 : CTerm} (eqt2 : eqTypes u w2 T2 U2)
...
<Type-NAT : {u : univs} {w : world} {T1 T2 : CTerm} {eqt : eqTypes u w T1 T2}
            {w' : world} {U1 U2 : CTerm} {x₁ : U1 #⇛ #NAT at w'} {x₂ : U2 #⇛ #NAT at w'}
...
<Type-QNAT : {u : univs} {w : world} {T1 T2 : CTerm} {eqt : eqTypes u w T1 T2}
             {w' : world} {U1 U2 : CTerm} {x₁ : U1 #⇛ #QNAT at w'} {x₂ : U2 #⇛ #QNAT at w'}
...
<Type-LT : {u : univs} {w : world} {T1 T2 : CTerm} {eqt : eqTypes u w T1 T2}
           {w' : world} {U1 U2 a1 b1 a2 b2 : CTerm} {x₁ : U1 #⇛ #LT a1 b1 at w'} {x₂ : U2 #⇛ #LT a2 b2 at w'}
...
<Type-QLT : {u : univs} {w : world} {T1 T2 : CTerm} {eqt : eqTypes u w T1 T2}
            {w' : world} {U1 U2 a1 b1 a2 b2 : CTerm} {x₁ : U1 #⇛ #QLT a1 b1 at w'} {x₂ : U2 #⇛ #QLT a2 b2 at w'}
...
<Type-FREE : {u : univs} {w : world} {T1 T2 : CTerm} {eqt : eqTypes u w T1 T2}
             {w' : world} {U1 U2 : CTerm} {x₁ : U1 #⇛ #FREE at w'} {x₂ : U2 #⇛ #FREE at w'}
...
<Type-UNIV : {u : univs} {w : world} {T1 T2 : CTerm} {eqt : eqTypes u w T1 T2}
             {w' : world} {U1 U2 : CTerm} {x : proj₁ (proj₂ u) w' U1 U2}
...
#⇛-refl : (w : world) (T : CTerm) → T #⇛ T at w
#⇛-refl w T w' e' = lift (⇓-refl ⌜ T ⌝ w')



eqTypes-mon2 : (u : univs) → mon (proj₁ (proj₂ u)) → {w : world} {T1 T2 : CTerm} → eqTypes u w T1 T2
...
PIeq-ext : {u : univs} {w : world} {A1 A2 : CTerm} {B1 B2 : CTerm0}
           {eqta : allW w (λ w' _ → eqTypes u w' A1 A2)}
           {eqtb : allW w (λ w' e → (a1 a2 : CTerm) → eqInType u w' (eqta w' e) a1 a2
                                  → eqTypes u w' (sub0 a1 B1) (sub0 a2 B2))}
           {w' : world} {e1 e2 : w' ≽ w} {a b : CTerm}
           (exta : (a b : CTerm) → wPredExtIrr (λ w e → eqInType u w (eqta w e) a b))
           (extb : (a b c d : CTerm) → wPredDepExtIrr (λ w e x → eqInType u w (eqtb w e a b x) c d))
...
SUMeq-ext : {u : univs} {w : world} {A1 A2 : CTerm} {B1 B2 : CTerm0}
            {eqta : allW w (λ w' _ → eqTypes u w' A1 A2)}
            {eqtb : allW w (λ w' e → (a1 a2 : CTerm) → eqInType u w' (eqta w' e) a1 a2
                                   → eqTypes u w' (sub0 a1 B1) (sub0 a2 B2))}
            {w' : world} {e1 e2 : w' ≽ w} {a b : CTerm}
...
SETeq-ext : {u : univs} {w : world} {A1 A2 : CTerm} {B1 B2 : CTerm0}
            {eqta : allW w (λ w' _ → eqTypes u w' A1 A2)}
            {eqtb : allW w (λ w' e → (a1 a2 : CTerm) → eqInType u w' (eqta w' e) a1 a2
                                   → eqTypes u w' (sub0 a1 B1) (sub0 a2 B2))}
            {w' : world} {e1 e2 : w' ≽ w} {a b : CTerm}
...
EQeq-ext : {u : univs} {w : world} {A B a1 a2 : CTerm}
           {eqta : allW w (λ w' _ → eqTypes u w' A B)}
           {w' : world} {e1 e2 : w' ≽ w} {a b : CTerm}
           (exta : (a b : CTerm) → wPredExtIrr (λ w e → eqInType u w (eqta w e) a b))
...
UNIONeq-ext : {u : univs} {w : world} {A1 B1 A2 B2 : CTerm}
              {eqta : allW w (λ w' _ → eqTypes u w' A1 A2)}
              {eqtb : allW w (λ w' _ → eqTypes u w' B1 B2)}
              {w' : world} {e1 e2 : w' ≽ w} {a b : CTerm}
              (exta : (a b : CTerm) → wPredExtIrr (λ w e → eqInType u w (eqta w e) a b))
...
TSQUASHeq-ext : {u : univs} {w : world} {A1 A2 : CTerm}
                {eqta : allW w (λ w' _ → eqTypes u w' A1 A2)}
                {w' : world} {e1 e2 : w' ≽ w} {a b : CTerm}
                (exta : (a b : CTerm) → wPredExtIrr (λ w e → eqInType u w (eqta w e) a b))
...
FFDEFSeq-ext : {u : univs} {w : world} {A1 A2 : CTerm} {x1 : CTerm}
               {eqta : allW w (λ w' _ → eqTypes u w' A1 A2)}
               {w' : world} {e1 e2 : w' ≽ w} {a b : CTerm}
               (exta : (a b : CTerm) → wPredExtIrr (λ w e → eqInType u w (eqta w e) a b))
...
ind<Type : {u : univs} (umon : mon (proj₁ (proj₂ u))) (P : {w : world} {T1 T2 : CTerm} → eqTypes u w T1 T2 → Set₁)
           → ({w : world} {T1 T2 : CTerm} (eqt : eqTypes u w T1 T2)
               → ({w' : world} {T1' T2' : CTerm} (eqt' : eqTypes u w' T1' T2') → <Type u eqt' eqt → P eqt')
               → P eqt)
           → {w : world} {T1 T2 : CTerm} (eqt : eqTypes u w T1 T2) → P eqt
{-# TERMINATING #-}
ind<Type {u} umon P ind {w0} {X1} {X2} eqt =
  ...
  where
    ...
    indLtt : {w : world} {T1 T2 : CTerm} (eqt : eqTypes u w T1 T2)
             {w' : world} {T1' T2' : CTerm} (eqt' : eqTypes u w' T1' T2')
    ...
    indLtt {w} {T1} {T2} (EQTPI A1 B1 A2 B2 x x₁ eqta eqtb exta extb) {w'} {.A1} {.A2} .(eqta w' e') (<Type1 .(eqta w' e') .(EQTPI A1 B1 A2 B2 x x₁ eqta eqtb exta extb) (<TypePIa .w .T1 .T2 .A1 .B1 .A2 .B2 .x .x₁ .eqta .eqtb .exta .extb .w' e')) =
      ...
      where
        ind' : (w1 : world) (e1 : w1 ≽ w) {w' : world} {T1' T2' : CTerm} (eqt' : eqTypes u w' T1' T2') → <Type u eqt' (eqta w1 e1) → P eqt'
    ...
    indLtt {w} {T1} {T2} (EQTPI A1 B1 A2 B2 x x₁ eqta eqtb exta extb) {w'} {.(sub0 a1 B1)} {.(sub0 a2 B2)} .(eqtb w' e' a1 a2 eqa) (<Type1 .(eqtb w' e' a1 a2 eqa) .(EQTPI A1 B1 A2 B2 x x₁ eqta eqtb exta extb) (<TypePIb .w .T1 .T2 .A1 .B1 .A2 .B2 .x .x₁ .eqta .eqtb .exta .extb .w' e' a1 a2 eqa)) =
      ...
      where
        ind' : (w1 : world) (e1 : w1 ≽ w) (a1 a2 : CTerm) (eqa : eqInType u w1 (eqta w1 e1) a1 a2) {w' : world} {T1' T2' : CTerm} (eqt' : eqTypes u w' T1' T2') → <Type u eqt' (eqtb w1 e1 a1 a2 eqa) → P eqt'
    ...
    indLtt {w} {T1} {T2} (EQTUNION A1 B1 A2 B2 x x₁ eqtA eqtB exta extb) {w'} {.B1} {.B2} .(eqtB w' e') (<Type1 .(eqtB w' e') .(EQTUNION A1 B1 A2 B2 x x₁ eqtA eqtB exta extb) (<TypeUNIONr .w .T1 .T2 .A1 .B1 .A2 .B2 .x .x₁ .eqtA .eqtB .exta .extb .w' e')) =
      ...
      where
        ind' : (w1 : world) (e1 : w1 ≽ w) {w' : world} {T1' T2' : CTerm} (eqt' : eqTypes u w' T1' T2') → <Type u eqt' (eqtB w1 e1) → P eqt'
...
--    indLtt {w} {T1} {T2} (EQTDUM A1 A2 x x₁ eqtA ext) {w'} {A1'} {A2'} eqtA' ltt = {!!}
    ...
    indLtt {w} {T1} {T2} (EQTBAR i) {w'} {.T1} {.T2} eqt' (<Type1 .eqt' .(EQTBAR i) (<TypeBAR .w .T1 .T2 .i .w' e' .eqt' a)) =
      ...
      where
        ind' : (w1 : world) (e1 : w1 ≽ w) (p : eqTypes u w1 T1 T2) (a : Bar.atBar inOpenBar-Bar i w1 e1 p)
               {w' : world} {T1' T2' : CTerm} (eqt' : eqTypes u w' T1' T2')
               → <Type u eqt' p → P eqt'
...
≤Type-EQTBAR-eqInTypeExt : {u : univs} {w : world} {A B : CTerm}
                           {i : inbar w (λ w' _ → eqTypes u w' A B)}
                           {w1 : world} {e1 : w1 ≽ w} {z : eqTypes u w1 A B}
                           (a : atbar i w1 e1 z)
                           (ext : {w' : world} {A' B' : CTerm} (eqt' : eqTypes u w' A' B') → ≤Type u eqt' (EQTBAR i) → eqInTypeExt eqt')
                           → ({w' : world} {A' B' : CTerm} (eqt' : eqTypes u w' A' B') → ≤Type u eqt' z → eqInTypeExt eqt')
