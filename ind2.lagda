...
data <TypeStep u where
  <TypePIa : (w : world) (T1 T2 : Term) (A1 B1 A2 B2 : Term)
             ...
             (w' : world) (e' : w' ≽ w)
             → <TypeStep u (eqta w' e') (EQTPI A1 B1 A2 B2 c₁ c₂ eqta eqtb exta extb)
  <TypePIb : (w : world) (T1 T2 : Term) (A1 B1 A2 B2 : Term)
             ...
             → <TypeStep u (eqtb w' e' a1 a2 eqa) (EQTPI A1 B1 A2 B2 c₁ c₂ eqta eqtb exta extb)
  <TypeSUMa : (w : world) (T1 T2 : Term) (A1 B1 A2 B2 : Term)
              ...
              (extb : (a b c d : Term) → wPredDepExtIrr (λ w e x → eqInType u w (eqtb w e a b x) c d))
              (w' : world) (e' : w' ≽ w)
              → <TypeStep u (eqta w' e') (EQTSUM A1 B1 A2 B2 c₁ c₂ eqta eqtb exta extb)
  <TypeSUMb : (w : world) (T1 T2 : Term) (A1 B1 A2 B2 : Term)
              ...
              (extb : (a b c d : Term) → wPredDepExtIrr (λ w e x → eqInType u w (eqtb w e a b x) c d))
              (w' : world) (e' : w' ≽ w) (a1 a2 : Term) (eqa : eqInType u w' (eqta w' e') a1 a2)
              → <TypeStep u (eqtb w' e' a1 a2 eqa) (EQTSUM A1 B1 A2 B2 c₁ c₂ eqta eqtb exta extb)
  ...
  <TypeEQ : (w : world) (T1 T2 : Term) (a1 b1 a2 b2 A B : Term)
            ...
            (w' : world) (e' : w' ≽ w)
            → <TypeStep u (eqtA w' e') (EQTEQ a1 b1 a2 b2 A B c₁ c₂ eqtA exta eqt1 eqt2)
  <TypeUNIONl : (w : world) (T1 T2 : Term) (A1 B1 A2 B2 : Term)
                ...
                (w' : world) (e' : w' ≽ w)
                → <TypeStep u (eqtA w' e') (EQTUNION A1 B1 A2 B2 c₁ c₂ eqtA eqtB exta extb)
  <TypeUNIONr : (w : world) (T1 T2 : Term) (A1 B1 A2 B2 : Term)
                ...
                (extb : (a b : Term) → wPredExtIrr (λ w e → eqInType u w (eqtB w e) a b))
                (w' : world) (e' : w' ≽ w)
                → <TypeStep u (eqtB w' e') (EQTUNION A1 B1 A2 B2 c₁ c₂ eqtA eqtB exta extb)
...
{--  <TypeDUM : (w : world) (T1 T2 : Term) (A1 A2 : Term)
  ...
  <TypeFFDEFS : (w : world) (T1 T2 : Term) (A1 A2 x1 x2 : Term)
                ...
                (w' : world) (e' : w' ≽ w)
                → <TypeStep u (eqtA w' e') (EQFFDEFS A1 A2 x1 x2 c₁ c₂ eqtA exta eqx)
...
data ≤Type (u : univs) : {w1 : world} {T1 U1 : Term} (eqt1 : eqTypes u w1 T1 U1)
                         {w2 : world} {T2 U2 : Term} (eqt2 : eqTypes u w2 T2 U2) → Set₁
data ≤Type u where
  ≤Type0 : {w : world} {T U : Term} (eqt : eqTypes u w T U) → ≤Type u eqt eqt
  ≤TypeS : {w1 : world} {T1 U1 : Term} (eqt1 : eqTypes u w1 T1 U1)
           {w2 : world} {T2 U2 : Term} (eqt2 : eqTypes u w2 T2 U2)
...
FFDEFSeq-ext : {u : univs} {w : world} {A1 A2 : Term} {x1 : Term}
               {eqta : allW w (λ w' _ → eqTypes u w' A1 A2)}
               {w' : world} {e1 e2 : w' ≽ w} {a b : Term}
               (exta : (a b : Term) → wPredExtIrr (λ w e → eqInType u w (eqta w e) a b))
...
ind<Type {u} umon P ind {w0} {X1} {X2} eqt =
  ...
  where
    ...
    indLtt {w} {T1} {T2} (EQTPI A1 B1 A2 B2 x x₁ eqta eqtb exta extb) {w'} {.(sub a1 B1)} {.(sub a2 B2)} .(eqtb w' e' a1 a2 eqa) (<Type1 .(eqtb w' e' a1 a2 eqa) .(EQTPI A1 B1 A2 B2 x x₁ eqta eqtb exta extb) (<TypePIb .w .T1 .T2 .A1 .B1 .A2 .B2 .x .x₁ .eqta .eqtb .exta .extb .w' e' a1 a2 eqa)) =
    ...
    indLtt {w} {T1} {T2} (EQTSUM A1 B1 A2 B2 x x₁ eqta eqtb exta extb) {w'} {.(sub a1 B1)} {.(sub a2 B2)} .(eqtb w' e' a1 a2 eqa) (<Type1 .(eqtb w' e' a1 a2 eqa) .(EQTSUM A1 B1 A2 B2 x x₁ eqta eqtb exta extb) (<TypeSUMb .w .T1 .T2 .A1 .B1 .A2 .B2 .x .x₁ .eqta .eqtb .exta .extb .w' e' a1 a2 eqa)) =
      ind (eqtb w' e' a1 a2 eqa) (ind' w' e' a1 a2 eqa)
      where
        ind' : (w1 : world) (e1 : w1 ≽ w) (a1 a2 : Term) (eqa : eqInType u w1 (eqta w1 e1) a1 a2) {w' : world} {T1' T2' : Term} (eqt' : eqTypes u w' T1' T2') → <Type u eqt' (eqtb w1 e1 a1 a2 eqa) → P eqt'
        ind' w1 e1 a1 a2 eqa {w'} {T1'} {T2'} eqt' ltt = indLtt (eqtb w1 e1 a1 a2 eqa) eqt' ltt
...
≤Type-EQTBAR-eqInTypeExt : {u : univs} {w : world} {A B : Term}
                           ...
                           → ({w' : world} {A' B' : Term} (eqt' : eqTypes u w' A' B') → ≤Type u eqt' z → eqInTypeExt eqt')
