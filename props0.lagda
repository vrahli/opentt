...
if-equalInType-EQ u w T a b t₁ t₂ (EQTBAR x , eqi) =
  Bar.inBar-idem
    inOpenBar-Bar
    (Bar.allW-inBar'-inBar inOpenBar-Bar aw x eqi)
  where
    aw : allW w
              (λ w' e' →
    ...
    aw w1 e1 eqt1 eqi1 = Bar.allW-inBarFunc inOpenBar-Bar (λ w' e' x z → x) ind
      where
...
irr-fam-sum u w A1 B1 A2 B2 eqta eqtb inda indb f g w1 e1 w' e' (a1 , a2 , b1 , b2 , eqa , c1 , c2 , eqb) z =
...
irr-fam-set u w A1 B1 A2 B2 eqta eqtb inda indb f g w1 e1 w' e' (b , eqa , eqb) z =
  b , eqa' , eqb'
    where
...
irr-union u w A1 A2 B1 B2 eqta inda eqtb indb f g w1 e1 w' e' (a , b , inj₁ (c₁ , c₂ , eqa)) z =
  a , b , inj₁ (c₁ , c₂ , eqa')
  where
...
irr-tsquash u w A1 A2 eqta inda f g w1 e1 w' e' (a1 , a2 , c₁ , c₂ , c₃ , eqa) z =
  a1 , a2 , c₁ , c₂ , c₃ , eqa'
  where
    eqa' : eqInType u w' (eqta w' z) a1 a2
    eqa' = snd (inda w' z (eqta w' (extTrans e' e1)) a1 a2) eqa
...
irr-ffdefs u w x1 A1 A2 eqta inda f g w1 e1 w' e' (x2 , c₁ , c₂ , eqa , nd) z =
  x2 , c₁ , c₂ , eqa' , nd
  where
