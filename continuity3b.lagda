...
--  step-sat-isHighestℕ2 cc gc {w1} {w2} {.TNAT} {b} {n} {name} {f} compat wgt0 comp indb updCtxt2-TNAT nnf nnw idom cf rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , TNAT , w1 , refl , (λ x → x , x) , (nnw , idom) , updCtxt2-TNAT
  ...
  ... |    inj₂ z rewrite z = ⊥-elim (¬just≡nothing (sym comp))
  step-sat-isHighestℕ2 cc gc {w1} {w2} {.(IFEQ a b c d)} {x} {n} {name} {f} compat wgt0 comp indb (updCtxt2-IFEQ a b c d ctxt ctxt₁ ctxt₂ ctxt₃) nnf nnw idom cf with is-NUM a
  ... | inj₁ (k1 , p) rewrite p with is-NUM b
  ... |    inj₁ (k2 , q) rewrite q with k1 ≟ k2
  ... |       yes r rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , c , w1 , refl , (λ x → x , x) , (nnw , idom) , ctxt₂
  ... |       no r rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , d , w1 , refl , (λ x → x , x) , (nnw , idom) , ctxt₃
  step-sat-isHighestℕ2 cc gc {w1} {w2} {.(IFEQ a b c d)} {x} {n} {name} {f} compat wgt0 comp indb (updCtxt2-IFEQ a b c d ctxt ctxt₁ ctxt₂ ctxt₃) nnf nnw idom cf | inj₁ (k1 , p) | inj₂ q with step⊎ b w1
  ... |       inj₁ (b' , w1' , z) rewrite p | z | sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) =
    ΣhighestUpdCtxt2-IFEQ₂ ctxt₂ ctxt₃ ind
    where
      ind : ΣhighestUpdCtxt2 name f n b' w1 w1'
      ind = step-sat-isHighestℕ2 cc gc {w1} {w1'} {b} {b'} {n} {name} {f} compat wgt0 z (stepsPresHighestℕ2-IFEQ₂→ indb) ctxt₁ nnf nnw idom cf
  ... |       inj₂ z rewrite z = ⊥-elim (¬just≡nothing (sym comp))
  step-sat-isHighestℕ2 cc gc {w1} {w2} {.(IFEQ a b c d)} {x} {n} {name} {f} compat wgt0 comp indb (updCtxt2-IFEQ a b c d ctxt ctxt₁ ctxt₂ ctxt₃) nnf nnw idom cf | inj₂ p with step⊎ a w1
  ... |    inj₁ (a' , w1' , z) rewrite z | sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) =
    ΣhighestUpdCtxt2-IFEQ₁ ctxt₁ ctxt₂ ctxt₃ ind
    where
      ind : ΣhighestUpdCtxt2 name f n a' w1 w1'
      ind = step-sat-isHighestℕ2 cc gc {w1} {w1'} {a} {a'} {n} {name} {f} compat wgt0 z (stepsPresHighestℕ2-IFEQ₁→ indb) ctxt nnf nnw idom cf
  ... |    inj₂ z rewrite z = ⊥-elim (¬just≡nothing (sym comp))
  ...
  ... |    inj₂ z rewrite z = ⊥-elim (¬just≡nothing (sym comp))
  step-sat-isHighestℕ2 cc gc {w1} {w2} {.(NATREC a a₁ a₂)} {b} {n} {name} {f} compat wgt0 comp indb (updCtxt2-NATREC a a₁ a₂ ctxt ctxt₁ ctxt₂) nnf nnw idom cf with is-NUM a
  ... | inj₁ (k1 , p) rewrite p | sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) =
    0 , NATRECr k1 a₁ a₂ , w1 , refl , (λ x → x , x) , (nnw , idom) , updCtxt2-NATRECr {name} {f} {k1} {a₁} {a₂} cf ctxt₁ ctxt₂
  ... | inj₂ p with step⊎ a w1
  ... |    inj₁ (a' , w1' , z) rewrite z | sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) =
    ΣhighestUpdCtxt2-NATREC₁ ctxt₁ ctxt₂ ind
    where
      ind : ΣhighestUpdCtxt2 name f n a' w1 w1'
      ind = step-sat-isHighestℕ2 cc gc {w1} {w1'} {a} {a'} {n} {name} {f} compat wgt0 z (stepsPresHighestℕ2-NATREC₁→ indb) ctxt nnf nnw idom cf
  ... |    inj₂ z rewrite z = ⊥-elim (¬just≡nothing (sym comp))
  ...
  ... |          inj₂ z rewrite z = ⊥-elim (¬just≡nothing (sym comp))
  step-sat-isHighestℕ2 cc gc {w1} {w2} {.(APPLY g a)} {b} {n} {name} {f} compat wgt0 comp indb (updCtxt2-APPLY g a ctxt ctxt₁) nnf nnw idom cf | inj₂ x | inj₂ y with is-MSEQ g
  ... |    inj₁ (s , q) rewrite q | sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) =
    0 , MAPP s a , w1 , refl , (λ x → x , x) , (nnw , idom) , updCtxt2-MAPP _ _ ctxt₁
  ... |    inj₂ q with step⊎ g w1
  step-sat-isHighestℕ2 cc gc {w1} {w2} {.(APPLY g a)} {b} {n} {name} {f} compat wgt0 comp indb (updCtxt2-APPLY g a ctxt ctxt₁) nnf nnw idom cf | inj₂ x | inj₂ y | inj₂ q | inj₁ (g' , w1' , z) rewrite z | sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) =
  ...
  ... | inj₂ z rewrite z = ⊥-elim (¬just≡nothing (sym comp))
  step-sat-isHighestℕ2 cc gc {w1} {w2} {.(MSEQ s)} {b} {n} {name} {f} compat wgt0 comp indb (updCtxt2-MSEQ s) nnf nnw idom cf rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , MSEQ _ , w1 , refl , (λ x → x , x) , (nnw , idom) , updCtxt2-MSEQ _
  step-sat-isHighestℕ2 cc gc {w1} {w2} {.(MAPP s a)} {b} {n} {name} {f} compat wgt0 comp indb (updCtxt2-MAPP s a ctxt) nnf nnw idom cf with is-NUM a
  ... | inj₁ (n , q) rewrite q | sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , NUM (s n) , w1 , refl , (λ x → x , x) , (nnw , idom) , updCtxt2-NUM _
  ... | inj₂ y with step⊎ a w1
  ... |    inj₁ (a' , w1' , z) rewrite z | sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) =
    ΣhighestUpdCtxt2-MAPP₁ ind
    where
      ind : ΣhighestUpdCtxt2 name f n a' w1 w1'
      ind = step-sat-isHighestℕ2 cc gc {w1} {w1'} {a} {a'} {n} {name} {f} compat wgt0 z (stepsPresHighestℕ2-MAPP₁→ indb) ctxt nnf nnw idom cf
  ...
  ... |    inj₂ z rewrite z = ⊥-elim (¬just≡nothing (sym comp))
  step-sat-isHighestℕ2 cc gc {w1} {w2} {.(WT a b₁ c)} {b} {n} {name} {f} compat wgt0 comp indb (updCtxt2-WT a b₁ c ctxt ctxt₁ ctxt₂) nnf nnw idom cf rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , WT a b₁ c , w1 , refl , (λ x → x , x) , (nnw , idom) , updCtxt2-WT _ _ _ ctxt ctxt₁ ctxt₂
  ...
  ... |    inj₁ (a' , w1' , z) rewrite z | sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) =
    ...
    where
      ind : ΣhighestUpdCtxt2 name f n a' w1 w1'
      ind = step-sat-isHighestℕ2 cc gc {w1} {w1'} {a} {a'} {n} {name} {f} compat wgt0 z (stepsPresHighestℕ2-WREC₁→ indb) ctxt nnf nnw idom cf
  ... |    inj₂ z rewrite z = ⊥-elim (¬just≡nothing (sym comp))
  step-sat-isHighestℕ2 cc gc {w1} {w2} {.(MT a b₁ c)} {b} {n} {name} {f} compat wgt0 comp indb (updCtxt2-MT a b₁ c ctxt ctxt₁ ctxt₂) nnf nnw idom cf rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , MT a b₁ c , w1 , refl , (λ x → x , x) , (nnw , idom) , updCtxt2-MT _ _ _ ctxt ctxt₁ ctxt₂
...
--  step-sat-isHighestℕ2 cc gc {w1} {w2} {.(EQB a b₁ c d)} {b} {n} {name} {f} compat wgt0 comp indb (updCtxt2-EQB a b₁ c d ctxt ctxt₁ ctxt₂ ctxt₃) nnf nnw idom cf rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , EQB a b₁ c d , w1 , refl , (λ x → x , x) , (nnw , idom) , updCtxt2-EQB _ _ _ _ ctxt ctxt₁ ctxt₂ ctxt₃
...
--  step-sat-isHighestℕ2 cc gc {w1} {w2} {.(TTRUNC a)} {b} {n} {name} {f} compat wgt0 comp indb (updCtxt2-TTRUNC a ctxt) nnf nnw idom cf rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , TTRUNC a , w1 , refl , (λ x → x , x) , (nnw , idom) , updCtxt2-TTRUNC _ ctxt
  ...
  step-sat-isHighestℕ2 cc gc {w1} {w2} {.NOSEQ} {b} {n} {name} {f} compat wgt0 comp indb updCtxt2-NOSEQ nnf nnw idom cf rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , NOSEQ , w1 , refl , (λ x → x , x) , (nnw , idom) , updCtxt2-NOSEQ
  step-sat-isHighestℕ2 cc gc {w1} {w2} {.NOENC} {b} {n} {name} {f} compat wgt0 comp indb updCtxt2-NOENC nnf nnw idom cf rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , NOENC , w1 , refl , (λ x → x , x) , (nnw , idom) , updCtxt2-NOENC
  step-sat-isHighestℕ2 cc gc {w1} {w2} {.(TERM a)} {b} {n} {name} {f} compat wgt0 comp indb (updCtxt2-TERM a ctxt) nnf nnw idom cf rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , TERM a , w1 , refl , (λ x → x , x) , (nnw , idom) , updCtxt2-TERM _ ctxt
  step-sat-isHighestℕ2 cc gc {w1} {w2} {.(ENC a)} {b} {n} {name} {f} compat wgt0 comp indb (updCtxt2-ENC a ctxt) nnf nnw idom cf rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , ENCr a , w1 , refl , (λ x → x , x) , (nnw , idom) , updCtxt2-ENCr ctxt --0 , ENC a , w1 , refl , (λ x → x , x) , (nnw , idom) , updCtxt2-TERM _ ctxt
  step-sat-isHighestℕ2 cc gc {w1} {w2} {.(PARTIAL a)} {b} {n} {name} {f} compat wgt0 comp indb (updCtxt2-PARTIAL a ctxt) nnf nnw idom cf rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , PARTIAL a , w1 , refl , (λ x → x , x) , (nnw , idom) , updCtxt2-PARTIAL _ ctxt
