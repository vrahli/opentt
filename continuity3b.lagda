...
abstract
  ...
  step-sat-isHighestℕ2 cc gc {w1} {w2} {.TERM} {b} {n} {name} {f} compat wgt0 comp indb updCtxt2-TERM nnf nnw idom cf rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , TERM , w1 , refl , (λ x → x , x) , (nnw , idom) , updCtxt2-TERM
