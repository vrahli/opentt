...
abstract
  ...
  ... |    inj₂ z rewrite z = ⊥-elim (¬just≡nothing (sym comp))
  step-sat-isHighestℕ2 cc gc {w1} {w2} {.(WT a b₁)} {b} {n} {name} {f} compat wgt0 comp indb (updCtxt2-WT a b₁ ctxt ctxt₁) nnf nnw idom cf rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , WT a b₁ , w1 , refl , (λ x → x , x) , (nnw , idom) , updCtxt2-WT _ _ ctxt ctxt₁
  ...
  ... |    inj₂ z rewrite z = ⊥-elim (¬just≡nothing (sym comp))
  step-sat-isHighestℕ2 cc gc {w1} {w2} {.(MT a b₁)} {b} {n} {name} {f} compat wgt0 comp indb (updCtxt2-MT a b₁ ctxt ctxt₁) nnf nnw idom cf rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , MT a b₁ , w1 , refl , (λ x → x , x) , (nnw , idom) , updCtxt2-MT _ _ ctxt ctxt₁
...
--  step-sat-isHighestℕ2 cc gc {w1} {w2} {.(TTRUNC a)} {b} {n} {name} {f} compat wgt0 comp indb (updCtxt2-TTRUNC a ctxt) nnf nnw idom cf rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , TTRUNC a , w1 , refl , (λ x → x , x) , (nnw , idom) , updCtxt2-TTRUNC _ ctxt
  step-sat-isHighestℕ2 cc gc {w1} {w2} {.(NOWRITE a)} {b} {n} {name} {f} compat wgt0 comp indb (updCtxt2-NOWRITE a ctxt) nnf nnw idom cf rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , NOWRITE a , w1 , refl , (λ x → x , x) , (nnw , idom) , updCtxt2-NOWRITE _ ctxt
  step-sat-isHighestℕ2 cc gc {w1} {w2} {.(NOREAD a)} {b} {n} {name} {f} compat wgt0 comp indb (updCtxt2-NOREAD a ctxt) nnf nnw idom cf rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , NOREAD a , w1 , refl , (λ x → x , x) , (nnw , idom) , updCtxt2-NOREAD _ ctxt
