...
typeSysConds-PI-ttrans u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTTERM y y₁) = ⊥-elim (PIneqTERM (⇛-val-det tt tt x₁ y))
...
typeSysConds-PI-extl1 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTTERM y y₁) f g eqi = ⊥-elim (PIneqTERM (⇛-val-det tt tt x y))
...
typeSysConds-PI-extl2 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTTERM y y₁) f g eqi = ⊥-elim (PIneqTERM (⇛-val-det tt tt x y₁))
...
typeSysConds-PI-extr1 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTTERM y y₁) f g eqi = ⊥-elim (PIneqTERM (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-PI-extr2 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTTERM y y₁) f g eqi = ⊥-elim (PIneqTERM (⇛-val-det tt tt x₁ y))
...
typeSysConds-PI-extrevl1 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTTERM y y₁) f g eqi = ⊥-elim (PIneqTERM (⇛-val-det tt tt x y))
...
typeSysConds-PI-extrevl2 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTTERM y y₁) f g eqi = ⊥-elim (PIneqTERM (⇛-val-det tt tt x y₁))
...
typeSysConds-PI-extrevr1 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTTERM y y₁) f g eqi = ⊥-elim (PIneqTERM (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-PI-extrevr2 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTTERM y y₁) f g eqi = ⊥-elim (PIneqTERM (⇛-val-det tt tt x₁ y))
...
eqInType-⇛-PI u w A B A1 A2 B1 B2 a b eqta eqtb exta extb inda indb c₁ c₂ (EQTTERM x x₁) ei = ⊥-elim (PIneqTERM (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-PI2 u w A B A1 A2 B1 B2 a b eqta eqtb exta extb c₁ c₂ (EQTTERM x x₁) ei ext = ⊥-elim (PIneqTERM (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-PI-rev u w A B A1 A2 B1 B2 a b eqta eqtb exta extb inda indb c₁ c₂ (EQTTERM x x₁) ei = ⊥-elim (PIneqTERM (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-PI-rev2 u w A B A1 A2 B1 B2 a b eqta eqtb exta extb c₁ c₂ (EQTTERM x x₁) ext ei = ⊥-elim (PIneqTERM (⇛-val-det tt tt c₁ x))
