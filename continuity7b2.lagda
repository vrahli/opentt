...
abstract
  ...
  step-updRel2 cc gc {n} {name} {f} {g} {.TERM} {.TERM} {x} {w0} {w1} {w2} {w} {r} nnf cf cg naid nbid comp ind updRel2-TERM upw gtn nnw idom idom' compat compat' wgt0 ew01 ew0 eqn rewrite pair-inj₁ (just-inj (sym comp)) | pair-inj₂ (just-inj (sym comp)) = 0 , 0 , TERM , TERM , w1 , w , r , refl , refl , updRel2-TERM , upw , subRen-refl r
