...
FFDEFSneqNN : {a b : Term} {c : Term} → ¬ FFDEFS a b ≡ NN c
FFDEFSneqNN {a} {b} {c} ()
...
typeSysConds-FFDEFS-ttrans u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTNN t₁ y y₁) = ⊥-elim (FFDEFSneqNN (⇛-val-det tt tt x₁ y))
...
typeSysConds-FFDEFS-extl1 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTNN t₁ y y₁) f g eqi = ⊥-elim (FFDEFSneqNN (⇛-val-det tt tt x y))
...
typeSysConds-FFDEFS-extl2 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTNN t₁ y y₁) f g eqi = ⊥-elim (FFDEFSneqNN (⇛-val-det tt tt x y₁))
...
typeSysConds-FFDEFS-extr1 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTNN t₁ y y₁) f g eqi = ⊥-elim (FFDEFSneqNN (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-FFDEFS-extr2 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTNN t₁ y y₁) f g eqi = ⊥-elim (FFDEFSneqNN (⇛-val-det tt tt x₁ y))
...
typeSysConds-FFDEFS-extrevl1 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTNN t₁ y y₁) f g eqi = ⊥-elim (FFDEFSneqNN (⇛-val-det tt tt x y))
...
typeSysConds-FFDEFS-extrevl2 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTNN t₁ y y₁) f g eqi = ⊥-elim (FFDEFSneqNN (⇛-val-det tt tt x y₁))
...
typeSysConds-FFDEFS-extrevr1 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTNN t₁ y y₁) f g eqi = ⊥-elim (FFDEFSneqNN (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-FFDEFS-extrevr2 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTNN t₁ y y₁) f g eqi = ⊥-elim (FFDEFSneqNN (⇛-val-det tt tt x₁ y))
...
eqInType-⇛-FFDEFS u w A B A1 B1 x1 x2 a b eqta exta inda c₁ c₂ (EQTNN t₁ x x₁) ei = ⊥-elim (FFDEFSneqNN (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-FFDEFS2 u w A B A1 B1 x1 x2 a b eqta exta c₁ c₂ (EQTNN t₁ x x₁) ei ext = ⊥-elim (FFDEFSneqNN (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-FFDEFS-rev u w A B A1 B1 x1 x2 a b eqta exta inda c₁ c₂ (EQTNN t₁ x x₁) ei = ⊥-elim (FFDEFSneqNN (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-FFDEFS-rev2 u w A B A1 B1 x1 x2 a b eqta exta c₁ c₂ (EQTNN t₁ x x₁) ext ei = ⊥-elim (FFDEFSneqNN (⇛-val-det tt tt c₁ x))
