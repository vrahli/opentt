...
module type_sys_props_ffdefs {L : Level} (W : PossibleWorlds {L})
...
typeSysConds-FFDEFS-extrevl1 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTBAR y) f g eqi =
  ...
  where
    ...
    aw w1 e1 z {--at--} ez = Bar.∀𝕎-□Func barI (irr-ffdefs u w x1 A1 B1 eqta exta f g w1 e1) (aw0 w1 e1 z {--at--} ez)
...
eqInType-⇛-FFDEFS u w A B A1 B1 x1 x2 a b eqta exta inda c₁ c₂ (EQTBAR x) ei =
  ...
  where
    ...
    aw w1 e1 z {--at--} ez = Bar.∀𝕎-□Func barI (irr-ffdefs u w x1 A1 B1 eqta exta a b w1 e1) (aw0 w1 e1 z {--at--} ez)
...
eqInType-⇛-FFDEFS2 u w A B A1 B1 x1 x2 a b eqta exta c₁ c₂ (EQTBAR x) ei ext =
  ...
  where
    ...
    aw w1 e1 z {--at--} ez = Bar.∀𝕎-□Func barI (irr-ffdefs (u ·ᵤ) w x1 A1 B1 eqta exta a b w1 e1) (aw0 w1 e1 z {--at--} ez)
