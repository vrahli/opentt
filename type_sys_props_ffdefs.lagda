...
FFDEFSneqW : {a b : Term} {c : Term} {d : Term} → ¬ FFDEFS a b ≡ WT c d
FFDEFSneqW {a} {b} {c} {d} ()

FFDEFSneqM : {a b : Term} {c : Term} {d : Term} → ¬ FFDEFS a b ≡ MT c d
FFDEFSneqM {a} {b} {c} {d} ()
...
FFDEFSneqNOWRITE : {a b : Term} {c : Term} → ¬ FFDEFS a b ≡ NOWRITE c
FFDEFSneqNOWRITE {a} {b} {c} ()

FFDEFSneqNOREAD : {a b : Term} {c : Term} → ¬ FFDEFS a b ≡ NOREAD c
FFDEFSneqNOREAD {a} {b} {c} ()
...
typeSysConds-FFDEFS-ttrans u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTW C1 D1 C2 D2 y y₁ eqta0 eqtb0 exta0 extb0) = ⊥-elim (FFDEFSneqW (⇛-val-det tt tt x₁ y))
typeSysConds-FFDEFS-ttrans u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTM C1 D1 C2 D2 y y₁ eqta0 eqtb0 exta0 extb0) = ⊥-elim (FFDEFSneqM (⇛-val-det tt tt x₁ y))
...
typeSysConds-FFDEFS-ttrans u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTNOWRITE A3 A4 y y₁ eqtA extA) = ⊥-elim (FFDEFSneqNOWRITE (⇛-val-det tt tt x₁ y))
typeSysConds-FFDEFS-ttrans u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTNOREAD A3 A4 y y₁ eqtA extA) = ⊥-elim (FFDEFSneqNOREAD (⇛-val-det tt tt x₁ y))
...
typeSysConds-FFDEFS-extl1 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTW A3 B3 A4 B4 y y₁ eqta0 eqtb0 exta0 extb0) f g eqi = ⊥-elim (FFDEFSneqW (⇛-val-det tt tt x y))
typeSysConds-FFDEFS-extl1 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTM A3 B3 A4 B4 y y₁ eqta0 eqtb0 exta0 extb0) f g eqi = ⊥-elim (FFDEFSneqM (⇛-val-det tt tt x y))
...
typeSysConds-FFDEFS-extl1 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTNOWRITE A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (FFDEFSneqNOWRITE (⇛-val-det tt tt x y))
typeSysConds-FFDEFS-extl1 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTNOREAD A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (FFDEFSneqNOREAD (⇛-val-det tt tt x y))
...
typeSysConds-FFDEFS-extl2 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTW A3 B3 A4 B4 y y₁ eqta₁ eqtb₁ exta₁ extb₁) f g eqi = ⊥-elim (FFDEFSneqW (⇛-val-det tt tt x y₁))
typeSysConds-FFDEFS-extl2 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTM A3 B3 A4 B4 y y₁ eqta₁ eqtb₁ exta₁ extb₁) f g eqi = ⊥-elim (FFDEFSneqM (⇛-val-det tt tt x y₁))
...
typeSysConds-FFDEFS-extl2 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTNOWRITE A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (FFDEFSneqNOWRITE (⇛-val-det tt tt x y₁))
typeSysConds-FFDEFS-extl2 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTNOREAD A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (FFDEFSneqNOREAD (⇛-val-det tt tt x y₁))
...
typeSysConds-FFDEFS-extr1 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTW A3 B3 A4 B4 y y₁ eqta₁ eqtb₁ exta₁ extb₁) f g eqi = ⊥-elim (FFDEFSneqW (⇛-val-det tt tt x₁ y₁))
typeSysConds-FFDEFS-extr1 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTM A3 B3 A4 B4 y y₁ eqta₁ eqtb₁ exta₁ extb₁) f g eqi = ⊥-elim (FFDEFSneqM (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-FFDEFS-extr1 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTNOWRITE A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (FFDEFSneqNOWRITE (⇛-val-det tt tt x₁ y₁))
typeSysConds-FFDEFS-extr1 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTNOREAD A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (FFDEFSneqNOREAD (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-FFDEFS-extr2 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTW A3 B3 A4 B4 y y₁ eqta₁ eqtb₁ exta₁ extb₁) f g eqi = ⊥-elim (FFDEFSneqW (⇛-val-det tt tt x₁ y))
typeSysConds-FFDEFS-extr2 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTM A3 B3 A4 B4 y y₁ eqta₁ eqtb₁ exta₁ extb₁) f g eqi = ⊥-elim (FFDEFSneqM (⇛-val-det tt tt x₁ y))
...
typeSysConds-FFDEFS-extr2 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTNOWRITE A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (FFDEFSneqNOWRITE (⇛-val-det tt tt x₁ y))
typeSysConds-FFDEFS-extr2 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTNOREAD A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (FFDEFSneqNOREAD (⇛-val-det tt tt x₁ y))
...
typeSysConds-FFDEFS-extrevl1 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTW A3 B3 A4 B4 y y₁ eqta₁ eqtb₁ exta₁ extb₁) f g eqi = ⊥-elim (FFDEFSneqW (⇛-val-det tt tt x y))
typeSysConds-FFDEFS-extrevl1 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTM A3 B3 A4 B4 y y₁ eqta₁ eqtb₁ exta₁ extb₁) f g eqi = ⊥-elim (FFDEFSneqM (⇛-val-det tt tt x y))
...
typeSysConds-FFDEFS-extrevl1 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTNOWRITE A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (FFDEFSneqNOWRITE (⇛-val-det tt tt x y))
typeSysConds-FFDEFS-extrevl1 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTNOREAD A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (FFDEFSneqNOREAD (⇛-val-det tt tt x y))
...
typeSysConds-FFDEFS-extrevl2 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTW A3 B3 A4 B4 y y₁ eqta₁ eqtb₁ exta₁ extb₁) f g eqi = ⊥-elim (FFDEFSneqW (⇛-val-det tt tt x y₁))
typeSysConds-FFDEFS-extrevl2 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTM A3 B3 A4 B4 y y₁ eqta₁ eqtb₁ exta₁ extb₁) f g eqi = ⊥-elim (FFDEFSneqM (⇛-val-det tt tt x y₁))
...
typeSysConds-FFDEFS-extrevl2 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTNOWRITE A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (FFDEFSneqNOWRITE (⇛-val-det tt tt x y₁))
typeSysConds-FFDEFS-extrevl2 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTNOREAD A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (FFDEFSneqNOREAD (⇛-val-det tt tt x y₁))
...
typeSysConds-FFDEFS-extrevr1 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTW A3 B3 A4 B4 y y₁ eqta₁ eqtb₁ exta₁ extb₁) f g eqi = ⊥-elim (FFDEFSneqW (⇛-val-det tt tt x₁ y₁))
typeSysConds-FFDEFS-extrevr1 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTM A3 B3 A4 B4 y y₁ eqta₁ eqtb₁ exta₁ extb₁) f g eqi = ⊥-elim (FFDEFSneqM (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-FFDEFS-extrevr1 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTNOWRITE A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (FFDEFSneqNOWRITE (⇛-val-det tt tt x₁ y₁))
typeSysConds-FFDEFS-extrevr1 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTNOREAD A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (FFDEFSneqNOREAD (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-FFDEFS-extrevr2 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTW A3 B3 A4 B4 y y₁ eqta₁ eqtb₁ exta₁ extb₁) f g eqi = ⊥-elim (FFDEFSneqW (⇛-val-det tt tt x₁ y))
typeSysConds-FFDEFS-extrevr2 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTM A3 B3 A4 B4 y y₁ eqta₁ eqtb₁ exta₁ extb₁) f g eqi = ⊥-elim (FFDEFSneqM (⇛-val-det tt tt x₁ y))
...
typeSysConds-FFDEFS-extrevr2 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTNOWRITE A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (FFDEFSneqNOWRITE (⇛-val-det tt tt x₁ y))
typeSysConds-FFDEFS-extrevr2 u w A B A1 B1 x1 x2 x x₁ eqta exta inda eqx C (EQTNOREAD A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (FFDEFSneqNOREAD (⇛-val-det tt tt x₁ y))
...
eqInType-⇛-FFDEFS u w A B A1 B1 x1 x2 a b eqta exta inda c₁ c₂ (EQTW A3 B3 A4 B4 x x₁ eqta₁ eqtb₁ exta₁ extb₁) ei = ⊥-elim (FFDEFSneqW (⇛-val-det tt tt c₁ x))
eqInType-⇛-FFDEFS u w A B A1 B1 x1 x2 a b eqta exta inda c₁ c₂ (EQTM A3 B3 A4 B4 x x₁ eqta₁ eqtb₁ exta₁ extb₁) ei = ⊥-elim (FFDEFSneqM (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-FFDEFS u w A B A1 B1 x1 x2 a b eqta exta inda c₁ c₂ (EQTNOWRITE A3 A4 x x₁ eqta₁ exta₁) ei = ⊥-elim (FFDEFSneqNOWRITE (⇛-val-det tt tt c₁ x))
eqInType-⇛-FFDEFS u w A B A1 B1 x1 x2 a b eqta exta inda c₁ c₂ (EQTNOREAD A3 A4 x x₁ eqta₁ exta₁) ei = ⊥-elim (FFDEFSneqNOREAD (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-FFDEFS2 u w A B A1 B1 x1 x2 a b eqta exta c₁ c₂ (EQTW A3 B3 A4 B4 x x₁ eqta₁ eqtb₁ exta₁ extb₁) ei ext = ⊥-elim (FFDEFSneqW (⇛-val-det tt tt c₁ x))
eqInType-⇛-FFDEFS2 u w A B A1 B1 x1 x2 a b eqta exta c₁ c₂ (EQTM A3 B3 A4 B4 x x₁ eqta₁ eqtb₁ exta₁ extb₁) ei ext = ⊥-elim (FFDEFSneqM (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-FFDEFS2 u w A B A1 B1 x1 x2 a b eqta exta c₁ c₂ (EQTNOWRITE A3 A4 x x₁ eqta₁ exta₁) ei ext = ⊥-elim (FFDEFSneqNOWRITE (⇛-val-det tt tt c₁ x))
eqInType-⇛-FFDEFS2 u w A B A1 B1 x1 x2 a b eqta exta c₁ c₂ (EQTNOREAD A3 A4 x x₁ eqta₁ exta₁) ei ext = ⊥-elim (FFDEFSneqNOREAD (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-FFDEFS-rev u w A B A1 B1 x1 x2 a b eqta exta inda c₁ c₂ (EQTW A3 B3 A4 B4 x x₁ eqta₁ eqtb₁ exta₁ extb₁) ei = ⊥-elim (FFDEFSneqW (⇛-val-det tt tt c₁ x))
eqInType-⇛-FFDEFS-rev u w A B A1 B1 x1 x2 a b eqta exta inda c₁ c₂ (EQTM A3 B3 A4 B4 x x₁ eqta₁ eqtb₁ exta₁ extb₁) ei = ⊥-elim (FFDEFSneqM (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-FFDEFS-rev u w A B A1 B1 x1 x2 a b eqta exta inda c₁ c₂ (EQTNOWRITE A3 A4 x x₁ eqta₁ exta₁) ei = ⊥-elim (FFDEFSneqNOWRITE (⇛-val-det tt tt c₁ x))
eqInType-⇛-FFDEFS-rev u w A B A1 B1 x1 x2 a b eqta exta inda c₁ c₂ (EQTNOREAD A3 A4 x x₁ eqta₁ exta₁) ei = ⊥-elim (FFDEFSneqNOREAD (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-FFDEFS-rev2 u w A B A1 B1 x1 x2 a b eqta exta c₁ c₂ (EQTW A3 B3 A4 B4 x x₁ eqta₁ eqtb₁ exta₁ extb₁) ext ei = ⊥-elim (FFDEFSneqW (⇛-val-det tt tt c₁ x))
eqInType-⇛-FFDEFS-rev2 u w A B A1 B1 x1 x2 a b eqta exta c₁ c₂ (EQTM A3 B3 A4 B4 x x₁ eqta₁ eqtb₁ exta₁ extb₁) ext ei = ⊥-elim (FFDEFSneqM (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-FFDEFS-rev2 u w A B A1 B1 x1 x2 a b eqta exta c₁ c₂ (EQTNOWRITE A3 A4 x x₁ eqta₁ exta₁) ext ei = ⊥-elim (FFDEFSneqNOWRITE (⇛-val-det tt tt c₁ x))
eqInType-⇛-FFDEFS-rev2 u w A B A1 B1 x1 x2 a b eqta exta c₁ c₂ (EQTNOREAD A3 A4 x x₁ eqta₁ exta₁) ext ei = ⊥-elim (FFDEFSneqNOREAD (⇛-val-det tt tt c₁ x))
