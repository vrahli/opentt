...
typeSysConds-PURE-ttrans u w A B x x₁ C (EQTTERM y y₁) = ⊥-elim (PUREneqTERM (⇛-val-det tt tt x₁ y))
...
typeSysConds-PURE-extl1 u w A B x x₁ C (EQTTERM y y₁) f g eqi = ⊥-elim (PUREneqTERM (⇛-val-det tt tt x y))
...
typeSysConds-PURE-extl2 u w A B x x₁ C (EQTTERM y y₁) f g eqi = ⊥-elim (PUREneqTERM (⇛-val-det tt tt x y₁))
...
typeSysConds-PURE-extr1 u w A B x x₁ C (EQTTERM y y₁) f g eqi = ⊥-elim (PUREneqTERM (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-PURE-extr2 u w A B x x₁ C (EQTTERM y y₁) f g eqi = ⊥-elim (PUREneqTERM (⇛-val-det tt tt x₁ y))
...
typeSysConds-PURE-extrevl1 u w A B x x₁ C (EQTTERM y y₁) f g eqi = ⊥-elim (PUREneqTERM (⇛-val-det tt tt x y))
...
typeSysConds-PURE-extrevl2 u w A B x x₁ C (EQTTERM y y₁) f g eqi = ⊥-elim (PUREneqTERM (⇛-val-det tt tt x y₁))
...
typeSysConds-PURE-extrevr1 u w A B x x₁ C (EQTTERM y y₁) f g eqi = ⊥-elim (PUREneqTERM (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-PURE-extrevr2 u w A B x x₁ C (EQTTERM y y₁) f g eqi = ⊥-elim (PUREneqTERM (⇛-val-det tt tt x₁ y))
...
eqInType-⇛-PURE u w A B a b c₁ c₂ (EQTTERM x x₁) ei = ⊥-elim (PUREneqTERM (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-PURE2 u w A B a b c₁ c₂ (EQTTERM x x₁) ei = ⊥-elim (PUREneqTERM (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-PURE-rev u w A B a b c₁ c₂ (EQTTERM x x₁) ei = ⊥-elim (PUREneqTERM (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-PURE-rev2 u w A B a b c₁ c₂ (EQTTERM x x₁) ei = ⊥-elim (PUREneqTERM (⇛-val-det tt tt c₁ x))
