...
PUREneqW : {c d e : Term} → ¬ PURE ≡ WT c d e
PUREneqW {c} {d} {e} ()

PUREneqM : {c d e : Term} → ¬ PURE ≡ MT c d e
PUREneqM {c} {d} {e} ()
...
PUREneqNOWRITE : ¬ PURE ≡ NOWRITE
PUREneqNOWRITE ()

PUREneqNOREAD : ¬ PURE ≡ NOREAD
PUREneqNOREAD ()
...
--    ind {u} {w} {T1} {T2} (EQTTNAT y y₁) ih c₁ c₂ = ⊥-elim (PUREneqTNAT (⇛-val-det tt tt c₂ y))
    ...
    ind {u} {w} {T1} {T2} (EQTW A1 B1 C1 A2 B2 C2 y y₁ eqta eqtb eqtc exta extb extc) ih c₁ c₂ = ⊥-elim (PUREneqW (⇛-val-det tt tt c₂ y))
    ind {u} {w} {T1} {T2} (EQTM A1 B1 C1 A2 B2 C2 y y₁ eqta eqtb eqtc exta extb extc) ih c₁ c₂ = ⊥-elim (PUREneqM (⇛-val-det tt tt c₂ y))
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A1 A2 y y₁ eqtA extA) ih c₁ c₂ = ⊥-elim (PUREneqTTRUNC (⇛-val-det tt tt c₂ y))
    ...
    ind {u} {w} {T1} {T2} (EQTPARTIAL A1 A2 y y₁ eqtA extA) ih c₁ c₂ = ⊥-elim (PUREneqPARTIAL (⇛-val-det tt tt c₂ y))
...
--    ind {u} {w} {T1} {T2} (EQTTNAT y y₁) ih comp a b eqi = ⊥-elim (PUREneqTNAT (⇛-val-det tt tt comp y))
    ...
    ind {u} {w} {T1} {T2} (EQTW A1 B1 C1 A2 B2 C2 y y₁ eqta eqtb eqtc exta extb extc) ih comp a b eqi = ⊥-elim (PUREneqW (⇛-val-det tt tt comp y))
    ind {u} {w} {T1} {T2} (EQTM A1 B1 C1 A2 B2 C2 y y₁ eqta eqtb eqtc exta extb extc) ih comp a b eqi = ⊥-elim (PUREneqM (⇛-val-det tt tt comp y))
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A1 A2 y y₁ eqtA exta) ih comp a b eqi = ⊥-elim (PUREneqTTRUNC (⇛-val-det tt tt comp y))
    ...
    ind {u} {w} {T1} {T2} (EQTPARTIAL A1 A2 y y₁ eqtA extA) ih comp a b eqi = ⊥-elim (PUREneqPARTIAL (⇛-val-det tt tt comp y))
