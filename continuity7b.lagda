...
module continuity7b {L : Level} (L' : Level) (W : PossibleWorlds {L}) (M : Mod L' W)
...
step-updRel2 cc gc {n} {name} {f} {g} {.(IFLT a₁ b₁ c₁ d₁)} {.(IFLT a₂ b₂ c₂ d₂)} {x} {w0} {w1} {w2} {w} {r} nnf cf cg naid nbid comp ind (updRel2-IFLT a₁ a₂ b₁ b₂ c₁ c₂ d₁ d₂ ur ur₁ ur₂ ur₃) upw gtn nnw idom idom' compat compat' wgt0 ew01 ew0 eqn with is-NUM a₁
...
... |       no rn rewrite pair-inj₁ (just-inj (sym comp)) | pair-inj₂ (just-inj (sym comp)) =
  ...
  where
    ...
    ... | yes rn' = ⊥-elim (rn rn')
    ... | no rn' = refl
step-updRel2 cc gc {n} {name} {f} {g} {.(IFLT a₁ b₁ c₁ d₁)} {.(IFLT a₂ b₂ c₂ d₂)} {x} {w0} {w1} {w2} {w} {r} nnf cf cg naid nbid comp ind (updRel2-IFLT a₁ a₂ b₁ b₂ c₁ c₂ d₁ d₂ ur ur₁ ur₂ ur₃) upw gtn nnw idom idom' compat compat' wgt0 ew01 ew0 eqn | inj₁ (n₁ , p) | inj₂ q with step⊎ b₁ w1
... |       inj₁ (b₁' , w1' , z) rewrite z | pair-inj₁ (just-inj (sym comp)) | pair-inj₂ (just-inj (sym comp)) =
  ...
  where
    ...
    ind' = step-updRel2 cc gc {n} {name} {f} {g} {b₁} {b₂} {b₁'} {w0} {w1} {w1'} {w} nnf cf cg (++⊆3→1 {names b₁} {names c₁} {names d₁} {dom𝕎· w1} naid) (++⊆3→1 {names b₂} {names c₂} {names d₂} {dom𝕎· w} nbid) z (stepsPresUpdRel2-IFLT₂→ ind) ur₁ upw gtn nnw idom idom' compat compat' wgt0 ew01 ew0 eqn
... |       inj₂ z rewrite z = ⊥-elim (¬just≡nothing (sym comp))
step-updRel2 cc gc {n} {name} {f} {g} {.(IFLT a₁ b₁ c₁ d₁)} {.(IFLT a₂ b₂ c₂ d₂)} {x} {w0} {w1} {w2} {w} {r} nnf cf cg naid nbid comp ind (updRel2-IFLT a₁ a₂ b₁ b₂ c₁ c₂ d₁ d₂ ur ur₁ ur₂ ur₃) upw gtn nnw idom idom' compat compat' wgt0 ew01 ew0 eqn | inj₂ p with step⊎ a₁ w1
... |    inj₁ (a₁' , w1' , z) rewrite z | pair-inj₁ (just-inj (sym comp)) | pair-inj₂ (just-inj (sym comp)) =
  ...
  where
    ...
    ind' = step-updRel2 cc gc {n} {name} {f} {g} {a₁} {a₂} {a₁'} {w0} {w1} {w1'} {w} nnf cf cg (++⊆4→1 {names a₁} {names b₁} {names c₁} {names d₁} {dom𝕎· w1} naid) (++⊆4→1 {names a₂} {names b₂} {names c₂} {names d₂} {dom𝕎· w} nbid) z (stepsPresUpdRel2-IFLT₁→ ind) ur upw gtn nnw idom idom' compat compat' wgt0 ew01 ew0 eqn
... |    inj₂ z rewrite z = ⊥-elim (¬just≡nothing (sym comp))
step-updRel2 cc gc {n} {name} {f} {g} {.(SUC a₁)} {.(SUC a₂)} {x} {w0} {w1} {w2} {w} {r} nnf cf cg naid nbid comp ind (updRel2-SUC a₁ a₂ ur) upw gtn nnw idom idom' compat compat' wgt0 ew01 ew0 eqn with is-NUM a₁
...
... |    inj₁ (a₁' , w1' , z) rewrite z | pair-inj₁ (just-inj (sym comp)) | pair-inj₂ (just-inj (sym comp)) =
  ...
  where
    ind' : ΣstepsUpdRel2 name f g a₁' w1 w1' a₂ w r
    ind' = step-updRel2 cc gc {n} {name} {f} {g} {a₁} {a₂} {a₁'} {w0} {w1} {w1'} {w} nnf cf cg naid nbid z (stepsPresUpdRel2-SUC₁→ ind) ur upw gtn nnw idom idom' compat compat' wgt0 ew01 ew0 eqn
... |    inj₂ z rewrite z = ⊥-elim (¬just≡nothing (sym comp))
...
... |          inj₂ z rewrite z = ⊥-elim (¬just≡nothing (sym comp))
step-updRel2 cc gc {n} {name} {f} {g} {.(APPLY a₁ b₁)} {.(APPLY a₂ b₂)} {x} {w0} {w1} {w2} {w} {r} nnf cf cg naid nbid comp ind (updRel2-APPLY a₁ a₂ b₁ b₂ ur ur₁) upw gtn nnw idom idom' compat compat' wgt0 ew01 ew0 eqn | inj₂ q | inj₂ p with step⊎ a₁ w1
... | inj₁ (a₁' , w1' , z) rewrite z | pair-inj₁ (just-inj (sym comp)) | pair-inj₂ (just-inj (sym comp)) =
...
... |    inj₂ z rewrite z = ⊥-elim (¬just≡nothing (sym comp))
step-updRel2 cc gc {n} {name} {f} {g} {.(LET a₁ b₁)} {.(LET a₂ b₂)} {x} {w0} {w1} {w2} {w} {r} nnf cf cg naid nbid comp ind (updRel2-LET a₁ a₂ b₁ b₂ ur ur₁) upw gtn nnw idom idom' compat compat' wgt0 ew01 ew0 eqn with isValue⊎ a₁
...
... |    inj₁ (a₁' , w1' , z) rewrite z | pair-inj₁ (just-inj (sym comp)) | pair-inj₂ (just-inj (sym comp)) =
  ...
  where
    ind' : ΣstepsUpdRel2 name f g a₁' w1 w1' a₂ w r
    ind' = step-updRel2 cc gc {n} {name} {f} {g} {a₁} {a₂} {a₁'} {w0} {w1} {w1'} {w} nnf cf cg (++⊆2→1 {names a₁} {names b₁} {dom𝕎· w1} naid) (++⊆2→1 {names a₂} {names b₂} {dom𝕎· w} nbid) z (stepsPresUpdRel2-LET₁→ ind) ur upw gtn nnw idom idom' compat compat' wgt0 ew01 ew0 eqn
... |    inj₂ z rewrite z = ⊥-elim (¬just≡nothing (sym comp))
...
step-updRel2 cc gc {n} {name} {f} {g} {.(SPREAD a₁ b₁)} {.(SPREAD a₂ b₂)} {x} {w0} {w1} {w2} {w} {r} nnf cf cg naid nbid comp ind (updRel2-SPREAD a₁ a₂ b₁ b₂ ur ur₁) upw gtn nnw idom idom' compat compat' wgt0 ew01 ew0 eqn with is-PAIR a₁
...
... |    inj₁ (a₁' , w1' , z) rewrite z | pair-inj₁ (just-inj (sym comp)) | pair-inj₂ (just-inj (sym comp)) =
  ...
  where
    ind' : ΣstepsUpdRel2 name f g a₁' w1 w1' a₂ w r
    ind' = step-updRel2 cc gc {n} {name} {f} {g} {a₁} {a₂} {a₁'} {w0} {w1} {w1'} {w} nnf cf cg (++⊆2→1 {names a₁} {names b₁} {dom𝕎· w1} naid) (++⊆2→1 {names a₂} {names b₂} {dom𝕎· w} nbid) z (stepsPresUpdRel2-SPREAD₁→ ind) ur upw gtn nnw idom idom' compat compat' wgt0 ew01 ew0 eqn
... |    inj₂ z rewrite z = ⊥-elim (¬just≡nothing (sym comp))
...
step-updRel2 cc gc {n} {name} {f} {g} {.(DECIDE a₁ b₁ c₁)} {.(DECIDE a₂ b₂ c₂)} {x} {w0} {w1} {w2} {w} {r} nnf cf cg naid nbid comp ind (updRel2-DECIDE a₁ a₂ b₁ b₂ c₁ c₂ ur ur₁ ur₂) upw gtn nnw idom idom' compat compat' wgt0 ew01 ew0 eqn with is-INL a₁
...
... |       inj₁ (a₁' , w1' , z) rewrite z | pair-inj₁ (just-inj (sym comp)) | pair-inj₂ (just-inj (sym comp)) =
  ...
  where
    ind' : ΣstepsUpdRel2 name f g a₁' w1 w1' a₂ w r
    ind' = step-updRel2 cc gc {n} {name} {f} {g} {a₁} {a₂} {a₁'} {w0} {w1} {w1'} {w} nnf cf cg (++⊆3→1 {names a₁} {names b₁} {names c₁} {dom𝕎· w1} naid) (++⊆3→1 {names a₂} {names b₂} {names c₂} {dom𝕎· w} nbid) z (stepsPresUpdRel2-DECIDE₁→ ind) ur upw gtn nnw idom idom' compat compat' wgt0 ew01 ew0 eqn
... |       inj₂ z rewrite z = ⊥-elim (¬just≡nothing (sym comp))
