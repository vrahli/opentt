...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A1 A2 y y₁ eqtA extA) ih c₁ c₂ = ⊥-elim (NOENCneqTTRUNC (⇛-val-det tt tt c₂ y))
    ...
    ind {u} {w} {T1} {T2} (EQTPARTIAL A1 A2 y y₁ eqtA extA) ih c₁ c₂ = ⊥-elim (NOENCneqPARTIAL (⇛-val-det tt tt c₂ y))
...
typeSysConds-NOENC-extl1 u w A B x x₁ C eqt' =
  ...
  where
    ind : {u : univs} {w : 𝕎·} {T1 T2 : CTerm} (eqt : eqTypes u w T1 T2)
          → ({u' : univs} {w' : 𝕎·} {T1' T2' : CTerm} (eqt'' : eqTypes u' w' T1' T2')
                 → <Type eqt'' eqt → (comp : T1' #⇛ #NOENC at w') (a b : CTerm) → □· w' (λ w'' _ → NOENCeq w'' a b) → eqInType u' w' eqt'' a b)
          → (comp : T1 #⇛ #NOENC at w) (a b : CTerm) → □· w (λ w' _ → NOENCeq w' a b) → eqInType u w eqt a b
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A1 A2 y y₁ eqtA exta) ih comp a b eqi = ⊥-elim (NOENCneqTTRUNC (⇛-val-det tt tt comp y))
    ...
    ind {u} {w} {T1} {T2} (EQTPARTIAL A1 A2 y y₁ eqtA extA) ih comp a b eqi = ⊥-elim (NOENCneqPARTIAL (⇛-val-det tt tt comp y))
...
--    ind {u} {w} {T1} {T2} (EQTLIFT A1 A2 y y₁ eqtA exta) ih comp a b eqi = ⊥-elim (NOENCneqLIFT (⇛-val-det tt tt comp y))
    ...
    concl : (comp : A #⇛ #NOENC at w) (a b : CTerm) → □· w (λ w' _ → NOENCeq w' a b) → eqInType u w eqt' a b
    concl =
      ind<Type
        (λ {u} {w} {T1} {T2} eqt' → (comp : T1 #⇛ #NOENC at w) (a b : CTerm) → □· w (λ w' _ → NOENCeq w' a b) → eqInType u w eqt' a b)
        ind
        eqt'
...
typeSysConds-NOENC-extl2 u w A B x x₁ C eqt' = concl x
  where
    ind : {u : univs} {w : 𝕎·} {T1 T2 : CTerm} (eqt : eqTypes u w T1 T2)
          → ({u' : univs} {w' : 𝕎·} {T1' T2' : CTerm} (eqt'' : eqTypes u' w' T1' T2')
                 → <Type eqt'' eqt → (comp : T2' #⇛ #NOENC at w') (a b : CTerm) → □· w' (λ w'' _ → NOENCeq w'' a b) → eqInType u' w' eqt'' a b)
          → (comp : T2 #⇛ #NOENC at w) (a b : CTerm) → □· w (λ w' _ → NOENCeq w' a b) → eqInType u w eqt a b
--    ind {u} {w} {T1} {T2} (EQTNAT y y₁) ih comp a b eqi = ⊥-elim (NOENCneqNAT (⇛-val-det tt tt comp y₁))
    ind {u} {w} {T1} {T2} (EQTQNAT y y₁) ih comp a b eqi = ⊥-elim (NOENCneqQNAT (⇛-val-det tt tt comp y₁))
--    ind {u} {w} {T1} {T2} (EQTTNAT y y₁) ih comp a b eqi = ⊥-elim (NOENCneqTNAT (⇛-val-det tt tt comp y₁))
    ind {u} {w} {T1} {T2} (EQTLT a1 a2 b1 b2 y y₁ x₄ x₅) ih comp a b eqi = ⊥-elim (NOENCneqLT (⇛-val-det tt tt comp y₁))
...
--    ind {u} {w} {T1} {T2} (EQTLIFT A1 A2 y y₁ eqtA exta) ih comp a b eqi = ⊥-elim (NOENCneqLIFT (⇛-val-det tt tt comp y₁))
    ...
    concl =
      ind<Type
        (λ {u} {w} {T1} {T2} eqt' → (comp : T2 #⇛ #NOENC at w) (a b : CTerm) → □· w (λ w' _ → NOENCeq w' a b) → eqInType u w eqt' a b)
        ind
        eqt'
...
--    ind {u} {w} {T1} {T2} (EQTLIFT A1 A2 y y₁ eqtA exta) ih comp a b eqi = ⊥-elim (NOENCneqLIFT (⇛-val-det tt tt comp y₁))
    ...
    concl : (comp : B #⇛ #NOENC at w) (a b : CTerm) → □· w (λ w' _ → NOENCeq w' a b) → eqInType u w eqt' a b
    concl =
      ind<Type
        (λ {u} {w} {T1} {T2} eqt' → (comp : T2 #⇛ #NOENC at w) (a b : CTerm) → □· w (λ w' _ → NOENCeq w' a b) → eqInType u w eqt' a b)
        ind
...
typeSysConds-NOENC-extrevl1 u w A B x x₁ C eqt' = concl x
  where
    ind : {u : univs} {w : 𝕎·} {T1 T2 : CTerm} (eqt : eqTypes u w T1 T2)
          → ({u' : univs} {w' : 𝕎·} {T1' T2' : CTerm} (eqt'' : eqTypes u' w' T1' T2')
                 → <Type eqt'' eqt → (comp : T1' #⇛ #NOENC at w') (a b : CTerm) → eqInType u' w' eqt'' a b → □· w' (λ w'' _ → NOENCeq w'' a b))
          → (comp : T1 #⇛ #NOENC at w) (a b : CTerm) → eqInType u w eqt a b → □· w (λ w' _ → NOENCeq w' a b)
--    ind {u} {w} {T1} {T2} (EQTNAT y y₁) ih comp a b eqi = ⊥-elim (NOENCneqNAT (⇛-val-det tt tt comp y))
    ind {u} {w} {T1} {T2} (EQTQNAT y y₁) ih comp a b eqi = ⊥-elim (NOENCneqQNAT (⇛-val-det tt tt comp y))
--    ind {u} {w} {T1} {T2} (EQTTNAT y y₁) ih comp a b eqi = ⊥-elim (NOENCneqTNAT (⇛-val-det tt tt comp y))
    ind {u} {w} {T1} {T2} (EQTLT a1 a2 b1 b2 y y₁ x₂ x₃) ih comp a b eqi = ⊥-elim (NOENCneqLT (⇛-val-det tt tt comp y))
...
--    ind {u} {w} {T1} {T2} (EQTLIFT A1 A2 y y₁ eqtA exta) ih comp a b eqi = ⊥-elim (NOENCneqLIFT (⇛-val-det tt tt comp y))
    ind {u} {w} {T1} {T2} (EQTBAR x) ih comp a b eqi = Mod.□-idem M (Mod.∀𝕎-□'-□ M x aw eqi)
      where
        aw0 : ∀𝕎 w (λ w' e' → (z : eqTypes u w' T1 T2) (at : at□· x w' e' z) → eqInType u w' z a b
                             → Mod.□ M w' (↑wPred (λ w'' e → NOENCeq w'' a b) e'))
    ...
    concl : (comp : A #⇛ #NOENC at w) (a b : CTerm) → eqInType u w eqt' a b → □· w (λ w' _ → NOENCeq w' a b)
    concl =
      ind<Type
        (λ {u} {w} {T1} {T2} eqt' → (comp : T1 #⇛ #NOENC at w) (a b : CTerm) → eqInType u w eqt' a b → □· w (λ w' _ → NOENCeq w' a b))
        ind
        eqt'
...
typeSysConds-NOENC-extrevl2 u w A B x x₁ C eqt' = concl x
  where
    ind : {u : univs} {w : 𝕎·} {T1 T2 : CTerm} (eqt : eqTypes u w T1 T2)
          → ({u' : univs} {w' : 𝕎·} {T1' T2' : CTerm} (eqt'' : eqTypes u' w' T1' T2')
                 → <Type eqt'' eqt → (comp : T2' #⇛ #NOENC at w') (a b : CTerm) → eqInType u' w' eqt'' a b → □· w' (λ w'' _ → NOENCeq w'' a b))
          → (comp : T2 #⇛ #NOENC at w) (a b : CTerm) → eqInType u w eqt a b → □· w (λ w' _ → NOENCeq w' a b)
--    ind {u} {w} {T1} {T2} (EQTNAT y y₁) ih comp a b eqi = ⊥-elim (NOENCneqNAT (⇛-val-det tt tt comp y₁))
    ind {u} {w} {T1} {T2} (EQTQNAT y y₁) ih comp a b eqi = ⊥-elim (NOENCneqQNAT (⇛-val-det tt tt comp y₁))
--    ind {u} {w} {T1} {T2} (EQTTNAT y y₁) ih comp a b eqi = ⊥-elim (NOENCneqTNAT (⇛-val-det tt tt comp y₁))
    ind {u} {w} {T1} {T2} (EQTLT a1 a2 b1 b2 y y₁ x₂ x₃) ih comp a b eqi = ⊥-elim (NOENCneqLT (⇛-val-det tt tt comp y₁))
...
--    ind {u} {w} {T1} {T2} (EQTLIFT A1 A2 y y₁ eqtA exta) ih comp a b eqi = ⊥-elim (NOENCneqLIFT (⇛-val-det tt tt comp y₁))
    ...
    concl =
      ind<Type
        (λ {u} {w} {T1} {T2} eqt' → (comp : T2 #⇛ #NOENC at w) (a b : CTerm) → eqInType u w eqt' a b → □· w (λ w' _ → NOENCeq w' a b))
        ind
        eqt'
...
--    ind {u} {w} {T1} {T2} (EQTLIFT A1 A2 y y₁ eqtA exta) ih comp a b eqi = ⊥-elim (NOENCneqLIFT (⇛-val-det tt tt comp y₁))
    ...
    concl : (comp : B #⇛ #NOENC at w) (a b : CTerm) → eqInType u w eqt' a b → □· w (λ w' _ → NOENCeq w' a b)
    concl =
      ind<Type
        (λ {u} {w} {T1} {T2} eqt' → (comp : T2 #⇛ #NOENC at w) (a b : CTerm) → eqInType u w eqt' a b → □· w (λ w' _ → NOENCeq w' a b))
        ind
