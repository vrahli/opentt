...
abstract
  ...
  equalInType-LT-⇛NUM→ {i} {w} {a} {b} {u} {v} {n} {m} compa compb (EQTNOSEQ x x₁ , eqi) = ⊥-elim (LTneqNOSEQ (compAllVal x tt))
...
abstract
  ...
  equalInType-W→ i w A B t u (EQTNOSEQ x x₁ , h) = ⊥-elim (WneqNOSEQ (compAllVal x tt))
...
abstract
  ...
  equalInType-M→ i w A B t u (EQTNOSEQ x x₁ , h) = ⊥-elim (MneqNOSEQ (compAllVal x tt))
