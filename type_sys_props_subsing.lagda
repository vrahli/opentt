...
SUBSINGneqTERM : {a : Term} → ¬ (SUBSING a) ≡ TERM
SUBSINGneqTERM {a} ()
...
typeSysConds-SUBSING-ttrans u w A B A1 B1 x x₁ eqta exta inda C (EQTTERM y y₁) = ⊥-elim (SUBSINGneqTERM (⇛-val-det tt tt x₁ y))
...
typeSysConds-SUBSING-extl1 u w A B A1 B1 x x₁ eqta exta inda C (EQTTERM y y₁) f g eqi = ⊥-elim (SUBSINGneqTERM (⇛-val-det tt tt x y))
...
typeSysConds-SUBSING-extl2 u w A B A1 B1 x x₁ eqta exta inda C (EQTTERM y y₁) f g eqi = ⊥-elim (SUBSINGneqTERM (⇛-val-det tt tt x y₁))
...
typeSysConds-SUBSING-extr1 u w A B A1 B1 x x₁ eqta exta inda C (EQTTERM y y₁) f g eqi = ⊥-elim (SUBSINGneqTERM (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-SUBSING-extr2 u w A B A1 B1 x x₁ eqta exta inda C (EQTTERM y y₁) f g eqi = ⊥-elim (SUBSINGneqTERM (⇛-val-det tt tt x₁ y))
...
typeSysConds-SUBSING-extrevl1 u w A B A1 B1 x x₁ eqta exta inda C (EQTTERM y y₁) f g eqi = ⊥-elim (SUBSINGneqTERM (⇛-val-det tt tt x y))
...
typeSysConds-SUBSING-extrevl2 u w A B A1 B1 x x₁ eqta exta inda C (EQTTERM y y₁) f g eqi = ⊥-elim (SUBSINGneqTERM (⇛-val-det tt tt x y₁))
...
typeSysConds-SUBSING-extrevr1 u w A B A1 B1 x x₁ eqta exta inda C (EQTTERM y y₁) f g eqi = ⊥-elim (SUBSINGneqTERM (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-SUBSING-extrevr2 u w A B A1 B1 x x₁ eqta exta inda C (EQTTERM y y₁) f g eqi = ⊥-elim (SUBSINGneqTERM (⇛-val-det tt tt x₁ y))
...
eqInType-⇛-SUBSING u w A B A1 B1 a b eqta exta inda c₁ c₂ (EQTTERM x x₁) ei = ⊥-elim (SUBSINGneqTERM (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-SUBSING2 u w A B A1 B1 a b eqta exta c₁ c₂ (EQTTERM x x₁) ei ext = ⊥-elim (SUBSINGneqTERM (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-SUBSING-rev u w A B A1 B1 a b eqta exta inda c₁ c₂ (EQTTERM x x₁) ei = ⊥-elim (SUBSINGneqTERM (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-SUBSING-rev2 u w A B A1 B1 a b eqta exta c₁ c₂ (EQTTERM x x₁) ext ei = ⊥-elim (SUBSINGneqTERM (⇛-val-det tt tt c₁ x))
