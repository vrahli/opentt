...
module worldInstanceCSbool (E : Extensionality 0ℓ 0ℓ) where
\end{code}
...
decℂ₀cs : (c : ℂ·) → c ≡ C0 ⊎ ¬ c ≡ C0
decℂ₀cs false = inj₂ (λ ())
decℂ₀cs true = inj₁ refl


decℂ₁cs : (c : ℂ·) → c ≡ C1 ⊎ ¬ c ≡ C1
decℂ₁cs false = inj₁ refl
decℂ₁cs true = inj₂ (λ ())
...
choiceExtCS = mkChoiceExt C0 C1 decℂ₀cs decℂ₁cs
...
choiceValCS = mkChoiceVal ¬∼c01 tt tt ℂ→T→ℂ0 ℂ→T→ℂ1
