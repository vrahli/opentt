...
abstract
  ...
  updRel2-shiftNameUp→ n {name} {f} {g} {r} cf cg {IFEQ a a₁ a₂ a₃} {IFEQ b b₁ b₂ b₃} (updRel2-IFEQ .(shiftNameUp n a) .(shiftNameUp n b) .(shiftNameUp n a₁) .(shiftNameUp n b₁) .(shiftNameUp n a₂) .(shiftNameUp n b₂) .(shiftNameUp n a₃) .(shiftNameUp n b₃) u u₁ u₂ u₃) = updRel2-IFEQ _ _ _ _ _ _ _ _ (updRel2-shiftNameUp→ n cf cg u) (updRel2-shiftNameUp→ n cf cg u₁) (updRel2-shiftNameUp→ n cf cg u₂) (updRel2-shiftNameUp→ n cf cg u₃)
  ...
  updRel2-shiftNameUp→ n {name} {f} {g} {r} cf cg {MAPP s a} {MAPP .s b} (updRel2-MAPP .s .(shiftNameUp n a) .(shiftNameUp n b) u) = updRel2-MAPP _ _ _ (updRel2-shiftNameUp→ n cf cg u)
  ...
  updRel2-shiftNameUp→ n {name} {f} {g} {r} cf cg {WT a a₁} {WT b b₁} (updRel2-WT .(shiftNameUp n a) .(shiftNameUp n b) .(shiftNameUp n a₁) .(shiftNameUp n b₁) u u₁) = updRel2-WT _ _ _ _ (updRel2-shiftNameUp→ n cf cg u) (updRel2-shiftNameUp→ n cf cg u₁)
  updRel2-shiftNameUp→ n {name} {f} {g} {r} cf cg {SUP a a₁} {SUP b b₁} (updRel2-SUP .(shiftNameUp n a) .(shiftNameUp n b) .(shiftNameUp n a₁) .(shiftNameUp n b₁) u u₁) = updRel2-SUP _ _ _ _ (updRel2-shiftNameUp→ n cf cg u) (updRel2-shiftNameUp→ n cf cg u₁)
  updRel2-shiftNameUp→ n {name} {f} {g} {r} cf cg {WREC a a₁} {WREC b b₁} (updRel2-WREC .(shiftNameUp n a) .(shiftNameUp n b) .(shiftNameUp n a₁) .(shiftNameUp n b₁) u u₁) = updRel2-WREC _ _ _ _ (updRel2-shiftNameUp→ n cf cg u) (updRel2-shiftNameUp→ n cf cg u₁)
  updRel2-shiftNameUp→ n {name} {f} {g} {r} cf cg {MT a a₁} {MT b b₁} (updRel2-MT .(shiftNameUp n a) .(shiftNameUp n b) .(shiftNameUp n a₁) .(shiftNameUp n b₁) u u₁) = updRel2-MT _ _ _ _ (updRel2-shiftNameUp→ n cf cg u) (updRel2-shiftNameUp→ n cf cg u₁)
  ...
  updRel2-shiftNameUp→ n {name} {f} {g} {r} cf cg {TERM a} {TERM b} (updRel2-TERM .(shiftNameUp n a) .(shiftNameUp n b) u) = updRel2-TERM _ _ (updRel2-shiftNameUp→ n cf cg u)
