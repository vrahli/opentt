...
SETneqTERM : {a b : Term} → ¬ (SET a b) ≡ TERM
SETneqTERM {a} {b} ()
...
typeSysConds-SET-ttrans u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTTERM y y₁) = ⊥-elim (SETneqTERM (⇛-val-det tt tt x₁ y))
...
typeSysConds-SET-extl1 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTTERM y y₁) f g eqi = ⊥-elim (SETneqTERM (⇛-val-det tt tt x y))
...
typeSysConds-SET-extl2 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTTERM y y₁) f g eqi = ⊥-elim (SETneqTERM (⇛-val-det tt tt x y₁))
...
typeSysConds-SET-extr1 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTTERM y y₁) f g eqi = ⊥-elim (SETneqTERM (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-SET-extr2 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTTERM y y₁) f g eqi = ⊥-elim (SETneqTERM (⇛-val-det tt tt x₁ y))
...
typeSysConds-SET-extrevl1 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTTERM y y₁) f g eqi = ⊥-elim (SETneqTERM (⇛-val-det tt tt x y))
...
typeSysConds-SET-extrevl2 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTTERM y y₁) f g eqi = ⊥-elim (SETneqTERM (⇛-val-det tt tt x y₁))
...
typeSysConds-SET-extrevr1 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTTERM y y₁) f g eqi = ⊥-elim (SETneqTERM (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-SET-extrevr2 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTTERM y y₁) f g eqi = ⊥-elim (SETneqTERM (⇛-val-det tt tt x₁ y))
...
eqInType-⇛-SET u w A B A1 A2 B1 B2 a b eqta eqtb exta extb inda indb c₁ c₂ (EQTTERM x x₁) ei = ⊥-elim (SETneqTERM (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-SET2 u w A B A1 A2 B1 B2 a b eqta eqtb exta extb c₁ c₂ (EQTTERM x x₁) ei ext = ⊥-elim (SETneqTERM (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-SET-rev u w A B A1 A2 B1 B2 a b eqta eqtb exta extb inda indb c₁ c₂ (EQTTERM x x₁) ei = ⊥-elim (SETneqTERM (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-SET-rev2 u w A B A1 A2 B1 B2 a b eqta eqtb exta extb c₁ c₂ (EQTTERM x x₁) ext ei = ⊥-elim (SETneqTERM (⇛-val-det tt tt c₁ x))
