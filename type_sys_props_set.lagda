...
SETneqNOENC : {a b : Term} → ¬ (SET a b) ≡ NOENC
SETneqNOENC {a} {b} ()
...
SETneqPARTIAL : {a b : Term} {c : Term} → ¬ (SET a b) ≡ PARTIAL c
SETneqPARTIAL {a} {b} {c} ()
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A3 A4 y y₁ eqtA extA) ind x x₁ eqta eqtb exta extb inda indb = ⊥-elim (SETneqTTRUNC (⇛-val-det tt tt x₁ y))
    ...
    ind {u} {w} {T1} {T2} (EQTNOENC y y₁) ind x x₁ eqta eqtb exta extb inda indb = ⊥-elim (SETneqNOENC (⇛-val-det tt tt x₁ y))
    ...
    ind {u} {w} {T1} {T2} (EQTPARTIAL A3 A4 y y₁ eqtA extA) ind x x₁ eqta eqtb exta extb inda indb = ⊥-elim (SETneqPARTIAL (⇛-val-det tt tt x₁ y))
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A3 A4 y y₁ eqtA extA) ind eqta eqtb exta extb inda indb x f g eqi = ⊥-elim (SETneqTTRUNC (⇛-val-det tt tt x y))
    ...
    ind {u} {w} {T1} {T2} (EQTPARTIAL A3 A4 y y₁ eqtA extA) ind eqta eqtb exta extb inda indb x f g eqi = ⊥-elim (SETneqPARTIAL (⇛-val-det tt tt x y))
    ...
    ind {u} {w} {T1} {T2} (EQTNOENC y y₁) ind eqta eqtb exta extb inda indb x f g eqi = ⊥-elim (SETneqNOENC (⇛-val-det tt tt x y))
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A3 A4 x x₁ eqta₁ exta₁) ind eqta eqtb exta extb inda indb c₁ c₂ a b ei = ⊥-elim (SETneqTTRUNC (⇛-val-det tt tt c₁ x))
    ...
    ind {u} {w} {T1} {T2} (EQTPARTIAL A3 A4 x x₁ eqta₁ exta₁) ind eqta eqtb exta extb inda indb c₁ c₂ a b ei = ⊥-elim (SETneqPARTIAL (⇛-val-det tt tt c₁ x))
    ...
    ind {u} {w} {T1} {T2} (EQTNOENC x x₁) ind eqta eqtb exta extb inda indb c₁ c₂ a b ei = ⊥-elim (SETneqNOENC (⇛-val-det tt tt c₁ x))
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A3 A4 x x₁ eqta₁ exta₁) ind eqta eqtb exta extb c₁ c₂ a b ei ext = ⊥-elim (SETneqTTRUNC (⇛-val-det tt tt c₁ x))
    ...
    ind {u} {w} {T1} {T2} (EQTNOENC x x₁) ind eqta eqtb exta extb c₁ c₂ a b ei ext = ⊥-elim (SETneqNOENC (⇛-val-det tt tt c₁ x))
    ...
    ind {u} {w} {T1} {T2} (EQTPARTIAL A3 A4 x x₁ eqtA extA) ind eqta eqtb exta extb c₁ c₂ a b ei ext = ⊥-elim (SETneqPARTIAL (⇛-val-det tt tt c₁ x))
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A3 A4 x x₁ eqta₁ exta₁) ind eqta eqtb exta extb c₁ c₂ a b ext ei = ⊥-elim (SETneqTTRUNC (⇛-val-det tt tt c₁ x))
    ...
    ind {u} {w} {T1} {T2} (EQTNOENC x x₁) ind eqta eqtb exta extb c₁ c₂ a b ext ei = ⊥-elim (SETneqNOENC (⇛-val-det tt tt c₁ x))
    ...
    ind {u} {w} {T1} {T2} (EQTPARTIAL A3 A4 x x₁ eqtA extA) ind eqta eqtb exta extb c₁ c₂ a b ext ei = ⊥-elim (SETneqPARTIAL (⇛-val-det tt tt c₁ x))
