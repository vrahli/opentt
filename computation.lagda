...
\begin{code}
T→Name : Term → Name
T→Name t = fst (freshName (names t))
...
step-APPLY-CS-¬NUM name (WT a a₁ a₂) b w w' c s rewrite sym (pair-inj₁ (just-inj s)) | sym (pair-inj₂ (just-inj s)) = refl
step-APPLY-CS-¬NUM name (SUP a a₁) b w w' c s rewrite sym (pair-inj₁ (just-inj s)) | sym (pair-inj₂ (just-inj s)) = refl
step-APPLY-CS-¬NUM name (MT a a₁ a₂) b w w' c s rewrite sym (pair-inj₁ (just-inj s)) | sym (pair-inj₂ (just-inj s)) = refl
--step-APPLY-CS-¬NUM name (MSUP a a₁) b w w' c s rewrite sym (pair-inj₁ (just-inj s)) | sym (pair-inj₂ (just-inj s)) = refl
...
step-APPLY-CS-¬NUM name (ISECT a a₁) b w w' c s rewrite sym (pair-inj₁ (just-inj s)) | sym (pair-inj₂ (just-inj s)) = refl
step-APPLY-CS-¬NUM name (TUNION a a₁) b w w' c s rewrite sym (pair-inj₁ (just-inj s)) | sym (pair-inj₂ (just-inj s)) = refl
step-APPLY-CS-¬NUM name (UNION a a₁) b w w' c s rewrite sym (pair-inj₁ (just-inj s)) | sym (pair-inj₂ (just-inj s)) = refl
--step-APPLY-CS-¬NUM name (QTUNION a a₁) b w w' c s rewrite sym (pair-inj₁ (just-inj s)) | sym (pair-inj₂ (just-inj s)) = refl
...
--step-APPLY-CS-¬NUM name (EQB a a₁ a₂ a₃) b w w' c s rewrite sym (pair-inj₁ (just-inj s)) | sym (pair-inj₂ (just-inj s)) = refl
...
step-APPLY-CS-¬NUM name (MSEQ x) b w w' c s rewrite sym (pair-inj₁ (just-inj s)) | sym (pair-inj₂ (just-inj s)) = refl
...
step-APPLY-CS-¬NUM name (PARTIAL a) b w w' c s rewrite sym (pair-inj₁ (just-inj s)) | sym (pair-inj₂ (just-inj s)) = refl
...
step-APPLY-CS-¬NUM name NOSEQ b w w' c s rewrite sym (pair-inj₁ (just-inj s)) | sym (pair-inj₂ (just-inj s)) = refl
step-APPLY-CS-¬NUM name NOENC b w w' c s rewrite sym (pair-inj₁ (just-inj s)) | sym (pair-inj₂ (just-inj s)) = refl
step-APPLY-CS-¬NUM name (TERM a) b w w' c s rewrite sym (pair-inj₁ (just-inj s)) | sym (pair-inj₂ (just-inj s)) = refl
...
... |    inj₁ (u , w'' , z) rewrite z | sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = step⊑ {_} {_} {a} z
... |    inj₂ z rewrite z = ⊥-elim (¬just≡nothing (sym comp))
step⊑ {w} {w'} {WT a a₁ a₂} {b} comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = ⊑-refl· _
...
... |    inj₁ (u , w'' , z) rewrite z | sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = step⊑ {_} {_} {a} z
... |    inj₂ z rewrite z = ⊥-elim (¬just≡nothing (sym comp))--}
step⊑ {w} {w'} {WREC a a₁} {b} comp with is-SUP a
... | inj₁ (u , v , p) rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = ⊑-refl· _
... | inj₂ p with step⊎ a w
... |    inj₁ (u , w'' , z) rewrite z | sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = step⊑ {_} {_} {a} z
... |    inj₂ z rewrite z = ⊥-elim (¬just≡nothing (sym comp))
step⊑ {w} {w'} {MT a a₁ a₂} {b} comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = ⊑-refl· _
{--step⊑ {w} {w'} {MSUP a a₁} {b} comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = ⊑-refl· _
step⊑ {w} {w'} {DMSUP a a₁} {b} comp with is-MSUP a
... | inj₁ (u , v , p) rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = ⊑-refl· _
... | inj₂ p with step⊎ a w
... |    inj₁ (u , w'' , z) rewrite z | sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = step⊑ {_} {_} {a} z
... |    inj₂ z rewrite z = ⊥-elim (¬just≡nothing (sym comp))--}
...
step⊑ {w} {w'} {ISECT a a₁} {b} comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = ⊑-refl· _
step⊑ {w} {w'} {TUNION a a₁} {b} comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = ⊑-refl· _
step⊑ {w} {w'} {UNION a a₁} {b} comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = ⊑-refl· _
--step⊑ {w} {w'} {QTUNION a a₁} {b} comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = ⊑-refl· _
...
--step⊑ {w} {w'} {EQB a a₁ a₂ a₃} {b} comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = ⊑-refl· _
...
step⊑ {w} {w'} {MSEQ x} {b} comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = ⊑-refl· _
...
step⊑ {w} {w'} {PARTIAL a} {b} comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = ⊑-refl· _
...
step⊑ {w} {w'} {NOSEQ} {b} comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = ⊑-refl· _
step⊑ {w} {w'} {NOENC} {b} comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = ⊑-refl· _
...
→-step-APPLY {w} {w'} {FIX a} {b} c comp = 1 , z
  where
    ...
    z rewrite comp = refl
→-step-APPLY {w} {w'} {WT a a₁ a₂} {b} c comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , refl
→-step-APPLY {w} {w'} {SUP a a₁} {b} c comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , refl
→-step-APPLY {w} {w'} {MT a a₁ a₂} {b} c comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , refl
--→-step-APPLY {w} {w'} {MSUP a a₁} {b} c comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , refl
...
→-step-APPLY {w} {w'} {ISECT a a₁} {b} c comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , refl
→-step-APPLY {w} {w'} {TUNION a a₁} {b} c comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , refl
→-step-APPLY {w} {w'} {UNION a a₁} {b} c comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , refl
--→-step-APPLY {w} {w'} {QTUNION a a₁} {b} c comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , refl
...
--→-step-APPLY {w} {w'} {EQB a a₁ a₂ a₃} {b} c comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , refl
...
→-step-APPLY {w} {w'} {PARTIAL a} {b} c comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , refl
...
→-step-APPLY {w} {w'} {NOSEQ} {b} c comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , refl
→-step-APPLY {w} {w'} {NOENC} {b} c comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , refl
→-step-APPLY {w} {w'} {TERM a} {b} c comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , refl
...
{--→-step-APPLY {w} {w'} {DSUP a x} {b} c comp = 1 , z
  where
    ...
    z rewrite comp = refl--}
→-step-APPLY {w} {w'} {WREC a x} {b} c comp = 1 , z
  where
    z : steps 1 (APPLY (WREC a x) c , w) ≡ (APPLY b c , w')
    z rewrite comp = refl
{--→-step-APPLY {w} {w'} {DMSUP a x} {b} c comp = 1 , z
  where
    z : steps 1 (APPLY (DMSUP a x) c , w) ≡ (APPLY b c , w')
    z rewrite comp = refl--}
...
step-⇓-ASSERT₁ {w} {w'} {FIX a} {b} comp = 1 , z
  where
    ...
    z rewrite comp = refl
step-⇓-ASSERT₁ {w} {w'} {WT a a₁ a₂} {b} comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , refl
step-⇓-ASSERT₁ {w} {w'} {SUP a a₁} {b} comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , refl
step-⇓-ASSERT₁ {w} {w'} {MT a a₁ a₂} {b} comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , refl
--step-⇓-ASSERT₁ {w} {w'} {MSUP a a₁} {b} comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , refl
...
step-⇓-ASSERT₁ {w} {w'} {ISECT a a₁} {b} comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , refl
step-⇓-ASSERT₁ {w} {w'} {TUNION a a₁} {b} comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , refl
step-⇓-ASSERT₁ {w} {w'} {UNION a a₁} {b} comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , refl
--step-⇓-ASSERT₁ {w} {w'} {QTUNION a a₁} {b} comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , refl
...
{--step-⇓-ASSERT₁ {w} {w'} {DSUP a a₁} {b} comp = 1 , z
  where
    ...
    z rewrite comp = refl--}
step-⇓-ASSERT₁ {w} {w'} {WREC a a₁} {b} comp = 1 , z
  where
    z : steps 1 (ASSERT₁ (WREC a a₁) , w) ≡ (ASSERT₁ b , w')
    z rewrite comp = refl
{--step-⇓-ASSERT₁ {w} {w'} {DMSUP a a₁} {b} comp = 1 , z
  where
    z : steps 1 (ASSERT₁ (DMSUP a a₁) , w) ≡ (ASSERT₁ b , w')
    z rewrite comp = refl--}
...
--step-⇓-ASSERT₁ {w} {w'} {EQB a a₁ a₂ a₃} {b} comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , refl
...
step-⇓-ASSERT₁ {w} {w'} {PARTIAL a} {b} comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , refl
...
step-⇓-ASSERT₁ {w} {w'} {NOSEQ} {b} comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , refl
step-⇓-ASSERT₁ {w} {w'} {NOENC} {b} comp rewrite sym (pair-inj₁ (just-inj comp)) | sym (pair-inj₂ (just-inj comp)) = 0 , refl
...
step-preserves-fvars w (ISECT a a₁) b e {x} i rewrite sym (just-inj e) = i
step-preserves-fvars w (TUNION a a₁) b e {x} i rewrite sym (just-inj e) = i
...
--step-preserves-fvars w (EQB a a₁ a₂ a₃) b e {x} i rewrite sym (just-inj e) = i
...
step-preserves-fvars w (PARTIAL a) b e {x} i rewrite sym (just-inj e) = i
...
step-preserves-fvars w (NOENC) b e {x} i rewrite sym (just-inj e) = i
