...
--  differNF⇓-aux2 gc0 f cf nnf name w1 w2 w1' w0 .(TTRUNC a) b v k compat1 compat2 agtn atgn' (differ-TTRUNC a .a diff) s hv isvv pd rewrite sym (pair-inj₁ (just-inj s)) | sym (pair-inj₂ (just-inj s)) = TTRUNC _ , w1 , w1' , ⇓from-to-refl _ _ , ⇓from-to-refl _ _ , differ-TTRUNC _ _ diff
  differNF⇓-aux2 gc0 f cf nnf name w1 w2 w1' w0 .(NOWRITE a) b v k compat1 compat2 agtn atgn' (differ-NOWRITE a .a diff) s hv isvv pd rewrite sym (pair-inj₁ (just-inj s)) | sym (pair-inj₂ (just-inj s)) = NOWRITE _ , w1 , w1' , ⇓from-to-refl _ _ , ⇓from-to-refl _ _ , differ-NOWRITE _ _ diff
  differNF⇓-aux2 gc0 f cf nnf name w1 w2 w1' w0 .(NOREAD a) b v k compat1 compat2 agtn atgn' (differ-NOREAD a .a diff) s hv isvv pd rewrite sym (pair-inj₁ (just-inj s)) | sym (pair-inj₂ (just-inj s)) = NOREAD _ , w1 , w1' , ⇓from-to-refl _ _ , ⇓from-to-refl _ _ , differ-NOREAD _ _ diff
