...
LTneqNN : {u v : Term} {c : Term} → ¬ LT u v ≡ NN c
LTneqNN {u} {v} {c} ()
...
typeSysConds-LT-ttrans u w A B a1 b1 a2 b2 x x₁ s s₁ C (EQTNN t₁ y y₁) = ⊥-elim (LTneqNN (⇛-val-det tt tt x₁ y))
...
typeSysConds-LT-extl1 u w A B a1 b1 a2 b2 x x₁ s s₁ C (EQTNN t₁ y y₁) a b eqi = ⊥-elim (LTneqNN (⇛-val-det tt tt x y))
...
typeSysConds-LT-extl2 u w A B a1 b1 a2 b2 x x₁ s s₁ C (EQTNN t₁ y y₁) a b eqi = ⊥-elim (LTneqNN (⇛-val-det tt tt x y₁))
...
typeSysConds-LT-extr1 u w A B a1 b1 a2 b2 x x₁ s s₁ C (EQTNN t₁ y y₁) a b eqi = ⊥-elim (LTneqNN (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-LT-extr2 u w A B a1 b1 a2 b2 x x₁ s s₁ C (EQTNN t₁ y y₁) a b eqi = ⊥-elim (LTneqNN (⇛-val-det tt tt x₁ y))
...
typeSysConds-LT-extrevl1 u w A B a1 b1 a2 b2 x x₁ s s₁ C (EQTNN t₁ y y₁) a b eqi = ⊥-elim (LTneqNN (⇛-val-det tt tt x y))
...
typeSysConds-LT-extrevl2 u w A B a1 b1 a2 b2 x x₁ s s₁ C (EQTNN t₁ y y₁) a b eqi = ⊥-elim (LTneqNN (⇛-val-det tt tt x y₁))
...
typeSysConds-LT-extrevr1 u w A B a1 b1 a2 b2 x x₁ s s₁ C (EQTNN t₁ y y₁) a b eqi = ⊥-elim (LTneqNN (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-LT-extrevr2 u w A B a1 b1 a2 b2 x x₁ s s₁ C (EQTNN t₁ y y₁) a b eqi = ⊥-elim (LTneqNN (⇛-val-det tt tt x₁ y))
...
eqInType-⇛-LT u w A B a1 b1 a2 b2 a b c₁ c₂ (EQTNN t₁ x x₁) ei = ⊥-elim (LTneqNN (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-LT-rev u w A B a1 b1 a2 b2 a b c₁ c₂ (EQTNN t₁ x x₁) ei = ⊥-elim (LTneqNN (⇛-val-det tt tt c₁ x))
