...
LTneqTCONST : {u v : Term} {c : Term} → ¬ LT u v ≡ TCONST c
LTneqTCONST {u} {v} {c} ()
...
LTneqTERM : {u v : Term} → ¬ LT u v ≡ TERM
LTneqTERM {u} {v} ()
...
typeSysConds-LT-ttrans u w A B a1 b1 a2 b2 x x₁ s s₁ C (EQTCONST A1 A2 y y₁ eqtA extA) = ⊥-elim (LTneqTCONST (⇛-val-det tt tt x₁ y))
...
typeSysConds-LT-ttrans u w A B a1 b1 a2 b2 x x₁ s s₁ C (EQTTERM y y₁) = ⊥-elim (LTneqTERM (⇛-val-det tt tt x₁ y))
...
typeSysConds-LT-extl1 u w A B a1 b1 a2 b2 x x₁ s s₁ C (EQTCONST A1 A2 y y₁ eqtA extA) a b eqi = ⊥-elim (LTneqTCONST (⇛-val-det tt tt x y))
...
typeSysConds-LT-extl1 u w A B a1 b1 a2 b2 x x₁ s s₁ C (EQTTERM y y₁) a b eqi = ⊥-elim (LTneqTERM (⇛-val-det tt tt x y))
...
typeSysConds-LT-extl2 u w A B a1 b1 a2 b2 x x₁ s s₁ C (EQTCONST A1 A2 y y₁ eqtA extA) a b eqi = ⊥-elim (LTneqTCONST (⇛-val-det tt tt x y₁))
...
typeSysConds-LT-extl2 u w A B a1 b1 a2 b2 x x₁ s s₁ C (EQTTERM y y₁) a b eqi = ⊥-elim (LTneqTERM (⇛-val-det tt tt x y₁))
...
typeSysConds-LT-extr1 u w A B a1 b1 a2 b2 x x₁ s s₁ C (EQTCONST A1 A2 y y₁ eqtA extA) a b eqi = ⊥-elim (LTneqTCONST (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-LT-extr1 u w A B a1 b1 a2 b2 x x₁ s s₁ C (EQTTERM y y₁) a b eqi = ⊥-elim (LTneqTERM (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-LT-extr2 u w A B a1 b1 a2 b2 x x₁ s s₁ C (EQTCONST A1 A2 y y₁ eqtA extA) a b eqi = ⊥-elim (LTneqTCONST (⇛-val-det tt tt x₁ y))
...
typeSysConds-LT-extr2 u w A B a1 b1 a2 b2 x x₁ s s₁ C (EQTTERM y y₁) a b eqi = ⊥-elim (LTneqTERM (⇛-val-det tt tt x₁ y))
...
typeSysConds-LT-extrevl1 u w A B a1 b1 a2 b2 x x₁ s s₁ C (EQTCONST A1 A2 y y₁ eqtA extA) a b eqi = ⊥-elim (LTneqTCONST (⇛-val-det tt tt x y))
...
typeSysConds-LT-extrevl1 u w A B a1 b1 a2 b2 x x₁ s s₁ C (EQTTERM y y₁) a b eqi = ⊥-elim (LTneqTERM (⇛-val-det tt tt x y))
...
typeSysConds-LT-extrevl2 u w A B a1 b1 a2 b2 x x₁ s s₁ C (EQTCONST A1 A2 y y₁ eqtA extA) a b eqi = ⊥-elim (LTneqTCONST (⇛-val-det tt tt x y₁))
...
typeSysConds-LT-extrevl2 u w A B a1 b1 a2 b2 x x₁ s s₁ C (EQTTERM y y₁) a b eqi = ⊥-elim (LTneqTERM (⇛-val-det tt tt x y₁))
...
typeSysConds-LT-extrevr1 u w A B a1 b1 a2 b2 x x₁ s s₁ C (EQTCONST A1 A2 y y₁ eqtA extA) a b eqi = ⊥-elim (LTneqTCONST (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-LT-extrevr1 u w A B a1 b1 a2 b2 x x₁ s s₁ C (EQTTERM y y₁) a b eqi = ⊥-elim (LTneqTERM (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-LT-extrevr2 u w A B a1 b1 a2 b2 x x₁ s s₁ C (EQTCONST A1 A2 y y₁ eqtA extA) a b eqi = ⊥-elim (LTneqTCONST (⇛-val-det tt tt x₁ y))
...
typeSysConds-LT-extrevr2 u w A B a1 b1 a2 b2 x x₁ s s₁ C (EQTTERM y y₁) a b eqi = ⊥-elim (LTneqTERM (⇛-val-det tt tt x₁ y))
...
eqInType-⇛-LT u w A B a1 b1 a2 b2 a b c₁ c₂ (EQTCONST A1 A2 x x₁ eqtA extA) ei = ⊥-elim (LTneqTCONST (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-LT u w A B a1 b1 a2 b2 a b c₁ c₂ (EQTTERM x x₁) ei = ⊥-elim (LTneqTERM (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-LT-rev u w A B a1 b1 a2 b2 a b c₁ c₂ (EQTCONST A1 A2 x x₁ eqtA extA) ei = ⊥-elim (LTneqTCONST (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-LT-rev u w A B a1 b1 a2 b2 a b c₁ c₂ (EQTTERM x x₁) ei = ⊥-elim (LTneqTERM (⇛-val-det tt tt c₁ x))
