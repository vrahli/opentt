...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A3 A4 y y₁ eqtA extA) ind x x₁ s s₁ = ⊥-elim (LTneqTTRUNC (⇛-val-det tt tt x₁ y))
    ...
    ind {u} {w} {T1} {T2} (EQTPARTIAL A3 A4 y y₁ eqtA extA) ind x x₁ s s₁ = ⊥-elim (LTneqPARTIAL (⇛-val-det tt tt x₁ y))
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A3 A4 y y₁ eqtA extA) ind x s s₁ f g eqi = ⊥-elim (LTneqTTRUNC (⇛-val-det tt tt x y))
    ...
    ind {u} {w} {T1} {T2} (EQTPARTIAL A3 A4 y y₁ eqtA extA) ind x s s₁ f g eqi = ⊥-elim (LTneqPARTIAL (⇛-val-det tt tt x y))
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A3 A4 y y₁ eqtA extA) ind s s₁ x f g eqi = ⊥-elim (LTneqTTRUNC (⇛-val-det tt tt x y₁))
    ...
    ind {u} {w} {T1} {T2} (EQTPARTIAL A3 A4 y y₁ eqtA extA) ind s s₁ x f g eqi = ⊥-elim (LTneqPARTIAL (⇛-val-det tt tt x y₁))
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A3 A4 x x₁ eqta₁ exta₁) ind c₁ c₂ a b ei = ⊥-elim (LTneqTTRUNC (⇛-val-det tt tt c₁ x))
    ...
    ind {u} {w} {T1} {T2} (EQTPARTIAL A3 A4 x x₁ eqta₁ exta₁) ind c₁ c₂ a b ei = ⊥-elim (LTneqPARTIAL (⇛-val-det tt tt c₁ x))
