...
TUNIONneqNOWRITE : {a b : Term} {c : Term} → ¬ (TUNION a b) ≡ NOWRITE c
TUNIONneqNOWRITE {a} {b} {c} ()

TUNIONneqNOREAD : {a b : Term} {c : Term} → ¬ (TUNION a b) ≡ NOREAD c
TUNIONneqNOREAD {a} {b} {c} ()
...
typeSysConds-TUNION-ttrans u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTNOWRITE A3 A4 y y₁ eqtA extA) = ⊥-elim (TUNIONneqNOWRITE (⇛-val-det tt tt x₁ y))
typeSysConds-TUNION-ttrans u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTNOREAD A3 A4 y y₁ eqtA extA) = ⊥-elim (TUNIONneqNOREAD (⇛-val-det tt tt x₁ y))
...
typeSysConds-TUNION-extl1 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTNOWRITE A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (TUNIONneqNOWRITE (⇛-val-det tt tt x y))
typeSysConds-TUNION-extl1 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTNOREAD A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (TUNIONneqNOREAD (⇛-val-det tt tt x y))
...
typeSysConds-TUNION-extl2 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTNOWRITE A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (TUNIONneqNOWRITE (⇛-val-det tt tt x y₁))
typeSysConds-TUNION-extl2 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTNOREAD A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (TUNIONneqNOREAD (⇛-val-det tt tt x y₁))
...
typeSysConds-TUNION-extr1 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTNOWRITE A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (TUNIONneqNOWRITE (⇛-val-det tt tt x₁ y₁))
typeSysConds-TUNION-extr1 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTNOREAD A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (TUNIONneqNOREAD (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-TUNION-extr2 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTNOWRITE A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (TUNIONneqNOWRITE (⇛-val-det tt tt x₁ y))
typeSysConds-TUNION-extr2 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTNOREAD A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (TUNIONneqNOREAD (⇛-val-det tt tt x₁ y))
...
typeSysConds-TUNION-extrevl1 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTNOWRITE A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (TUNIONneqNOWRITE (⇛-val-det tt tt x y))
typeSysConds-TUNION-extrevl1 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTNOREAD A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (TUNIONneqNOREAD (⇛-val-det tt tt x y))
...
typeSysConds-TUNION-extrevl2 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTNOWRITE A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (TUNIONneqNOWRITE (⇛-val-det tt tt x y₁))
typeSysConds-TUNION-extrevl2 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTNOREAD A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (TUNIONneqNOREAD (⇛-val-det tt tt x y₁))
...
typeSysConds-TUNION-extrevr1 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTNOWRITE A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (TUNIONneqNOWRITE (⇛-val-det tt tt x₁ y₁))
typeSysConds-TUNION-extrevr1 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTNOREAD A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (TUNIONneqNOREAD (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-TUNION-extrevr2 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTNOWRITE A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (TUNIONneqNOWRITE (⇛-val-det tt tt x₁ y))
typeSysConds-TUNION-extrevr2 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTNOREAD A3 A4 y y₁ eqtA extA) f g eqi = ⊥-elim (TUNIONneqNOREAD (⇛-val-det tt tt x₁ y))
...
eqInType-⇛-TUNION u w A B A1 A2 B1 B2 a b eqta eqtb exta extb inda indb c₁ c₂ (EQTNOWRITE A3 A4 x x₁ eqtA extA) ei = ⊥-elim (TUNIONneqNOWRITE (⇛-val-det tt tt c₁ x))
eqInType-⇛-TUNION u w A B A1 A2 B1 B2 a b eqta eqtb exta extb inda indb c₁ c₂ (EQTNOREAD A3 A4 x x₁ eqtA extA) ei = ⊥-elim (TUNIONneqNOREAD (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-TUNION2 u w A B A1 A2 B1 B2 a b eqta eqtb exta extb c₁ c₂ (EQTNOWRITE A3 A4 x x₁ eqtA extA) ei ext = ⊥-elim (TUNIONneqNOWRITE (⇛-val-det tt tt c₁ x))
eqInType-⇛-TUNION2 u w A B A1 A2 B1 B2 a b eqta eqtb exta extb c₁ c₂ (EQTNOREAD A3 A4 x x₁ eqtA extA) ei ext = ⊥-elim (TUNIONneqNOREAD (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-TUNION-rev u w A B A1 A2 B1 B2 a b eqta eqtb exta extb inda indb c₁ c₂ (EQTNOWRITE A3 A4 x x₁ eqtA extA) ei = ⊥-elim (TUNIONneqNOWRITE (⇛-val-det tt tt c₁ x))
eqInType-⇛-TUNION-rev u w A B A1 A2 B1 B2 a b eqta eqtb exta extb inda indb c₁ c₂ (EQTNOREAD A3 A4 x x₁ eqtA extA) ei = ⊥-elim (TUNIONneqNOREAD (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-TUNION-rev2 u w A B A1 A2 B1 B2 a b eqta eqtb exta extb c₁ c₂ (EQTNOWRITE A3 A4 x x₁ eqtA extA) ext ei = ⊥-elim (TUNIONneqNOWRITE (⇛-val-det tt tt c₁ x))
eqInType-⇛-TUNION-rev2 u w A B A1 A2 B1 B2 a b eqta eqtb exta extb c₁ c₂ (EQTNOREAD A3 A4 x x₁ eqtA extA) ext ei = ⊥-elim (TUNIONneqNOREAD (⇛-val-det tt tt c₁ x))
