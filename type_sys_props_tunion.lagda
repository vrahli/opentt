...
TUNIONneqPARTIAL : {a b : Term} {c : Term} → ¬ (TUNION a b) ≡ PARTIAL c
TUNIONneqPARTIAL {a} {b} {c} ()
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A3 A4 y y₁ eqtA extA) ind x x₁ eqta eqtb exta extb inda indb = ⊥-elim (TUNIONneqTTRUNC (⇛-val-det tt tt x₁ y))
    ...
    ind {u} {w} {T1} {T2} (EQTPARTIAL A3 A4 y y₁ eqtA extA) ind x x₁ eqta eqtb exta extb inda indb = ⊥-elim (TUNIONneqPARTIAL (⇛-val-det tt tt x₁ y))
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A3 A4 y y₁ eqtA extA) ind eqta eqtb exta extb inda indb x f g eqi = ⊥-elim (TUNIONneqTTRUNC (⇛-val-det tt tt x y))
    ...
    ind {u} {w} {T1} {T2} (EQTPARTIAL A3 A4 y y₁ eqtA extA) ind eqta eqtb exta extb inda indb x f g eqi = ⊥-elim (TUNIONneqPARTIAL (⇛-val-det tt tt x y))
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A3 A4 x x₁ eqta₁ exta₁) ind eqta eqtb exta extb inda indb c₁ c₂ a b ei = ⊥-elim (TUNIONneqTTRUNC (⇛-val-det tt tt c₁ x))
    ...
    ind {u} {w} {T1} {T2} (EQTPARTIAL A3 A4 x x₁ eqta₁ exta₁) ind eqta eqtb exta extb inda indb c₁ c₂ a b ei = ⊥-elim (TUNIONneqPARTIAL (⇛-val-det tt tt c₁ x))
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A3 A4 x x₁ eqta₁ exta₁) ind eqta eqtb exta extb c₁ c₂ a b ei ext = ⊥-elim (TUNIONneqTTRUNC (⇛-val-det tt tt c₁ x))
    ...
    ind {u} {w} {T1} {T2} (EQTPARTIAL A3 A4 x x₁ eqtA extA) ind eqta eqtb exta extb c₁ c₂ a b ei ext = ⊥-elim (TUNIONneqPARTIAL (⇛-val-det tt tt c₁ x))
...
--    ind {u} {w} {T1} {T2} (EQTTRUNC A3 A4 x x₁ eqta₁ exta₁) ind eqta eqtb exta extb c₁ c₂ a b ext ei = ⊥-elim (TUNIONneqTTRUNC (⇛-val-det tt tt c₁ x))
    ...
    ind {u} {w} {T1} {T2} (EQTPARTIAL A3 A4 x x₁ eqtA extA) ind eqta eqtb exta extb c₁ c₂ a b ext ei = ⊥-elim (TUNIONneqPARTIAL (⇛-val-det tt tt c₁ x))
