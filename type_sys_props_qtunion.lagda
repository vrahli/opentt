...
QTUNIONneqNN : {a b : Term} {c : Term} → ¬ (QTUNION a b) ≡ NN c
QTUNIONneqNN {a} {b} {c} ()
...
typeSysConds-QTUNION-ttrans u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTNN t₁ y y₁) = ⊥-elim (QTUNIONneqNN (⇛-val-det tt tt x₁ y))
...
typeSysConds-QTUNION-extl1 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTNN t₁ y y₁) f g eqi = ⊥-elim (QTUNIONneqNN (⇛-val-det tt tt x y))
...
typeSysConds-QTUNION-extl2 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTNN t₁ y y₁) f g eqi = ⊥-elim (QTUNIONneqNN (⇛-val-det tt tt x y₁))
...
typeSysConds-QTUNION-extr1 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTNN t₁ y y₁) f g eqi = ⊥-elim (QTUNIONneqNN (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-QTUNION-extr2 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTNN t₁ y y₁) f g eqi = ⊥-elim (QTUNIONneqNN (⇛-val-det tt tt x₁ y))
...
typeSysConds-QTUNION-extrevl1 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTNN t₁ y y₁) f g eqi = ⊥-elim (QTUNIONneqNN (⇛-val-det tt tt x y))
...
typeSysConds-QTUNION-extrevl2 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTNN t₁ y y₁) f g eqi = ⊥-elim (QTUNIONneqNN (⇛-val-det tt tt x y₁))
...
typeSysConds-QTUNION-extrevr1 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTNN t₁ y y₁) f g eqi = ⊥-elim (QTUNIONneqNN (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-QTUNION-extrevr2 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTNN t₁ y y₁) f g eqi = ⊥-elim (QTUNIONneqNN (⇛-val-det tt tt x₁ y))
...
eqInType-⇛-QTUNION u w A B A1 A2 B1 B2 a b eqta eqtb exta extb inda indb c₁ c₂ (EQTNN t₁ x x₁) ei = ⊥-elim (QTUNIONneqNN (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-QTUNION2 u w A B A1 A2 B1 B2 a b eqta eqtb exta extb c₁ c₂ (EQTNN t₁ x x₁) ei ext = ⊥-elim (QTUNIONneqNN (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-QTUNION-rev u w A B A1 A2 B1 B2 a b eqta eqtb exta extb inda indb c₁ c₂ (EQTNN t₁ x x₁) ei = ⊥-elim (QTUNIONneqNN (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-QTUNION-rev2 u w A B A1 A2 B1 B2 a b eqta eqtb exta extb c₁ c₂ (EQTNN t₁ x x₁) ext ei = ⊥-elim (QTUNIONneqNN (⇛-val-det tt tt c₁ x))
