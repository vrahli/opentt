...
QTUNIONneqTERM : {a b : Term} → ¬ (QTUNION a b) ≡ TERM
QTUNIONneqTERM {a} {b} ()
...
typeSysConds-QTUNION-ttrans u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTTERM y y₁) = ⊥-elim (QTUNIONneqTERM (⇛-val-det tt tt x₁ y))
...
typeSysConds-QTUNION-extl1 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTTERM y y₁) f g eqi = ⊥-elim (QTUNIONneqTERM (⇛-val-det tt tt x y))
...
typeSysConds-QTUNION-extl2 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTTERM y y₁) f g eqi = ⊥-elim (QTUNIONneqTERM (⇛-val-det tt tt x y₁))
...
typeSysConds-QTUNION-extr1 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTTERM y y₁) f g eqi = ⊥-elim (QTUNIONneqTERM (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-QTUNION-extr2 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTTERM y y₁) f g eqi = ⊥-elim (QTUNIONneqTERM (⇛-val-det tt tt x₁ y))
...
typeSysConds-QTUNION-extrevl1 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTTERM y y₁) f g eqi = ⊥-elim (QTUNIONneqTERM (⇛-val-det tt tt x y))
...
typeSysConds-QTUNION-extrevl2 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTTERM y y₁) f g eqi = ⊥-elim (QTUNIONneqTERM (⇛-val-det tt tt x y₁))
...
typeSysConds-QTUNION-extrevr1 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTTERM y y₁) f g eqi = ⊥-elim (QTUNIONneqTERM (⇛-val-det tt tt x₁ y₁))
...
typeSysConds-QTUNION-extrevr2 u w A B A1 B1 A2 B2 x x₁ eqta eqtb exta extb inda indb C (EQTTERM y y₁) f g eqi = ⊥-elim (QTUNIONneqTERM (⇛-val-det tt tt x₁ y))
...
eqInType-⇛-QTUNION u w A B A1 A2 B1 B2 a b eqta eqtb exta extb inda indb c₁ c₂ (EQTTERM x x₁) ei = ⊥-elim (QTUNIONneqTERM (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-QTUNION2 u w A B A1 A2 B1 B2 a b eqta eqtb exta extb c₁ c₂ (EQTTERM x x₁) ei ext = ⊥-elim (QTUNIONneqTERM (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-QTUNION-rev u w A B A1 A2 B1 B2 a b eqta eqtb exta extb inda indb c₁ c₂ (EQTTERM x x₁) ei = ⊥-elim (QTUNIONneqTERM (⇛-val-det tt tt c₁ x))
...
eqInType-⇛-QTUNION-rev2 u w A B A1 A2 B1 B2 a b eqta eqtb exta extb c₁ c₂ (EQTTERM x x₁) ext ei = ⊥-elim (QTUNIONneqTERM (⇛-val-det tt tt c₁ x))
