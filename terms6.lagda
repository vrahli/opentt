...
--  differ-refl name1 name2 f TNAT nn = differ-TNAT
  ...
  differ-refl name1 name2 f (NATREC t t₁ t₂) nn = differ-NATREC _ _ _ _ _ _ (differ-refl name1 name2 f t (∧≡true→1-3 {¬names t} {¬names t₁} {¬names t₂} nn)) (differ-refl name1 name2 f t₁ (∧≡true→2-3 {¬names t} {¬names t₁} {¬names t₂} nn)) (differ-refl name1 name2 f t₂ (∧≡true→3-3 {¬names t} {¬names t₁} {¬names t₂} nn))
  ...
  differ-refl name1 name2 f (WT t t₁ t₂) nn = differ-WT _ _ _ _ _ _ (differ-refl name1 name2 f t (∧≡true→1-3 {¬names t} {¬names t₁} {¬names t₂} nn)) (differ-refl name1 name2 f t₁ (∧≡true→2-3 {¬names t} {¬names t₁} {¬names t₂} nn)) (differ-refl name1 name2 f t₂ (∧≡true→3-3 {¬names t} {¬names t₁} {¬names t₂} nn))
  ...
  differ-refl name1 name2 f (MT t t₁ t₂) nn = differ-MT _ _ _ _ _ _ (differ-refl name1 name2 f t (∧≡true→1-3 {¬names t} {¬names t₁} {¬names t₂} nn)) (differ-refl name1 name2 f t₁ (∧≡true→2-3 {¬names t} {¬names t₁} {¬names t₂} nn)) (differ-refl name1 name2 f t₂ (∧≡true→3-3 {¬names t} {¬names t₁} {¬names t₂} nn))
...
--  differ-refl name1 name2 f (TTRUNC t) nn = differ-TTRUNC _ _ (differ-refl name1 name2 f t nn)
  ...
  differ-refl name1 name2 f (PARTIAL t) nn = differ-PARTIAL _ _ (differ-refl name1 name2 f t nn)
...
differ-NATRECr : {name1 name2 : Name} {f : Term} {n : ℕ} {b1 b2 c1 c2 : Term} (cf : # f)
               → differ name1 name2 f b1 b2
               → differ name1 name2 f c1 c2
               → differ name1 name2 f (NATRECr n b1 c1) (NATRECr n b2 c2)
differ-NATRECr {name1} {name2} {f} {0} {b1} {b2} {c1} {c2} cf db dc = db
differ-NATRECr {name1} {name2} {f} {suc n} {b1} {b2} {c1} {c2} cf db dc =
  differ-APPLY _ _ _ _ (differ-APPLY _ _ _ _ dc (differ-NUM _)) (differ-NATREC _ _ _ _ _ _ (differ-NUM _) db dc)
...
--  differ⇓-aux2 gc0 f cf nnf name1 name2 w1 w2 w1' w0 .TNAT .TNAT a' v k compat1 compat2 agtn differ-TNAT g0 s hv isvv pd rewrite sym (pair-inj₁ (just-inj s)) | sym (pair-inj₂ (just-inj s)) = TNAT , TNAT , w1 , w1' , ⇓from-to-refl _ _ , ⇓from-to-refl _ _ , differ-TNAT , g0
  ...
  ... |    inj₂ z rewrite z = ⊥-elim (¬just≡nothing (sym s))
  -- NATREC
  differ⇓-aux2 gc0 f cf nnf name1 name2 w1 w2 w1' w0 .(NATREC a₁ b₁ c₁) .(NATREC a₂ b₂ c₂) a' v k compat1 compat2 agtn (differ-NATREC a₁ a₂ b₁ b₂ c₁ c₂ diff diff₁ diff₂) g0 s hv isvv pd with is-NUM a₁
  ... | inj₁ (n , p)
    rewrite p | differ-NUM→ diff | sym (pair-inj₁ (just-inj s)) | sym (pair-inj₂ (just-inj s))
    = NATRECr n b₁ c₁ , NATRECr n b₂ c₂ , w1 , w1' , (0 , refl) , (1 , refl) ,
      differ-NATRECr {_} {_} {f} {n} {b₁} {b₂} {c₁} {c₂} cf diff₁ diff₂ , g0
 --NUM (suc n) , NUM (suc n) , w1 , w1' , (0 , refl) , (1 , refl) , differ-NUM (suc n) , g0
  ... | inj₂ p with step⊎ a₁ w1
  ... |    inj₁ (a₁' , w1'' , z) rewrite z | sym (pair-inj₁ (just-inj s)) | sym (pair-inj₂ (just-inj s)) =
    NATREC (fst ind) b₁ c₁ ,
    NATREC (fst (snd ind)) b₂ c₂ ,
    fst (snd (snd ind)) ,
    fst (snd (snd (snd ind))) ,
    NATREC⇓ b₁ c₁ (fst (snd (snd (snd (snd ind))))) ,
    NATREC⇓ b₂ c₂ (fst (snd (snd (snd (snd (snd ind)))))) ,
    differ-NATREC _ _ _ _ _ _ (fst (snd (snd (snd (snd (snd (snd ind))))))) diff₁ diff₂ ,
    snd (snd (snd (snd (snd (snd (snd ind))))))
    where
      hv0 : hasValueℕ k a₁' w1''
      hv0 = NATREC→hasValue k a₁' b₁ c₁ v w1'' w0 hv isvv
  ...
  ... |    inj₂ z rewrite z = ⊥-elim (¬just≡nothing (sym s))
  -- WT
  differ⇓-aux2 gc0 f cf nnf name1 name2 w1 w2 w1' w0 .(WT a₁ b₁ c₁) .(WT a₂ b₂ c₂) a' v k compat1 compat2 agtn (differ-WT a₁ a₂ b₁ b₂ c₁ c₂ diff diff₁ diff₂) g0 s hv isvv pd rewrite sym (pair-inj₁ (just-inj s)) | sym (pair-inj₂ (just-inj s)) = WT a₁ b₁ c₁ , WT a₂ b₂ c₂ , w1 , w1' , ⇓from-to-refl _ _ , ⇓from-to-refl _ _ , differ-WT _ _ _ _ _ _ diff diff₁ diff₂ , g0
  -- SUP
  ...
  ... |    inj₂ z rewrite z = ⊥-elim (¬just≡nothing (sym s))
  -- MT
  differ⇓-aux2 gc0 f cf nnf name1 name2 w1 w2 w1' w0 .(MT a₁ b₁ c₁) .(MT a₂ b₂ c₂) a' v k compat1 compat2 agtn (differ-MT a₁ a₂ b₁ b₂ c₁ c₂ diff diff₁ diff₂) g0 s hv isvv pd rewrite sym (pair-inj₁ (just-inj s)) | sym (pair-inj₂ (just-inj s)) = MT a₁ b₁ c₁ , MT a₂ b₂ c₂ , w1 , w1' , ⇓from-to-refl _ _ , ⇓from-to-refl _ _ , differ-MT _ _ _ _ _ _ diff diff₁ diff₂ , g0
  -- MSUP
...
--  differ⇓-aux2 gc0 f cf nnf name1 name2 w1 w2 w1' w0 .(TTRUNC a) .(TTRUNC b) a' v k compat1 compat2 agtn (differ-TTRUNC a b diff) g0 s hv isvv pd rewrite sym (pair-inj₁ (just-inj s)) | sym (pair-inj₂ (just-inj s)) = TTRUNC a , TTRUNC b , w1 , w1' , ⇓from-to-refl _ _ , ⇓from-to-refl _ _ , differ-TTRUNC _ _ diff , g0
  ...
  differ⇓-aux2 gc0 f cf nnf name1 name2 w1 w2 w1' w0 .(PARTIAL a) .(PARTIAL b) a' v k compat1 compat2 agtn (differ-PARTIAL a b diff) g0 s hv isvv pd rewrite sym (pair-inj₁ (just-inj s)) | sym (pair-inj₂ (just-inj s)) = PARTIAL a , PARTIAL b , w1 , w1' , ⇓from-to-refl _ _ , ⇓from-to-refl _ _ , differ-PARTIAL _ _ diff , g0
...
--  ¬Names→shiftNameUp≡ TNAT n nnt = refl
  ...
  ¬Names→shiftNameUp≡ (NATREC t t₁ t₂) n nnt rewrite ¬Names→shiftNameUp≡ t n (∧≡true→1-3 {¬names t} {¬names t₁} {¬names t₂} nnt) | ¬Names→shiftNameUp≡ t₁ n (∧≡true→2-3 {¬names t} {¬names t₁} {¬names t₂} nnt) | ¬Names→shiftNameUp≡ t₂ n (∧≡true→3-3 {¬names t} {¬names t₁} {¬names t₂} nnt) = refl
  ...
  ¬Names→shiftNameUp≡ (WT t t₁ t₂) n nnt rewrite ¬Names→shiftNameUp≡ t n (∧≡true→1-3 {¬names t} {¬names t₁} {¬names t₂} nnt) | ¬Names→shiftNameUp≡ t₁ n (∧≡true→2-3 {¬names t} {¬names t₁} {¬names t₂} nnt) | ¬Names→shiftNameUp≡ t₂ n (∧≡true→3-3 {¬names t} {¬names t₁} {¬names t₂} nnt) = refl
  ...
  ¬Names→shiftNameUp≡ (MT t t₁ t₂) n nnt rewrite ¬Names→shiftNameUp≡ t n (∧≡true→1-3 {¬names t} {¬names t₁} {¬names t₂} nnt) | ¬Names→shiftNameUp≡ t₁ n (∧≡true→2-3 {¬names t} {¬names t₁} {¬names t₂} nnt) | ¬Names→shiftNameUp≡ t₂ n (∧≡true→3-3 {¬names t} {¬names t₁} {¬names t₂} nnt) = refl
...
--  ¬Names→shiftNameUp≡ (TTRUNC t) n nnt rewrite ¬Names→shiftNameUp≡ t n nnt = refl
  ...
  ¬Names→shiftNameUp≡ (PARTIAL t) n nnt rewrite ¬Names→shiftNameUp≡ t n nnt = refl
