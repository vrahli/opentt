...
→ΣstepsUpdRel-DSUP₁ : {name : Name} {f g : Term} {a₁ a₂ b₁ b₂ : Term} {w1 w : 𝕎·}
                        → updRel name f g b₁ b₂
                        → ΣstepsUpdRel name f g a₁ w1 a₂ w
                        → ΣstepsUpdRel name f g (DSUP a₁ b₁) w1 (DSUP a₂ b₂) w
→ΣstepsUpdRel-DSUP₁ {name} {f} {g} {a₁} {a₂} {b₁} {b₂} {w1} {w} updb (k1 , k2 , y1 , y2 , w3 , comp1 , comp2 , r) =
  fst comp1' , fst comp2' , DSUP y1 b₁ , DSUP y2 b₂ , w3 , snd comp1' , snd comp2' ,
  updRel-DSUP _ _ _ _ r updb
  where
    comp1' : DSUP a₁ b₁ ⇓ DSUP y1 b₁ from w1 to w3
    comp1' = DSUP⇓steps k1 b₁ comp1

    comp2' : DSUP a₂ b₂ ⇓ DSUP y2 b₂ from w to w
    comp2' = DSUP⇓steps k2 b₂ comp2
--}


isHighestℕ-WREC₁→ : {n : ℕ} {k : ℕ} {name : Name} {a b v : Term} {w w' : 𝕎·}
                      ...
                      → Σ ℕ (λ k' → Σ Term (λ u → Σ 𝕎· (λ w'' → Σ (steps k' (a , w) ≡ (u , w'')) (λ comp' →
                          ...
                          × isValue u
                          × k' < k))))
isHighestℕ-WREC₁→ {n} {0} {name} {a} {b} {v} {w} {w'} comp isv h
  rewrite sym (pair-inj₁ comp) | sym (pair-inj₂ comp) = ⊥-elim isv
isHighestℕ-WREC₁→ {n} {suc k} {name} {a} {b} {v} {w} {w'} comp isv h with is-SUP a
... | inj₁ (u₁ , u₂ , p) rewrite p = 0 , SUP u₁ u₂ , w , refl , fst h , tt , _≤_.s≤s _≤_.z≤n
... | inj₂ x with step⊎ a w
... |    inj₁ (a0 , w0 , z) rewrite z =
  suc (fst ind) , concl
  where
    ind : Σ ℕ (λ k' → Σ Term (λ u → Σ 𝕎· (λ w'' → Σ (steps k' (a0 , w0) ≡ (u , w'')) (λ comp' →
                          ...
                          × isValue u
                          × k' < k))))
    ind = isHighestℕ-WREC₁→ {n} {k} {name} {a0} {b} {v} {w0} {w'} comp isv (snd h)
...
stepsPresUpdRel-WREC₁→ : {n : ℕ} {name : Name} {f g : Term} {a b : Term} {w : 𝕎·}
                           → stepsPresUpdRel n name f g (WREC a b) w
                           → stepsPresUpdRel n name f g a w
stepsPresUpdRel-WREC₁→ {n} {name} {f} {g} {a} {b} {w} (k , v , w' , comp , isv , ish , ind) =
  ...
  where
    hv : Σ ℕ (λ k' → Σ Term (λ u → Σ 𝕎· (λ w'' → Σ (steps k' (a , w) ≡ (u , w'')) (λ comp' →
                          ...
                          × isValue u
                          × k' < k))))
    hv = isHighestℕ-WREC₁→ {n} {k} {name} {a} {b} {v} {w} {w'} comp isv ish



→ΣstepsUpdRel-WREC₁ : {name : Name} {f g : Term} {a₁ a₂ b₁ b₂ : Term} {w1 w : 𝕎·}
                        → updRel name f g b₁ b₂
                        → ΣstepsUpdRel name f g a₁ w1 a₂ w
                        → ΣstepsUpdRel name f g (WREC a₁ b₁) w1 (WREC a₂ b₂) w
→ΣstepsUpdRel-WREC₁ {name} {f} {g} {a₁} {a₂} {b₁} {b₂} {w1} {w} updb (k1 , k2 , y1 , y2 , w3 , comp1 , comp2 , r) =
  fst comp1' , fst comp2' , WREC y1 b₁ , WREC y2 b₂ , w3 , snd comp1' , snd comp2' ,
  updRel-WREC _ _ _ _ r updb
  where
...
stepsPresUpdRel-DMSUP₁→ : {n : ℕ} {name : Name} {f g : Term} {a b : Term} {w : 𝕎·}
                           → stepsPresUpdRel n name f g (DMSUP a b) w
                           → stepsPresUpdRel n name f g a w
...
→ΣstepsUpdRel-DMSUP₁ : {name : Name} {f g : Term} {a₁ a₂ b₁ b₂ : Term} {w1 w : 𝕎·}
                        → updRel name f g b₁ b₂
                        → ΣstepsUpdRel name f g a₁ w1 a₂ w
                        → ΣstepsUpdRel name f g (DMSUP a₁ b₁) w1 (DMSUP a₂ b₂) w
→ΣstepsUpdRel-DMSUP₁ {name} {f} {g} {a₁} {a₂} {b₁} {b₂} {w1} {w} updb (k1 , k2 , y1 , y2 , w3 , comp1 , comp2 , r) =
  fst comp1' , fst comp2' , DMSUP y1 b₁ , DMSUP y2 b₂ , w3 , snd comp1' , snd comp2' ,
  updRel-DMSUP _ _ _ _ r updb
  where
    comp1' : DMSUP a₁ b₁ ⇓ DMSUP y1 b₁ from w1 to w3
    comp1' = DMSUP⇓steps k1 b₁ comp1

    comp2' : DMSUP a₂ b₂ ⇓ DMSUP y2 b₂ from w to w
    comp2' = DMSUP⇓steps k2 b₂ comp2
--}
...
--  updRel-shiftUp n {name} {f} {g} cf cg {.TNAT} {.TNAT} updRel-TNAT = updRel-TNAT
  ...
  updRel-shiftUp n {name} {f} {g} cf cg {.(WT a₁ b₁ c₁)} {.(WT a₂ b₂ c₂)} (updRel-WT a₁ a₂ b₁ b₂ c₁ c₂ u u₁ u₂) = updRel-WT _ _ _ _ _ _ (updRel-shiftUp n cf cg u) (updRel-shiftUp (suc n) cf cg u₁) (updRel-shiftUp n cf cg u₂)
  ...
  updRel-shiftUp n {name} {f} {g} cf cg {.(MT a₁ b₁ c₁)} {.(MT a₂ b₂ c₂)} (updRel-MT a₁ a₂ b₁ b₂ c₁ c₂ u u₁ u₂) = updRel-MT _ _ _ _ _ _ (updRel-shiftUp n cf cg u) (updRel-shiftUp (suc n) cf cg u₁) (updRel-shiftUp n cf cg u₂)
...
--  updRel-shiftDown n {name} {f} {g} cf cg {.TNAT} {.TNAT} updRel-TNAT = updRel-TNAT
  ...
  updRel-shiftDown n {name} {f} {g} cf cg {.(WT a₁ b₁ c₁)} {.(WT a₂ b₂ c₂)} (updRel-WT a₁ a₂ b₁ b₂ c₁ c₂ u u₁ u₂) = updRel-WT _ _ _ _ _ _ (updRel-shiftDown n cf cg u) (updRel-shiftDown (suc n) cf cg u₁) (updRel-shiftDown n cf cg u₂)
  ...
  updRel-shiftDown n {name} {f} {g} cf cg {.(MT a₁ b₁ c₁)} {.(MT a₂ b₂ c₂)} (updRel-MT a₁ a₂ b₁ b₂ c₁ c₂ u u₁ u₂) = updRel-MT _ _ _ _ _ _ (updRel-shiftDown n cf cg u) (updRel-shiftDown (suc n) cf cg u₁) (updRel-shiftDown n cf cg u₂)
...
--  updRel-subv v {name} {f} {g} cf cg {.TNAT} {.TNAT} {b₁} {b₂} updRel-TNAT ub = updRel-TNAT
  ...
  updRel-subv v {name} {f} {g} cf cg {.(WT a₁ b₃ c₁)} {.(WT a₂ b₄ c₂)} {b₁} {b₂} (updRel-WT a₁ a₂ b₃ b₄ c₁ c₂ ua ua₁ ua₂) ub = updRel-WT _ _ _ _ _ _ (updRel-subv v cf cg ua ub) (updRel-subv (suc v) cf cg ua₁ (updRel-shiftUp 0 cf cg ub)) (updRel-subv v cf cg ua₂ ub)
  ...
  updRel-subv v {name} {f} {g} cf cg {.(MT a₁ b₃ c₁)} {.(MT a₂ b₄ c₂)} {b₁} {b₂} (updRel-MT a₁ a₂ b₃ b₄ c₁ c₂ ua ua₁ ua₂) ub = updRel-MT _ _ _ _ _ _ (updRel-subv v cf cg ua ub) (updRel-subv (suc v) cf cg ua₁ (updRel-shiftUp 0 cf cg ub)) (updRel-subv v cf cg ua₂ ub)
...
--  updRel→¬Names {name} {f} {g} {.TNAT} {.TNAT} nng updRel-TNAT = refl
  ...
  updRel→¬Names {name} {f} {g} {.(WT a₁ b₁ c₁)} {.(WT a₂ b₂ c₂)} nng (updRel-WT a₁ a₂ b₁ b₂ c₁ c₂ u u₁ u₂) = →∧3≡true (updRel→¬Names nng u) (updRel→¬Names nng u₁) (updRel→¬Names nng u₂)
  ...
  updRel→¬Names {name} {f} {g} {.(MT a₁ b₁ c₁)} {.(MT a₂ b₂ c₂)} nng (updRel-MT a₁ a₂ b₁ b₂ c₁ c₂ u u₁ u₂) = →∧3≡true (updRel→¬Names nng u) (updRel→¬Names nng u₁) (updRel→¬Names nng u₂)
...
--  updRel→isValue {name} {f} {g} {.TNAT} {.TNAT} updRel-TNAT isv = tt
  ...
  updRel→isValue {name} {f} {g} {.(WT a₁ b₁ c₁)} {.(WT a₂ b₂ c₂)} (updRel-WT a₁ a₂ b₁ b₂ c₁ c₂ u u₁ u₂) isv = tt
  updRel→isValue {name} {f} {g} {.(SUP a₁ b₁)} {.(SUP a₂ b₂)} (updRel-SUP a₁ a₂ b₁ b₂ u u₁) isv = tt
  updRel→isValue {name} {f} {g} {.(MT a₁ b₁ c₁)} {.(MT a₂ b₂ c₂)} (updRel-MT a₁ a₂ b₁ b₂ c₁ c₂ u u₁ u₂) isv = tt
