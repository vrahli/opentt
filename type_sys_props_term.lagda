...
--typeSysConds-TERM-ttrans u w A B t1 t2 x x₁ x₂ C (EQTPARTIAL A3 A4 y y₁ eqtA) = ⊥-elim (TERMneqPARTIAL (⇛-val-det tt tt x₁ y))
...
--typeSysConds-TERM-extl1 u w A B t1 t2 x x₁ x₂ C (EQTPARTIAL A3 A4 y y₁ eqtA) f g eqi = ⊥-elim (TERMneqPARTIAL (⇛-val-det tt tt x y))
...
--typeSysConds-TERM-extl2 u w A B t1 t2 x x₁ x₂ C (EQTPARTIAL A3 A4 y y₁ eqtA) f g eqi = ⊥-elim (TERMneqPARTIAL (⇛-val-det tt tt x y₁))
...
--typeSysConds-TERM-extr1 u w A B t1 t2 x x₁ x₂ C (EQTPARTIAL A3 A4 y y₁ eqtA) f g eqi = ⊥-elim (TERMneqPARTIAL (⇛-val-det tt tt x₁ y₁))
...
--typeSysConds-TERM-extr2 u w A B t1 t2 x x₁ x₂ C (EQTPARTIAL A3 A4 y y₁ eqtA) f g eqi = ⊥-elim (TERMneqPARTIAL (⇛-val-det tt tt x₁ y))
...
--typeSysConds-TERM-extrevl1 u w A B t1 t2 x x₁ x₂ C (EQTPARTIAL A3 A4 y y₁ eqtA) f g eqi = ⊥-elim (TERMneqPARTIAL (⇛-val-det tt tt x y))
...
--typeSysConds-TERM-extrevl2 u w A B t1 t2 x x₁ x₂ C (EQTPARTIAL A3 A4 y y₁ eqtA) f g eqi = ⊥-elim (TERMneqPARTIAL (⇛-val-det tt tt x y₁))
...
--typeSysConds-TERM-extrevr1 u w A B t1 t2 x x₁ x₂ C (EQTPARTIAL A3 A4 y y₁ eqtA) f g eqi = ⊥-elim (TERMneqPARTIAL (⇛-val-det tt tt x₁ y₁))
...
--typeSysConds-TERM-extrevr2 u w A B t1 t2 x x₁ x₂ C (EQTPARTIAL A3 A4 y y₁ eqtA) f g eqi = ⊥-elim (TERMneqPARTIAL (⇛-val-det tt tt x₁ y))
...
--eqInType-⇛-TERM u w A B t1 t2 a b bx c₁ c₂ (EQTPARTIAL A3 A4 x x₁ eqtA) ei = ⊥-elim (TERMneqPARTIAL (⇛-val-det tt tt c₁ x))
...
--eqInType-⇛-TERM2 u w A B t1 t2 a b bx c₁ c₂ (EQTPARTIAL A3 A4 x x₁ eqtA) ei = ⊥-elim (TERMneqPARTIAL (⇛-val-det tt tt c₁ x))
...
--eqInType-⇛-TERM-rev u w A B t1 t2 a b bx c₁ c₂ (EQTPARTIAL A3 A4 x x₁ eqtA) ei = ⊥-elim (TERMneqPARTIAL (⇛-val-det tt tt c₁ x))
...
--eqInType-⇛-TERM-rev2 u w A B t1 t2 a b bx c₁ c₂ (EQTPARTIAL A3 A4 x x₁ eqtA) ei = ⊥-elim (TERMneqPARTIAL (⇛-val-det tt tt c₁ x))
